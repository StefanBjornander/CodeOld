...
section .text
 ...
 limits_test$1:
	; parameter string_CHAR_BIT203D2025i0A#, offset 48
	mov qword [rbp + 48], string_CHAR_BIT203D2025i0A#

 limits_test$2:
	; parameter int4$8#, offset 56
	mov dword [rbp + 56], 8
 ...
 limits_test$6:
	; parameter string_CHAR_MIN203D2025i0A0A#, offset 48
	mov qword [rbp + 48], string_CHAR_MIN203D2025i0A0A#

 limits_test$7:
	; parameter int4$minus128#, offset 56
 ...
 limits_test$11:
	; parameter string_CHAR_MAX203D2025i0A#, offset 48
	mov qword [rbp + 48], string_CHAR_MAX203D2025i0A#

 limits_test$12:
	; parameter int4$127#, offset 56
 ...
 limits_test$16:
	; parameter string_UCHAR_MAX203D2025u0A0A#, offset 48
	mov qword [rbp + 48], string_UCHAR_MAX203D2025u0A0A#

 limits_test$17:
	; parameter int4$255#, offset 56
 ...
 limits_test$21:
	; parameter string_SHRT_MIN203D2025i0A#, offset 48
	mov qword [rbp + 48], string_SHRT_MIN203D2025i0A#

 limits_test$22:
	; parameter int4$minus32768#, offset 56
 ...
 limits_test$26:
	; parameter string_SHRT_MAX203D2025i0A#, offset 48
	mov qword [rbp + 48], string_SHRT_MAX203D2025i0A#

 limits_test$27:
	; parameter int4$32767#, offset 56
 ...
 limits_test$31:
	; parameter string_USHRT_MAX203D2025u0A0A#, offset 48
	mov qword [rbp + 48], string_USHRT_MAX203D2025u0A0A#

 limits_test$32:
	; parameter int4$65535#, offset 56
 ...
 limits_test$36:
	; parameter string_INT_MIN203D2025i0A#, offset 48
	mov qword [rbp + 48], string_INT_MIN203D2025i0A#

 limits_test$37:
	; parameter int4$minus2147483648#, offset 56
 ...
 limits_test$41:
	; parameter string_INT_MAX203D2025i0A#, offset 48
	mov qword [rbp + 48], string_INT_MAX203D2025i0A#

 limits_test$42:
	; parameter int4$2147483647#, offset 56
 ...
 limits_test$46:
	; parameter string_UINT_MAX203D2025u0A0A#, offset 48
	mov qword [rbp + 48], string_UINT_MAX203D2025u0A0A#

 limits_test$47:
	; parameter int4$4294967295#, offset 56
	mov eax, 4294967295
	mov [rbp + 56], eax
 ...
 limits_test$51:
	; parameter string_LONG_MIN203D2025li0A#, offset 48
	mov qword [rbp + 48], string_LONG_MIN203D2025li0A#

 limits_test$52:
	; parameter int8$minus9223372036854775808#, offset 56
 ...
 limits_test$56:
	; parameter string_LONG_MAX203D2025li0A#, offset 48
	mov qword [rbp + 48], string_LONG_MAX203D2025li0A#

 limits_test$57:
	; parameter int8$9223372036854775807#, offset 56
 ...
 limits_test$61:
	; parameter string_ULONG_MAX203D2025lu0A#, offset 48
	mov qword [rbp + 48], string_ULONG_MAX203D2025lu0A#

 limits_test$62:
	; parameter int8$18446744073709551615#, offset 56
 ...
 limits_test$66:
	; parameter string_ULONG_MAX203D2025lx0A#, offset 48
