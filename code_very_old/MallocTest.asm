...
section .text
 ...
 rec$7:
	; Dereference £temporary4320 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 28]

 rec$8:
	; Parameter unsigned int £temporary4320 -> lowHeapPtr 72
	mov eax, [rsi]
	mov [rbp + 72], eax
...
section .text
 ...
 malloc_test6$17:
	; Dereference £temporary4341 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 32]

 malloc_test6$18:
	; Parameter unsigned int £temporary4341 -> lowHeapPtr 96
	mov eax, [rsi]
	mov [rbp + 96], eax
