...
section .text
 ...
 asin2$4:
	; return_value = float8$1.5707963267948966192#
 ...
 asin2$10:
	; return_value = float8$minus1.5707963267948966192#
 ...
 asin2$44:
	; if £temporary557 >= int4$1000# goto 55
	cmp eax, 1000
	jge asin2$55
 ...
 atan$10:
	; return_value = float8$0.7853981633974483096#
 ...
 atan$16:
	; return_value = float8$minus0.7853981633974483096#
 ...
 atan$52:
	; if £temporary596 >= int4$1000# goto 61
	cmp eax, 1000
	jge atan$61
 ...
 atanY$54:
	; if £temporary616 >= int4$1000# goto 63
	cmp eax, 1000
	jge atanY$63
