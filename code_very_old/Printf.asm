...
section .text
 ...
 printArgument$122:
	; Assign £temporary1742 16
	mov rax, 16

 printArgument$123:
	; Assign £temporary1743 £temporary1742
 ...
 printArgument$239:
	; NotEqual 257 £temporary1800 101
	cmp ebx, 101
...
section .text
 ...
 printFormat$19:
	; Equal 294 £temporary1859 -> £temporary1862 0
	cmp byte [rsi], 0
	je printFormat$294
 ...
 printFormat$101:
	; BinarySubtract £temporary1879 g_outChars startChars
	mov eax, [g_outChars]
	sub eax, [rbp + 101]
 ...
 printFormat$103:
	; SignedGreaterThanEqual 246 £temporary1879 width
	cmp eax, [rbp + 44]
	jge printFormat$246
 ...
 printFormat$161:
	; BinaryAdd £temporary1901 field 1
	mov eax, [rbp + 113]
	inc eax
 ...
 printFormat$163:
	; SignedGreaterThanEqual 169 £temporary1901 width
	cmp eax, [rbp + 44]
	jge printFormat$169
 ...
 printFormat$219:
	; SignedGreaterThanEqual 225 £temporary1918 width
	cmp eax, [rbp + 44]
	jge printFormat$225
 ...
 printFormat$260:
	; BinaryAdd £temporary1935 index 1
	mov eax, [rbp + 40]
	inc eax
