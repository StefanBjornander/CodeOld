...
section .text
 ...
 main2$3:
	; Parameter 48 pointer "test1.txt"
	mov qword [rbp + 48], string_test12Etxt#

 main2$4:
	; Parameter 56 pointer "test2.txt"
...
section .text
 ...
 assert_test$17:
	; Parameter 84 signedint 876
	mov dword [rbp + 84], 876
...
section .text
 ...
 assert_test2$6:
	; Parameter 84 signedint 881
	mov dword [rbp + 84], 881
