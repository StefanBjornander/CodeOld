...
section .text
 ...
 character_test$3:
	; Parameter signedint £temporary2877 57
	mov [rbp + 57], eax
 ...
 character_test$8:
	; IntegralToIntegral £temporary2879 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$9:
	; Parameter signedint £temporary2879 57
	mov [rbp + 57], eax
 ...
 character_test$11:
	; IntegralToIntegral £temporary2880 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$12:
	; Parameter signedint £temporary2880 85
	mov [rbp + 85], eax
 ...
 character_test$16:
	; Equal 19 £temporary2881 0
	cmp ebx, 0
	je character_test$19

 character_test$17:
	; Assign £temporary2883 "Yes"
	mov rax, string_Yes#
 ...
 character_test$19:
	; Assign £temporary2883 "No"
	mov rax, string_No#

 character_test$20:
	; Parameter pointer £temporary2883 61
	mov [rbp + 61], rax
 ...
 character_test$25:
	; IntegralToIntegral £temporary2885 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$26:
	; Parameter signedint £temporary2885 57
	mov [rbp + 57], eax
 ...
 character_test$28:
	; IntegralToIntegral £temporary2886 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$29:
	; Parameter signedint £temporary2886 85
	mov [rbp + 85], eax
 ...
 character_test$32:
	; GetReturnValue £temporary2887

 character_test$33:
	; Equal 36 £temporary2887 0
	cmp ebx, 0
	je character_test$36

 character_test$34:
	; Assign £temporary2889 "Yes"
	mov rax, string_Yes#
 ...
 character_test$36:
	; Assign £temporary2889 "No"
	mov rax, string_No#

 character_test$37:
	; Parameter pointer £temporary2889 61
	mov [rbp + 61], rax
 ...
 character_test$203:
	; IntegralToIntegral £temporary2948 £temporary2947
	cmp ebx, 0
 ...
 character_test$205:
	; Parameter signedint £temporary2949 61
	mov [rbp + 61], ebx
 ...
 character_test$220:
	; Parameter signedint £temporary2955 61
	mov [rbp + 61], ebx
