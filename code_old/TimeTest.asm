...
section .text
 ...
 time_test$14:
	; Address £temporary4084 now
	mov rsi, rbp
	add rsi, 80

 time_test$15:
	; Parameter pointer £temporary4084 112
	mov [rbp + 112], rsi
 ...
 time_test$18:
	; GetReturnValue £temporary4085

 time_test$19:
	; Assign p £temporary4085
	mov [rbp + 88], rbx
 ...
 time_test$24:
	; GetReturnValue £temporary4086

 time_test$25:
	; Assign now2 £temporary4086
	mov [rbp + 96], rbx
 ...
 time_test$36:
	; Dereference £temporary4089 -> p p 0
	mov rsi, [rbp + 88]

 time_test$37:
	; Assign s £temporary4089 -> p
	mov rdi, rbp
	add rdi, 104
	mov al, 36
 ...
 time_test$40:
	; IntegralToIntegral £temporary4092 s.tm_wday
	mov eax, [rbp + 128]
	mov rbx, 4294967295
	and rax, rbx

 time_test$41:
	; UnsignedMultiply £temporary4093 £temporary4092 8
	xor rdx, rdx
	mul qword [Array_8#]

 time_test$42:
	; BinaryAdd £temporary4094 weekdays £temporary4093
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$43:
	; Dereference £temporary4091 -> £temporary4094 £temporary4094 0

 time_test$44:
	; Parameter pointer £temporary4091 -> £temporary4094 172
	mov rax, [rsi]
	mov [rbp + 172], rax

 time_test$45:
	; BinaryAdd £temporary4096 s.tm_year 1900
	mov eax, [rbp + 124]
	add eax, 1900

 time_test$46:
	; Parameter signedint £temporary4096 180
	mov [rbp + 180], eax

 time_test$47:
	; BinaryAdd £temporary4098 s.tm_mon 1
	mov eax, [rbp + 120]
	inc eax

 time_test$48:
	; Parameter signedint £temporary4098 184
	mov [rbp + 184], eax
 ...
 time_test$59:
	; Address £temporary4107 now
	mov rsi, rbp
	add rsi, 80

 time_test$60:
	; Parameter pointer £temporary4107 164
	mov [rbp + 164], rsi
 ...
 time_test$64:
	; Dereference £temporary4109 -> £temporary4108 £temporary4108 0

 time_test$65:
	; Assign s £temporary4109 -> £temporary4108
	mov rsi, rbp
	add rsi, 104
	mov al, 36
 ...
 time_test$68:
	; IntegralToIntegral £temporary4112 s.tm_wday
	mov eax, [rbp + 128]
	mov rbx, 4294967295
	and rax, rbx

 time_test$69:
	; UnsignedMultiply £temporary4113 £temporary4112 8
	xor rdx, rdx
	mul qword [Array_8#]

 time_test$70:
	; BinaryAdd £temporary4114 weekdays £temporary4113
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$71:
	; Dereference £temporary4111 -> £temporary4114 £temporary4114 0

 time_test$72:
	; Parameter pointer £temporary4111 -> £temporary4114 172
	mov rax, [rsi]
	mov [rbp + 172], rax

 time_test$73:
	; BinaryAdd £temporary4116 s.tm_year 1900
	mov eax, [rbp + 124]
	add eax, 1900

 time_test$74:
	; Parameter signedint £temporary4116 180
	mov [rbp + 180], eax

 time_test$75:
	; BinaryAdd £temporary4118 s.tm_mon 1
	mov eax, [rbp + 120]
	inc eax

 time_test$76:
	; Parameter signedint £temporary4118 184
	mov [rbp + 184], eax
 ...
 time_test$89:
	; Address £temporary4127 s
	mov rsi, rbp
	add rsi, 104

 time_test$90:
	; Parameter pointer £temporary4127 396
	mov [rbp + 396], rsi
 ...
 time_test$94:
	; Parameter pointer £temporary4128 372
	mov [rbp + 372], rbx
 ...
 time_test$100:
	; Address £temporary4130 now
	mov rsi, rbp
	add rsi, 80

 time_test$101:
	; Parameter pointer £temporary4130 396
	mov [rbp + 396], rsi
 ...
 time_test$105:
	; Parameter pointer £temporary4131 372
	mov [rbp + 372], rbx
 ...
 time_test$118:
	; Address £temporary4134 s
	mov rsi, rbp
	add rsi, 104

 time_test$119:
	; Parameter pointer £temporary4134 684
	mov [rbp + 684], rsi
