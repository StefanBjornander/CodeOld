...
section .text
 ...
 compare:
	; IntegralToIntegral £temporary3808 valuePtr1
	mov rsi, [rbp + 24]

 compare$1:
	; Dereference £temporary3809 -> £temporary3808 £temporary3808 0

 compare$2:
	; Assign intValue1 £temporary3809 -> £temporary3808
	mov eax, [rsi]
	mov [rbp + 40], eax

 compare$3:
	; IntegralToIntegral £temporary3810 valuePtr2
	mov rsi, [rbp + 32]

 compare$4:
	; Dereference £temporary3811 -> £temporary3810 £temporary3810 0

 compare$5:
	; Assign intValue2 £temporary3811 -> £temporary3810
	mov eax, [rsi]
	mov [rbp + 44], eax
 ...
 compare$12:
	; Assign £temporary3814 1
	mov ebx, 1

 compare$13:
	; Assign £temporary3815 £temporary3814

 compare$14:
	; Return £temporary3815
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
	jmp rax
...
section .text
 ...
 reverse_compare:
	; IntegralToIntegral £temporary3816 valuePtr1
	mov rsi, [rbp + 24]

 reverse_compare$1:
	; Dereference £temporary3817 -> £temporary3816 £temporary3816 0

 reverse_compare$2:
	; Assign intValue1 £temporary3817 -> £temporary3816
	mov eax, [rsi]
	mov [rbp + 40], eax

 reverse_compare$3:
	; IntegralToIntegral £temporary3818 valuePtr2
	mov rsi, [rbp + 32]

 reverse_compare$4:
	; Dereference £temporary3819 -> £temporary3818 £temporary3818 0

 reverse_compare$5:
	; Assign intValue2 £temporary3819 -> £temporary3818
	mov eax, [rsi]
	mov [rbp + 44], eax
 ...
 reverse_compare$12:
	; Assign £temporary3822 -1
	mov ebx, -1

 reverse_compare$13:
	; Assign £temporary3823 £temporary3822

 reverse_compare$14:
	; Return £temporary3823
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
	jmp rax
...
section .text
 ...
 stdlib_test$6:
	; Address £temporary3833 p
	mov rsi, rbp
	add rsi, 324

 stdlib_test$7:
	; Parameter pointer £temporary3833 380
	mov [rbp + 380], rsi
 ...
 stdlib_test$20:
	; Address £temporary3836 q
	mov rsi, rbp
	add rsi, 332

 stdlib_test$21:
	; Parameter pointer £temporary3836 396
	mov [rbp + 396], rsi
 ...
 stdlib_test$29:
	; Address £temporary3838 r
	mov rsi, rbp
	add rsi, 340

 stdlib_test$30:
	; Parameter pointer £temporary3838 404
	mov [rbp + 404], rsi
 ...
 stdlib_test$49:
	; Parameter signedint £temporary3841 412
	mov [rbp + 412], ebx
 ...
 stdlib_test$59:
	; Parameter signed long int £temporary3843 412
	mov [rbp + 412], rbx
 ...
 stdlib_test$88:
	; Parameter pointer £temporary3848 56
	mov [rbp + 56], rbx
 ...
 stdlib_test$106:
	; Parameter signedint £temporary3852 56
	mov [rbp + 56], ebx
 ...
 stdlib_test$112:
	; Parameter signedint £temporary3853 60
	mov [rbp + 60], ebx
 ...
 stdlib_test$118:
	; Parameter signed long int £temporary3854 64
	mov [rbp + 64], rbx
 ...
 stdlib_test$124:
	; Parameter signed long int £temporary3855 72
	mov [rbp + 72], rbx
 ...
 stdlib_test$132:
	; GetReturnValue £temporary3857 -> £temporary3858

 stdlib_test$133:
	; Assign i £temporary3857 -> £temporary3858
	mov rsi, rbp
	add rsi, 24
	mov al, 8
 ...
 stdlib_test$149:
	; GetReturnValue £temporary3863 -> £temporary3864

 stdlib_test$150:
	; Assign li £temporary3863 -> £temporary3864
	mov rsi, rbp
	add rsi, 24
	mov al, 16
 ...
 stdlib_test$174:
	; IntegralToIntegral £temporary3877 index
	mov eax, [rbp + 44]
	mov rbx, 4294967295
	and rax, rbx

 stdlib_test$175:
	; UnsignedMultiply £temporary3879 £temporary3877 4
	xor rdx, rdx
	mul qword [int8$4#]

 stdlib_test$176:
	; BinaryAdd £temporary3878 list £temporary3879
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 stdlib_test$177:
	; Dereference £temporary3880 -> £temporary3878 £temporary3878 0

 stdlib_test$178:
	; Parameter signedint £temporary3880 -> £temporary3878 80
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$198:
	; IntegralToIntegral £temporary3887 index
	mov eax, [rbp + 44]
	mov rbx, 4294967295
	and rax, rbx

 stdlib_test$199:
	; UnsignedMultiply £temporary3889 £temporary3887 4
	xor rdx, rdx
	mul qword [int8$4#]

 stdlib_test$200:
	; BinaryAdd £temporary3888 list £temporary3889
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 stdlib_test$201:
	; Dereference £temporary3890 -> £temporary3888 £temporary3888 0

 stdlib_test$202:
	; Parameter signedint £temporary3890 -> £temporary3888 80
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$222:
	; IntegralToIntegral £temporary3897 index
	mov eax, [rbp + 44]
	mov rbx, 4294967295
	and rax, rbx

 stdlib_test$223:
	; UnsignedMultiply £temporary3899 £temporary3897 4
	xor rdx, rdx
	mul qword [int8$4#]

 stdlib_test$224:
	; BinaryAdd £temporary3898 list £temporary3899
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 stdlib_test$225:
	; Dereference £temporary3900 -> £temporary3898 £temporary3898 0

 stdlib_test$226:
	; Parameter signedint £temporary3900 -> £temporary3898 80
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$238:
	; Address £temporary3905 key
	mov rsi, rbp
	add rsi, 44

 stdlib_test$239:
	; Parameter pointer £temporary3905 72
	mov [rbp + 72], rsi
 ...
 stdlib_test$247:
	; IntegralToIntegral £temporary3908 £temporary3907

 stdlib_test$248:
	; Assign p £temporary3908
	mov [rbp + 48], rbx
 ...
 stdlib_test$250:
	; BinarySubtract £temporary3911 p list
	mov rax, [rbp + 48]
	sub rax, rbp
	sub rax, 24

 stdlib_test$251:
	; UnsignedDivide £temporary3910 £temporary3911 4
	xor rdx, rdx
	div qword [int8$4#]

 stdlib_test$252:
	; IntegralToIntegral £temporary3912 £temporary3910

 stdlib_test$253:
	; Assign £temporary3913 £temporary3912
 ...
 stdlib_test$255:
	; Assign £temporary3913 -1
	mov eax, -1

 stdlib_test$256:
	; Assign index £temporary3913
	mov [rbp + 56], eax
