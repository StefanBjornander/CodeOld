...
section .text
 ...
 setlocale$1:
	...
	cmp qword [@1544$g_currStructPtr], 0
	je setlocale$5
 ...
 setlocale$7:
	...
	mov qword [@1544$g_currStructPtr], 0
...
@1533$en_US_utf8:
	...
	; initializer Pointer
	dq @1508$enLongDayList
	; initializer Pointer
	dq @1509$enShortMonthList
	; initializer Pointer
	dq @1510$enLongMonthList
	; initializer Pointer
...
@1539$sw_EN_utf8:
	...
	; initializer Pointer
	dq @1535$swLongDayList
	; initializer Pointer
	dq @1509$enShortMonthList
	; initializer Pointer
	dq @1537$swLongMonthList
	; initializer Pointer
	dq string_abcdefghijklmnopqrstuvwxyz#
	; initializer Pointer
	dq string_ABCDEFGHIJKLMNOPQRSTUVWXYZ#
	; initializer Pointer
	dq @1538$swMessageList
