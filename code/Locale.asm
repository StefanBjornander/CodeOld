...
@1527$en_US_utf8:
	...
	dd -4
	; Initializer Pointer @1501$enShortDayList
	dq @1501$enShortDayList
	; Initializer Pointer @1502$enLongDayList
	dq @1502$enLongDayList
	; Initializer Pointer @1503$enShortMonthList
	dq @1503$enShortMonthList
...
@1530$sArray:
	...
	dq string_#
	; Initializer Pointer @1527$en_US_utf8
	dq @1527$en_US_utf8
...
@1532$g_currStructPtr:
	; Initializer Pointer @1530$sArray
	dq @1530$sArray
...
section .text
 ...
 setlocale:
	...
	cmp qword [@1532$g_currStructPtr], 0
	je setlocale$4

 setlocale$1:
	; Dereference £temporary374 -> g_currStructPtr g_currStructPtr 0
	mov rsi, [@1532$g_currStructPtr]

 setlocale$2:
	; Assign £temporary375 £temporary374 -> g_currStructPtr
	mov rax, [rsi]
 ...
 setlocale$6:
	...
	mov qword [@1532$g_currStructPtr], 0
 ...
 setlocale$12:
	; IntegralToIntegral £temporary380 index
	mov eax, [rbp + 36]
	mov rbx, 4294967295
	and rax, rbx

 setlocale$13:
	; UnsignedMultiply £temporary381 £temporary380 16
	xor rdx, rdx
	mul qword [Array_16#]

 setlocale$14:
	; BinaryAdd £temporary382 sArray £temporary381
	mov rsi, @1530$sArray
	add rsi, rax

 setlocale$15:
	; Dereference £temporary379 -> £temporary382 £temporary382 0

 setlocale$16:
	; Parameter pointer £temporary379.name -> £temporary382 80
	mov rax, [rsi]
	mov [rbp + 80], rax
 ...
 setlocale$20:
	; NotEqual 28 £temporary383 0
	cmp ebx, 0
	jne setlocale$28

 setlocale$21:
	; IntegralToIntegral £temporary386 index
	mov eax, [rbp + 36]
	mov rbx, 4294967295
	and rax, rbx

 setlocale$22:
	; UnsignedMultiply £temporary387 £temporary386 16
	xor rdx, rdx
	mul qword [Array_16#]

 setlocale$23:
	; BinaryAdd £temporary388 sArray £temporary387
	mov rsi, @1530$sArray
	add rsi, rax

 setlocale$24:
	; Dereference £temporary385 -> £temporary388 £temporary388 0

 setlocale$25:
	; Address £temporary389 £temporary385 -> £temporary388

 setlocale$26:
	; Assign g_currStructPtr £temporary389
	mov [@1532$g_currStructPtr], rsi
...
section .text
 ...
 localeconv$1:
	; Dereference £temporary391 -> g_currStructPtr g_currStructPtr 0
	mov rsi, [@1532$g_currStructPtr]

 localeconv$2:
	; Assign £temporary392 £temporary391 -> g_currStructPtr
	mov rbx, [rsi + 8]
