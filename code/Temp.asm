...
section .text
 ...
 @2996$existsTempName$13:
	; if £temporary989 != int4$0# goto 16
	cmp ebx, 0
 ...
 @3003$generateTempName$17:
	; if £temporary1003 != int4$0# goto 47
	cmp ebx, 0
 ...
 @3003$generateTempName$29:
	; if £temporary1006 != int4$0# goto 47
	cmp ebx, 0
	jne @3003$generateTempName$47
 ...
 @3003$generateTempName$45:
	; return_value = £field1015 -> £temporary1018
	mov rbx, rsi
 ...
 @3003$generateTempName$60:
	; goto 2
	jmp @3003$generateTempName$2

 @3003$generateTempName$61:
	; return_value = int8$0#
	mov rbx, 0

 @3003$generateTempName$62:
	; return
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
 ...
 tmpfile$8:
	; if £temporary1022 == int4$0# goto 21
	cmp rbx, 0
	je tmpfile$21
