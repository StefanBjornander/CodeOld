...
section .text
 ...
 generateName:
	; BinaryAdd £temporary798 index 1
	mov eax, [rbp + 24]
	inc eax

 generateName$1:
	; GreaterThanEqual 32 £temporary798 max
	cmp eax, [rbp + 36]
	jge generateName$32

 generateName$2:
	; BinaryAdd £temporary800 index 1
	mov eax, [rbp + 24]
	inc eax

 generateName$3:
	; IntegralToIntegral £temporary802 £temporary800
	mov rbx, 4294967295
	and rax, rbx

 generateName$4:
	; BinaryAdd £temporary803 name £temporary802
	mov rsi, [rbp + 28]
	add rsi, rax

 generateName$5:
	; Dereference £temporary801 -> £temporary803 £temporary803 0

 generateName$6:
	; Assign £temporary801 -> £temporary803 0
	mov byte [rsi], 0
 ...
 generateName$8:
	; GreaterThan 37 c 122
	cmp byte [rbp + 40], 122
	jg generateName$37

 generateName$9:
	; IntegralToIntegral £temporary807 index
	mov eax, [rbp + 24]
	mov rbx, 4294967295
	and rax, rbx
 ...
 generateName$20:
	; BinaryAdd £temporary812 index 1
	mov eax, [rbp + 24]
	inc eax
 ...
 generateName$34:
	; BinaryAdd £temporary819 name £temporary818
	mov rsi, [rbp + 28]
	add rsi, rax

 generateName$35:
	; Dereference £temporary817 -> £temporary819 £temporary819 0

 generateName$36:
	; Assign £temporary817 -> £temporary819 0
	mov byte [rsi], 0
...
section .text
 ...
 tmpfile$16:
	; Dereference £temporary827 -> stream stream 0
	mov rsi, [rbp + 24]

 tmpfile$17:
	; Assign £temporary827 -> stream 1
	mov dword [rsi + 37], 1
