...
@2268$string_Raise20default0A#:
	; Initializer String Raise default\n
	db "Raise default", 10, 0

section .data

@2274$string_Raise20error0A#:
	; Initializer String Raise error\n
	db "Raise error", 10, 0

section .data

@2277$string_Raise20function2C20calling2025i20with2025i0A#:
...
section .text
 ...
 raise$3:
	...
	mov qword [rbp + 60], @2268$string_Raise20default0A#
 ...
 raise$10:
	...
	mov qword [rbp + 60], @2274$string_Raise20error0A#
 ...
 raise$16:
	...
	mov qword [rbp + 60], @2277$string_Raise20function2C20calling2025i20with2025i0A#
