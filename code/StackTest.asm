...
section .text
 ...
 stack_test$1:
	...
	mov qword [rbp + 48], @13436$string_25i20#
...
@13451$string_102420bytes2Dblock20number3A2025i0A#:
...
section .text
 ...
 heap_test$9:
	...
	mov qword [rbp + 60], @13451$string_102420bytes2Dblock20number3A2025i0A#
