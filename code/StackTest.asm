...
section .text
 ...
 stack_test$1:
	...
	mov qword [rbp + 48], @13002$string_25i20#

 stack_test$2:
	; Assign £temporary4171 i
	mov eax, [@13001$i]
 ...
 stack_test$4:
	; Parameter 56 signedint £temporary4171
	mov [rbp + 56], eax
...
@13016$string_102420bytes2Dblock20number3A2025i0A#:
...
section .text
 ...
 heap_test$9:
	...
	mov qword [rbp + 60], @13016$string_102420bytes2Dblock20number3A2025i0A#

 heap_test$10:
	; Assign £temporary4176 count
	mov eax, [rbp + 24]
 ...
 heap_test$12:
	; Parameter 68 signedint £temporary4176
	mov [rbp + 68], eax
