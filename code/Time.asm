...
section .text
 ...
 mktime$2:
	; BinarySubtract £temporary2477 £temporary2476 -> tp 69
	mov eax, [rsi + 20]
	sub eax, 69
 ...
 mktime$7:
	; BinarySubtract £temporary2481 £temporary2480 -> tp 70
	mov eax, [rsi + 20]
	sub eax, 70
 ...
 mktime$10:
	; BinaryAdd £temporary2484 £temporary2483 leapDays
	add rax, [rbp + 32]
 ...
 mktime$13:
	; BinaryAdd totalDays £temporary2484 £temporary2486
	add rax, rbx
	mov [rbp + 40], rax
 ...
 mktime$17:
	...
	xor rdx, rdx
	imul qword [@7679$int8$3600#]

 mktime$18:
	; BinaryAdd £temporary2492 £temporary2488 £temporary2491
	add rbx, rax
 ...
 mktime$21:
	...
	xor rdx, rdx
	imul qword [@7681$int8$60#]

 mktime$22:
	; BinaryAdd £temporary2496 £temporary2492 £temporary2495
	add rbx, rax
 ...
 mktime$25:
	; BinaryAdd £temporary2499 £temporary2496 £temporary2498
	add rbx, rax
...
section .text
 ...
 gmtime$7:
	...
	mov [@7684$g_timeStruct + 8], eax

 gmtime$8:
	; Divide £temporary2508 secondsOfHour 60
	mov rax, [rbp + 48]
	xor rdx, rdx
	idiv qword [@7699$int8$60#]
 ...
 gmtime$10:
	...
	mov [@7684$g_timeStruct + 4], eax

 gmtime$11:
	; Modulo £temporary2511 secondsOfHour 60
	mov rax, [rbp + 48]
	xor rdx, rdx
	idiv qword [@7701$int8$60#]
 ...
 gmtime$13:
	...
	mov [@7684$g_timeStruct], edx

 gmtime$14:
	; Divide totalDays time 86400
	mov rax, [rbp + 32]
	xor rdx, rdx
	idiv qword [@7703$int8$86400#]
	mov [rbp + 56], rax
 ...
 gmtime$16:
	; BinaryAdd £temporary2516 totalDays 4
	mov rax, [rbp + 56]
	add rax, 4
 ...
 gmtime$20:
	; BinarySubtract £temporary2519 totalDays 3
	mov rax, [rbp + 56]
	sub rax, 3
 ...
 gmtime$23:
	...
	mov [@7684$g_timeStruct + 24], edx

 gmtime$24:
	; Divide £temporary2522 totalDays 365
	mov rax, [rbp + 56]
	xor rdx, rdx
	idiv qword [@7715$int8$365#]

 gmtime$25:
	; BinaryAdd £temporary2523 £temporary2522 1970
	add rax, 1970
 ...
 gmtime$28:
	; BinarySubtract £temporary2525 year 1969
	mov eax, [rbp + 64]
	sub eax, 1969
 ...
 gmtime$32:
	; BinarySubtract totalDays totalDays £temporary2528
	sub [rbp + 56], rax
 ...
 gmtime$71:
	; BinaryAdd £temporary2558 daysOfMonths £temporary2557
	mov rsi, rbp
	add rsi, 72
	add rsi, rax
 ...
 gmtime$79:
	; BinaryAdd £temporary2565 daysOfMonths £temporary2564
	mov rsi, rbp
	add rsi, 72
	add rsi, rax
 ...
 gmtime$82:
	; BinarySubtract totalDays totalDays £temporary2566
	sub [rbp + 56], rax
 ...
 gmtime$84:
	...
	mov eax, [rbp + 120]
	mov [@7684$g_timeStruct + 16], eax

 gmtime$85:
	; BinaryAdd £temporary2570 totalDays 1
	mov rax, [rbp + 56]
	inc rax
 ...
 gmtime$87:
	...
	mov [@7684$g_timeStruct + 12], eax

 gmtime$88:
	; Assign g_timeStruct.tm_isdst -1
	mov dword [@7684$g_timeStruct + 32], -1

 gmtime$89:
	; SetReturnValue

 gmtime$90:
	; Return @7684$g_timeStruct
	mov rbx, @7684$g_timeStruct
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
	jmp rax
...
section .text
 ...
 localtime$23:
	...
	xor rdx, rdx
	imul qword [@7792$int8$3600#]

 localtime$24:
	; BinaryAdd t t £temporary2583
	add [rbp + 40], rax
...
section .text
 ...
 difftime:
	; BinarySubtract £temporary2588 time2 time1
	mov rax, [rbp + 32]
	sub rax, [rbp + 24]
...
@7807$g_shortDayList:
	; Initializer Pointer @7800$string_Sun#
	dq @7800$string_Sun#
	; Initializer Pointer @7801$string_Mon#
	dq @7801$string_Mon#
	; Initializer Pointer @7802$string_Tue#
	dq @7802$string_Tue#
	; Initializer Pointer @7803$string_Wed#
	dq @7803$string_Wed#
	; Initializer Pointer @7804$string_Thu#
	dq @7804$string_Thu#
	; Initializer Pointer @7805$string_Fri#
	dq @7805$string_Fri#
	; Initializer Pointer @7806$string_Sat#
	dq @7806$string_Sat#
...
@7811$string_Wednesday#:
	; Initializer String Wednesday
	db "Wednesday", 0

section .data

@7812$string_Thursday#:
...
@7815$g_longDayList:
	; Initializer Pointer @7808$string_Sunday#
	dq @7808$string_Sunday#
	; Initializer Pointer @7809$string_Monday#
	dq @7809$string_Monday#
	; Initializer Pointer @7810$string_Tuesday#
	dq @7810$string_Tuesday#
	; Initializer Pointer @7811$string_Wednesday#
	dq @7811$string_Wednesday#
	; Initializer Pointer @7812$string_Thursday#
	dq @7812$string_Thursday#
	; Initializer Pointer @7813$string_Friday#
	dq @7813$string_Friday#
	; Initializer Pointer @7814$string_Saturday#
	dq @7814$string_Saturday#
...
@7828$g_shortMonthList:
	; Initializer Pointer @7816$string_Jan#
	dq @7816$string_Jan#
	; Initializer Pointer @7817$string_Feb#
	dq @7817$string_Feb#
	; Initializer Pointer @7818$string_Mar#
	dq @7818$string_Mar#
	; Initializer Pointer @7819$string_Apr#
	dq @7819$string_Apr#
	; Initializer Pointer @7820$string_May#
	dq @7820$string_May#
	; Initializer Pointer @7821$string_Jun#
	dq @7821$string_Jun#
	; Initializer Pointer @7822$string_Jul#
	dq @7822$string_Jul#
	; Initializer Pointer @7823$string_Aug#
	dq @7823$string_Aug#
	; Initializer Pointer @7824$string_Sep#
	dq @7824$string_Sep#
	; Initializer Pointer @7825$string_Oct#
	dq @7825$string_Oct#
	; Initializer Pointer @7826$string_Nov#
	dq @7826$string_Nov#
	; Initializer Pointer @7827$string_Dec#
	dq @7827$string_Dec#
...
@7839$string_November#:
	; Initializer String November
	db "November", 0

section .data

@7840$string_December#:
	; Initializer String December
	db "December", 0

section .data

@7841$g_longMonthList:
	; Initializer Pointer @7829$string_January#
	dq @7829$string_January#
	; Initializer Pointer @7830$string_February#
	dq @7830$string_February#
	; Initializer Pointer @7831$string_March#
	dq @7831$string_March#
	; Initializer Pointer @7832$string_April#
	dq @7832$string_April#
	; Initializer Pointer @7833$string_May#
	dq @7833$string_May#
	; Initializer Pointer @7834$string_June#
	dq @7834$string_June#
	; Initializer Pointer @7835$string_July#
	dq @7835$string_July#
	; Initializer Pointer @7836$string_August#
	dq @7836$string_August#
	; Initializer Pointer @7837$string_September#
	dq @7837$string_September#
	; Initializer Pointer @7838$string_October#
	dq @7838$string_October#
	; Initializer Pointer @7839$string_November#
	dq @7839$string_November#
	; Initializer Pointer @7840$string_December#
	dq @7840$string_December#

section .data

@7861$string_25s2025s2025i202502i3A2502i3A2502i2025i#:
...
section .text
 ...
 asctime$7:
	...
	mov qword [rbp + 40], @7807$g_shortDayList
 ...
 asctime$14:
	...
	mov qword [rbp + 48], @7828$g_shortMonthList
 ...
 asctime$16:
	...
	mov qword [rbp + 80], @7799$g_timeString

 asctime$17:
	; Parameter 88 pointer "%s %s %i %02i:%02i:%02i %i"
	mov qword [rbp + 88], @7861$string_25s2025s2025i202502i3A2502i3A2502i2025i#
 ...
 asctime$21:
	; BinaryAdd £temporary2604 shortDayList £temporary2603
	mov rsi, [rbp + 40]
	add rsi, rax
 ...
 asctime$27:
	; BinaryAdd £temporary2609 shortMonthList £temporary2608
	mov rsi, [rbp + 48]
	add rsi, rax
 ...
 asctime$39:
	; BinaryAdd £temporary2615 £temporary2614 -> tp 1900
	mov eax, [rsi + 20]
	add eax, 1900
...
section .text
 ...
 getWeekNumber$1:
	; BinarySubtract £temporary2620 £temporary2619 -> tp 69
	mov eax, [rsi + 20]
	sub eax, 69
 ...
 getWeekNumber$6:
	; BinarySubtract £temporary2624 £temporary2623 -> tp 70
	mov eax, [rsi + 20]
	sub eax, 70
 ...
 getWeekNumber$9:
	; BinaryAdd £temporary2627 £temporary2626 leapDays
	add rax, [rbp + 32]
 ...
 getWeekNumber$15:
	; BinarySubtract £temporary2631 totalDays 3
	mov eax, [rbp + 40]
	sub eax, 3
 ...
 getWeekNumber$23:
	; BinarySubtract £temporary2637 £temporary2636 -> tp firstWeekSize
	mov eax, [rsi + 28]
	sub eax, [rbp + 48]
 ...
 getWeekNumber$24:
	...
	xor edx, edx
	idiv dword [@7906$int4$7#]

 getWeekNumber$25:
	; BinaryAdd £temporary2639 £temporary2638 1
	inc eax
...
@7978$string_2502i2D2502i2D2502i202502i3A2502i3A2502i#:
...
@8025$string_2502i3A2502i3A2502i#:
	; Initializer String %02i:%02i:%02i
	db "%02i:%02i:%02i", 0

section .data

@8028$string_2502i3A2502i3A2502i#:
	; Initializer String %02i:%02i:%02i
	db "%02i:%02i:%02i", 0
...
section .text
 ...
 strftime$11:
	; Assign shortDayList g_shortDayList
	mov qword [rbp + 60], @7807$g_shortDayList
 ...
 strftime$18:
	...
	mov qword [rbp + 76], @7815$g_longDayList
 ...
 strftime$25:
	; Assign shortMonthList g_shortMonthList
	mov qword [rbp + 68], @7828$g_shortMonthList
 ...
 strftime$32:
	...
	mov qword [rbp + 84], @7841$g_longMonthList
 ...
 strftime$35:
	...
	mov qword [rbp + 124], @7942$string_#
 ...
 strftime$50:
	; BinaryAdd £temporary2668 format £temporary2667
	mov rsi, [rbp + 36]
	add rsi, rax
 ...
 strftime$54:
	; BinaryAdd £temporary2673 format £temporary2672
	mov rsi, [rbp + 36]
	add rsi, rax
 ...
 strftime$60:
	; BinaryAdd £temporary2678 format £temporary2677
	mov rsi, [rbp + 36]
	add rsi, rax
 ...
 strftime$91:
	; BinaryAdd £temporary2683 shortDayList £temporary2682
	mov rsi, [rbp + 60]
	add rsi, rax
 ...
 strftime$102:
	; BinaryAdd £temporary2689 longDayList £temporary2688
	mov rsi, [rbp + 76]
	add rsi, rax
 ...
 strftime$113:
	; BinaryAdd £temporary2695 shortMonthList £temporary2694
	mov rsi, [rbp + 68]
	add rsi, rax
 ...
 strftime$124:
	; BinaryAdd £temporary2701 longMonthList £temporary2700
	mov rsi, [rbp + 84]
	add rsi, rax
 ...
 strftime$132:
	...
	mov qword [rbp + 156], @7978$string_2502i2D2502i2D2502i202502i3A2502i3A2502i#
 ...
 strftime$134:
	; BinaryAdd £temporary2704 £temporary2703 -> tp 1900
	mov eax, [rsi + 20]
	add eax, 1900
 ...
 strftime$137:
	; BinaryAdd £temporary2706 £temporary2705 -> tp 1
	mov eax, [rsi + 16]
	inc eax
 ...
 strftime$152:
	...
	mov qword [rbp + 156], @7985$string_2502i#
 ...
 strftime$160:
	; Parameter 156 pointer "%02i"
	mov qword [rbp + 156], @7988$string_2502i#
 ...
 strftime$168:
	; Parameter 156 pointer "%02i"
	mov qword [rbp + 156], @7991$string_2502i#
 ...
 strftime$177:
	...
	mov qword [rbp + 156], @7996$string_2503i#
 ...
 strftime$185:
	; Parameter 156 pointer "%02i"
	mov qword [rbp + 156], @7999$string_2502i#
 ...
 strftime$187:
	; BinaryAdd £temporary2722 £temporary2721 -> tp 1
	mov eax, [rsi + 16]
	inc eax
 ...
 strftime$194:
	; Parameter 156 pointer "%02i"
	mov qword [rbp + 156], @8004$string_2502i#
 ...
 strftime$202:
	...
	mov qword [rbp + 156], @8007$string_25s#
 ...
 strftime$213:
	; Parameter 156 pointer "%02i"
	mov qword [rbp + 156], @8013$string_2502i#
 ...
 strftime$221:
	; Parameter 156 pointer "%02i"
	mov qword [rbp + 156], @8016$string_2502i#
 ...
 strftime$228:
	; Parameter 156 pointer "%02i"
	mov qword [rbp + 156], @8019$string_2502i#
 ...
 strftime$243:
	...
	mov qword [rbp + 156], @8025$string_2502i3A2502i3A2502i#
 ...
 strftime$255:
	; Parameter 156 pointer "%02i:%02i:%02i"
	mov qword [rbp + 156], @8028$string_2502i3A2502i3A2502i#
 ...
 strftime$276:
	; Parameter 156 pointer "%02i"
	mov qword [rbp + 156], @8036$string_2502i#
 ...
 strftime$296:
	...
	mov qword [rbp + 156], @8046$string_25#
 ...
 strftime$301:
	; Parameter 156 pointer ""
	mov qword [rbp + 156], @8047$string_#
 ...
 strftime$307:
	; BinaryAdd £temporary2758 format £temporary2757
	mov rdi, [rbp + 36]
	add rdi, rax
 ...
 strftime$322:
	; BinaryAdd £temporary2762 £temporary2760 £temporary2761
	add ebx, eax
