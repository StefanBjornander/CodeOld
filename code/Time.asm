...
time$7:	; £temporary2785 -> timePtr = *timePtr
	mov rsi, [rbp + 24]

time$8:	; £temporary2785 -> timePtr = time
	mov rax, [rbp + 32]
	mov [rsi], rax
...
mktime$24:	; £temporary2809 -> tp = *tp
	mov rsi, [rbp + 24]

mktime$25:	; £temporary2810 = int_to_int £temporary2809 -> tp (Signed_Int -> Signed_Long_Int)
	mov eax, [rsi]
	mov rcx, 4294967295
	and rax, rcx
	cmp eax, 0
...
gmtime$2:	; £temporary2813 -> timePtr = *timePtr
	mov rsi, [rbp + 24]

gmtime$3:	; time = £temporary2813 -> timePtr
	mov rax, [rsi]
	mov [rbp + 36], rax
...
asctime$44:	; £temporary2913 -> tp = *tp
	mov rsi, [rbp + 24]

asctime$45:	; parameter £temporary2913 -> tp, offset 124
	mov eax, [rsi]
	mov [rbp + 124], eax
...
localtime$15:	; £temporary2934 -> localeConvPtr = *localeConvPtr
	mov rsi, [rbp + 40]

localtime$16:	; £temporary2937 = £temporary2934 -> localeConvPtr
	mov eax, [rsi]
...
localtime$21:	; £temporary2938 -> timePtr = *timePtr
	mov rsi, [rbp + 24]
...
localtime$24:	; £temporary2941 = £temporary2938 -> timePtr + £temporary2940
	mov rbx, [rsi]
	add rbx, rax
...
strftime$197:	; £temporary3041 -> tp = *tp
	mov rsi, [rbp + 44]

strftime$198:	; parameter £temporary3041 -> tp, offset 196
	mov eax, [rsi]
	mov [rbp + 196], eax
...
strftime$267:	; £temporary3061 -> tp = *tp
	mov rsi, [rbp + 44]

strftime$268:	; parameter £temporary3061 -> tp, offset 176
	mov eax, [rsi]
	mov [rbp + 176], eax
...
strftime$315:	; £temporary3075 -> tp = *tp
	mov rsi, [rbp + 44]

strftime$316:	; parameter £temporary3075 -> tp, offset 184
	mov eax, [rsi]
	mov [rbp + 184], eax
...
strftime$350:	; £temporary3085 -> add = *add
	mov rsi, rbp
	add rsi, 116
...
strftime$356:	; £temporary3090 -> add = int1$0#
	mov byte [rsi + 1], 0
