...
section .text
 ...
 time$3:
	; AssignRegister rdi £temporary2716
 ...
 time$7:
	; Assign £temporary2718 -> timePtr time
	mov rax, [rbp + 32]
	mov [rsi], rax
...
section .text
 ...
 mktime$2:
	; BinarySubtract £temporary2722 £temporary2721 -> tp 69
	mov eax, [rsi + 20]
	sub eax, 69

 mktime$3:
	; SignedDivide £temporary2723 £temporary2722 4
	xor edx, edx
	idiv dword [int4$4#]
 ...
 mktime$7:
	; BinarySubtract £temporary2726 £temporary2725 -> tp 70
	mov eax, [rsi + 20]
	sub eax, 70

 mktime$8:
	; SignedMultiply £temporary2727 £temporary2726 365
	xor edx, edx
	imul dword [int4$365#]
 ...
 mktime$10:
	; BinaryAdd £temporary2729 £temporary2728 leapDays
	add rax, [rbp + 32]
 ...
 mktime$13:
	; BinaryAdd totalDays £temporary2729 £temporary2731
	add rax, rbx
	mov [rbp + 40], rax

 mktime$14:
	; SignedMultiply £temporary2733 totalDays 86400
	mov rax, [rbp + 40]
	xor rdx, rdx
 ...
 mktime$16:
	; IntegralToIntegral £temporary2735 £temporary2734 -> tp
	mov eax, [rsi + 8]
	mov rcx, 4294967295
	and rax, rcx
	cmp eax, 0
 ...
 mktime$17:
	; SignedMultiply £temporary2736 £temporary2735 3600
	xor rdx, rdx
	imul qword [int8$3600#]

 mktime$18:
	; BinaryAdd £temporary2737 £temporary2733 £temporary2736
	add rbx, rax
 ...
 mktime$20:
	; IntegralToIntegral £temporary2739 £temporary2738 -> tp
	mov eax, [rsi + 4]
	mov rcx, 4294967295
	and rax, rcx
	cmp eax, 0
 ...
 mktime$21:
	; SignedMultiply £temporary2740 £temporary2739 60
	xor rdx, rdx
	imul qword [int8$60#]

 mktime$22:
	; BinaryAdd £temporary2741 £temporary2737 £temporary2740
	add rbx, rax
 ...
 mktime$24:
	; IntegralToIntegral £temporary2743 £temporary2742 -> tp
	mov eax, [rsi]
	mov rcx, 4294967295
	and rax, rcx
	cmp eax, 0
 ...
 mktime$25:
	; BinaryAdd £temporary2744 £temporary2741 £temporary2743
	add rbx, rax

 mktime$26:
	; Return £temporary2744
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
	jmp rax
...
section .text
 ...
 gmtime$2:
	; Dereference £temporary2746 -> timePtr timePtr 0
	mov rsi, [rbp + 24]

 gmtime$3:
	; Assign time £temporary2746 -> timePtr
	mov rax, [rsi]
	mov [rbp + 36], rax
 ...
 gmtime$5:
	; SignedDivide £temporary2749 secondsOfDay 3600
	mov rax, [rbp + 44]
	xor rdx, rdx
 ...
 gmtime$7:
	; Assign g_timeStruct.tm_hour £temporary2750
	mov [@4753$g_timeStruct + 8], eax

 gmtime$8:
	; SignedModulo £temporary2752 secondsOfDay 3600
	mov rax, [rbp + 44]
	xor rdx, rdx
	idiv qword [int8$3600#]

 gmtime$9:
	; SignedDivide £temporary2753 £temporary2752 60
	mov rax, rdx
	xor rdx, rdx
	idiv qword [int8$60#]
 ...
 gmtime$11:
	; Assign g_timeStruct.tm_min £temporary2754
	mov [@4753$g_timeStruct + 4], eax

 gmtime$12:
	; SignedModulo £temporary2756 secondsOfDay 3600
	mov rax, [rbp + 44]
	xor rdx, rdx
	idiv qword [int8$3600#]

 gmtime$13:
	; SignedModulo £temporary2757 £temporary2756 60
	mov rax, rdx
	xor rdx, rdx
	idiv qword [int8$60#]

 gmtime$14:
	; IntegralToIntegral £temporary2758 £temporary2757
	cmp rdx, 0
	jge gmtime$15
	neg rdx
	neg edx
 ...
 gmtime$15:
	; Assign g_timeStruct.tm_sec £temporary2758
	mov [@4753$g_timeStruct], edx
 ...
 gmtime$18:
	; BinaryAdd £temporary2762 totalDays 4
	mov rax, [rbp + 52]
	add rax, 4
 ...
 gmtime$22:
	; BinarySubtract £temporary2765 totalDays 3
	mov rax, [rbp + 52]
	sub rax, 3

 gmtime$23:
	; SignedModulo £temporary2766 £temporary2765 7
	xor rdx, rdx
	idiv qword [int8$7#]
 ...
 gmtime$25:
	; Assign g_timeStruct.tm_wday £temporary2767
	mov [@4753$g_timeStruct + 24], edx

 gmtime$26:
	; SignedModulo £temporary2768 year 4
	mov eax, [rbp + 32]
	xor edx, edx
	idiv dword [int4$4#]

 gmtime$27:
	; NotEqual 30 £temporary2768 0
	cmp edx, 0
	jne gmtime$30

 gmtime$28:
	; SignedModulo £temporary2770 year 100
	mov eax, [rbp + 32]
	xor edx, edx
	idiv dword [int4$100#]

 gmtime$29:
	; NotEqual 32 £temporary2770 0
	cmp edx, 0
	jne gmtime$32

 gmtime$30:
	; SignedModulo £temporary2773 year 400
	mov eax, [rbp + 32]
	xor edx, edx
	idiv dword [int4$400#]

 gmtime$31:
	; NotEqual 34 £temporary2773 0
	cmp edx, 0
	jne gmtime$34

 gmtime$32:
	; Assign £temporary2776 1
	mov eax, 1
 ...
 gmtime$34:
	; Assign £temporary2776 0
	mov eax, 0

 gmtime$35:
	; Assign leapYear £temporary2776
	mov [rbp + 60], eax
 ...
 gmtime$39:
	; Assign £temporary2778 365
	mov eax, 365

 gmtime$40:
	; Assign daysOfYear £temporary2778
	mov [rbp + 64], eax

 gmtime$41:
	; IntegralToIntegral £temporary2779 daysOfYear
	mov eax, [rbp + 64]
	mov rbx, 4294967295
	and rax, rbx
	cmp eax, 0
 ...
 gmtime$42:
	; SignedGreaterThanEqual 83 totalDays £temporary2779
	cmp [rbp + 52], rax
	jge gmtime$83
 ...
 gmtime$43:
	...
	mov eax, [rbp + 32]
	sub eax, 1900
	mov [@4753$g_timeStruct + 20], eax

 gmtime$44:
	; IntegralToIntegral £temporary2784 totalDays
	mov rax, [rbp + 52]
	cmp rax, 0
	jge gmtime$45
	neg rax
 ...
 gmtime$45:
	; Assign g_timeStruct.tm_yday £temporary2784
	mov [@4753$g_timeStruct + 28], eax
 ...
 gmtime$50:
	; Assign £temporary2786 28
	mov eax, 28

 gmtime$51:
	; Assign daysOfMonths[1] £temporary2786
	mov [rbp + 72], eax
 ...
 gmtime$63:
	; IntegralToIntegral £temporary2800 month
	mov eax, [rbp + 116]
	mov rbx, 4294967295
	and rax, rbx

 gmtime$64:
	; UnsignedMultiply £temporary2801 £temporary2800 4
	xor rdx, rdx
	mul qword [Array_4#]

 gmtime$65:
	; BinaryAdd £temporary2802 daysOfMonths £temporary2801
	mov rsi, rbp
	add rsi, 68
	add rsi, rax
 ...
 gmtime$67:
	; IntegralToIntegral £temporary2803 £temporary2799 -> £temporary2802
	mov eax, [rsi]
	mov rbx, 4294967295
	and rax, rbx
	cmp eax, 0
 ...
 gmtime$68:
	; SignedLessThan 77 totalDays £temporary2803
	cmp [rbp + 52], rax
	jl gmtime$77

 gmtime$69:
	; IntegralToIntegral £temporary2806 month
	mov eax, [rbp + 116]
	mov rbx, 4294967295
	and rax, rbx

 gmtime$70:
	; UnsignedMultiply £temporary2807 £temporary2806 4
	xor rdx, rdx
	mul qword [Array_4#]

 gmtime$71:
	; BinaryAdd £temporary2808 daysOfMonths £temporary2807
	mov rsi, rbp
	add rsi, 68
	add rsi, rax
 ...
 gmtime$73:
	; IntegralToIntegral £temporary2809 £temporary2805 -> £temporary2808
	mov eax, [rsi]
	mov rbx, 4294967295
	and rax, rbx
	cmp eax, 0
 ...
 gmtime$74:
	; BinarySubtract totalDays totalDays £temporary2809
	sub [rbp + 52], rax
 ...
 gmtime$77:
	...
	mov eax, [rbp + 116]
	mov [@4753$g_timeStruct + 16], eax

 gmtime$78:
	; BinaryAdd £temporary2814 totalDays 1
	mov rax, [rbp + 52]
	inc rax
 ...
 gmtime$80:
	; Assign g_timeStruct.tm_mday £temporary2815
	mov [@4753$g_timeStruct + 12], eax

 gmtime$81:
	; Assign g_timeStruct.tm_isdst -1
	mov dword [@4753$g_timeStruct + 32], -1

 gmtime$82:
	; Return @4753$g_timeStruct
	mov rbx, @4753$g_timeStruct
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
	jmp rax
 ...
 gmtime$84:
	; IntegralToIntegral £temporary2818 daysOfYear
	mov eax, [rbp + 64]
	mov rbx, 4294967295
	and rax, rbx
	cmp eax, 0
...
section .text
 ...
 difftime:
	; BinarySubtract £temporary2821 time2 time1
	mov rax, [rbp + 32]
	sub rax, [rbp + 24]

 difftime$1:
	; IntegralToFloating £temporary2822 £temporary2821
...
section .text
 ...
 asctime$2:
	; Dereference £temporary2824 -> localeConvPtr localeConvPtr 0
	mov rsi, [rbp + 32]

 asctime$3:
	; Assign £temporary2825 £temporary2824 -> localeConvPtr
	mov rax, [rsi + 8]
 ...
 asctime$5:
	; Assign £temporary2825 0
	mov rax, 0

 asctime$6:
	; Assign shortDayList £temporary2825
	mov [rbp + 40], rax
 ...
 asctime$11:
	; Assign £temporary2828 0
	mov rax, 0

 asctime$12:
	; Assign shortMonthList £temporary2828
	mov [rbp + 48], rax
 ...
 asctime$14:
	; Assign £temporary2830 shortDayList
	mov rax, [rbp + 40]
 ...
 asctime$16:
	; Assign £temporary2830 g_defaultShortDayList
	mov rax, @4766$g_defaultShortDayList

 asctime$17:
	; Assign shortDayList £temporary2830
	mov [rbp + 40], rax
 ...
 asctime$19:
	; Assign £temporary2832 shortMonthList
	mov rax, [rbp + 48]
 ...
 asctime$21:
	; Assign £temporary2832 g_defaultShortMonthList
	mov rax, @4768$g_defaultShortMonthList

 asctime$22:
	; Assign shortMonthList £temporary2832
	mov [rbp + 48], rax
 ...
 asctime$24:
	...
	mov qword [rbp + 80], @4765$g_timeString
 ...
 asctime$27:
	; IntegralToIntegral £temporary2835 £temporary2833 -> tp
	mov eax, [rsi + 24]
	mov rbx, 4294967295
	and rax, rbx

 asctime$28:
	; UnsignedMultiply £temporary2836 £temporary2835 8
	xor rdx, rdx
	mul qword [int8$8#]

 asctime$29:
	; BinaryAdd £temporary2837 shortDayList £temporary2836
	mov rsi, [rbp + 40]
	add rsi, rax

 asctime$30:
	; Dereference £temporary2834 -> £temporary2837 £temporary2837 0

 asctime$31:
	; Parameter pointer £temporary2834 -> £temporary2837 96
	mov rax, [rsi]
	mov [rbp + 96], rax
 ...
 asctime$33:
	; IntegralToIntegral £temporary2840 £temporary2838 -> tp
	mov eax, [rsi + 16]
	mov rbx, 4294967295
	and rax, rbx

 asctime$34:
	; UnsignedMultiply £temporary2841 £temporary2840 8
	xor rdx, rdx
	mul qword [int8$8#]

 asctime$35:
	; BinaryAdd £temporary2842 shortMonthList £temporary2841
	mov rsi, [rbp + 48]
	add rsi, rax

 asctime$36:
	; Dereference £temporary2839 -> £temporary2842 £temporary2842 0

 asctime$37:
	; Parameter pointer £temporary2839 -> £temporary2842 104
	mov rax, [rsi]
	mov [rbp + 104], rax
 ...
 asctime$39:
	; Parameter signedint £temporary2843 -> tp 112
	mov eax, [rsi + 12]
	mov [rbp + 112], eax

 asctime$40:
	; Dereference £temporary2844 -> tp tp 0
	mov rsi, [rbp + 24]

 asctime$41:
	; Parameter signedint £temporary2844 -> tp 116
	mov eax, [rsi + 8]
	mov [rbp + 116], eax
 ...
 asctime$43:
	; Parameter signedint £temporary2845 -> tp 120
	mov eax, [rsi + 4]
	mov [rbp + 120], eax
 ...
 asctime$45:
	; Parameter signedint £temporary2846 -> tp 124
	mov eax, [rsi]
	mov [rbp + 124], eax
 ...
 asctime$47:
	; BinaryAdd £temporary2848 £temporary2847 -> tp 1900
	mov eax, [rsi + 20]
	add eax, 1900

 asctime$48:
	; Parameter signedint £temporary2848 128
	mov [rbp + 128], eax
...
section .text
 ...
 ctime$6:
	; Parameter pointer £temporary2850 56
	mov [rbp + 56], rbx
...
section .text
 ...
 localtime$9:
	; GetReturnValue £temporary2853

 localtime$10:
	; Assign localeConvPtr £temporary2853
	mov [rbp + 40], rbx
 ...
 localtime$13:
	; Dereference £temporary2855 -> tmPtr tmPtr 0
	mov rsi, [rbp + 32]

 localtime$14:
	; Equal 18 £temporary2855 -> tmPtr 0
	cmp dword [rsi + 32], 0
	je localtime$18
 ...
 localtime$16:
	; Assign £temporary2859 £temporary2856 -> localeConvPtr
	mov eax, [rsi]
 ...
 localtime$18:
	; Dereference £temporary2857 -> localeConvPtr localeConvPtr 0
	mov rsi, [rbp + 40]

 localtime$19:
	; Assign £temporary2859 £temporary2857 -> localeConvPtr
	mov eax, [rsi + 4]

 localtime$20:
	; Assign timeZone £temporary2859
	mov [rbp + 48], eax

 localtime$21:
	; Dereference £temporary2860 -> timePtr timePtr 0
	mov rsi, [rbp + 24]

 localtime$22:
	; SignedMultiply £temporary2861 timeZone 3600
	mov eax, [rbp + 48]
	xor edx, edx
 ...
 localtime$24:
	; BinaryAdd time £temporary2860 -> timePtr £temporary2862
	mov rbx, [rsi]
	add rbx, rax
	mov [rbp + 52], rbx
 ...
 localtime$26:
	; Address £temporary2864 time
	mov rsi, rbp
	add rsi, 52

 localtime$27:
	; Parameter pointer £temporary2864 84
	mov [rbp + 84], rsi
 ...
 localtime$30:
	; GetReturnValue £temporary2865

 localtime$31:
	; Return £temporary2865
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
	jmp rax
...
section .text
 ...
 strftime$3:
	; GetReturnValue £temporary2867

 strftime$4:
	; Assign localeConvPtr £temporary2867
	mov [rbp + 52], rbx
 ...
 strftime$10:
	; Assign shortDayList £temporary2870
	mov [rbp + 60], rax
 ...
 strftime$22:
	; Assign longDayList £temporary2876
	mov [rbp + 76], rax
 ...
 strftime$28:
	; Assign longMonthList £temporary2879
	mov [rbp + 84], rax
 ...
 strftime$35:
	; Assign £temporary2882 shortDayList
	mov rax, [rbp + 60]
 ...
 strftime$37:
	; Assign £temporary2882 g_defaultShortDayList
	mov rax, @4766$g_defaultShortDayList

 strftime$38:
	; Assign shortDayList £temporary2882
	mov [rbp + 60], rax
 ...
 strftime$40:
	; Assign £temporary2884 longDayList
	mov rax, [rbp + 76]
 ...
 strftime$42:
	; Assign £temporary2884 g_defaultLongDayList
	mov rax, @4767$g_defaultLongDayList

 strftime$43:
	; Assign longDayList £temporary2884
	mov [rbp + 76], rax
 ...
 strftime$45:
	; Assign £temporary2886 shortMonthList
	mov rax, [rbp + 68]
 ...
 strftime$47:
	; Assign £temporary2886 g_defaultShortMonthList
	mov rax, @4768$g_defaultShortMonthList

 strftime$48:
	; Assign shortMonthList £temporary2886
	mov [rbp + 68], rax
 ...
 strftime$50:
	; Assign £temporary2888 longMonthList
	mov rax, [rbp + 84]
 ...
 strftime$52:
	; Assign £temporary2888 g_defaultLongMonthList
	mov rax, @4769$g_defaultLongMonthList
 ...
 strftime$55:
	; BinarySubtract £temporary2890 £temporary2889 -> tp 69
	mov eax, [rsi + 20]
	sub eax, 69

 strftime$56:
	; SignedDivide leapDays £temporary2890 4
	xor edx, edx
	idiv dword [int4$4#]
	mov [rbp + 92], eax
 ...
 strftime$58:
	; BinarySubtract £temporary2893 £temporary2892 -> tp 70
	mov eax, [rsi + 20]
	sub eax, 70

 strftime$59:
	; SignedMultiply £temporary2894 £temporary2893 365
	xor edx, edx
	imul dword [int4$365#]

 strftime$60:
	; BinaryAdd £temporary2895 £temporary2894 leapDays
	add eax, [rbp + 92]
 ...
 strftime$62:
	; BinaryAdd £temporary2897 £temporary2895 £temporary2896 -> tp
	add eax, [rsi + 28]
 ...
 strftime$64:
	; Assign totalDays £temporary2898
	mov [rbp + 96], rax
 ...
 strftime$66:
	; BinaryAdd £temporary2900 totalDays 4
	mov rax, [rbp + 96]
	add rax, 4
 ...
 strftime$68:
	; Assign yearDaySunday £temporary2901
	mov [rbp + 104], eax
 ...
 strftime$70:
	; BinarySubtract £temporary2902 totalDays 3
	mov rax, [rbp + 96]
	sub rax, 3
 ...
 strftime$73:
	; Assign yearDaySunday £temporary2904
	mov [rbp + 104], edx
 ...
 strftime$75:
	; BinaryAdd £temporary2906 totalDays 3
	mov rax, [rbp + 96]
	add rax, 3
 ...
 strftime$77:
	; Assign yearDayMonday £temporary2907
	mov [rbp + 108], eax
 ...
 strftime$79:
	; BinarySubtract £temporary2908 totalDays 4
	mov rax, [rbp + 96]
	sub rax, 4

 strftime$80:
	; SignedModulo £temporary2909 £temporary2908 7
	xor rdx, rdx
	idiv qword [int8$7#]
 ...
 strftime$82:
	; Assign yearDayMonday £temporary2910
	mov [rbp + 108], edx
 ...
 strftime$87:
	; Equal 358 £temporary2911 -> £temporary2914 0
	cmp byte [rsi], 0
	je strftime$358
 ...
 strftime$91:
	; NotEqual 332 £temporary2917 -> £temporary2920 37
	cmp byte [rsi], 37
	jne strftime$332

 strftime$92:
	; BinaryAdd £temporary2922 index 1
	mov eax, [rbp + 112]
	inc eax

 strftime$93:
	; IntegralToIntegral £temporary2924 £temporary2922
	mov rbx, 4294967295
	and rax, rbx

 strftime$94:
	; BinaryAdd £temporary2926 fmt £temporary2924
	mov rsi, [rbp + 36]
	add rsi, rax
 ...
 strftime$96:
	; Case 120 £temporary2923 -> £temporary2926 97
	mov al, [rsi]
	cmp al, 97
	je strftime$120

 strftime$97:
	; Case 131 £temporary2923 -> £temporary2926 65
	cmp al, 65
	je strftime$131

 strftime$98:
	; Case 142 £temporary2923 -> £temporary2926 98
	cmp al, 98
	je strftime$142

 strftime$99:
	; Case 153 £temporary2923 -> £temporary2926 66
	cmp al, 66
	je strftime$153

 strftime$100:
	; Case 164 £temporary2923 -> £temporary2926 99
	cmp al, 99
	je strftime$164

 strftime$101:
	; Case 184 £temporary2923 -> £temporary2926 100
	cmp al, 100
	je strftime$184

 strftime$102:
	; Case 192 £temporary2923 -> £temporary2926 72
	cmp al, 72
	je strftime$192

 strftime$103:
	; Case 200 £temporary2923 -> £temporary2926 73
	cmp al, 73
	je strftime$200

 strftime$104:
	; Case 209 £temporary2923 -> £temporary2926 106
	cmp al, 106
	je strftime$209

 strftime$105:
	; Case 217 £temporary2923 -> £temporary2926 109
	cmp al, 109
	je strftime$217

 strftime$106:
	; Case 226 £temporary2923 -> £temporary2926 77
	cmp al, 77
	je strftime$226

 strftime$107:
	; Case 234 £temporary2923 -> £temporary2926 112
	cmp al, 112
	je strftime$234

 strftime$108:
	; Case 246 £temporary2923 -> £temporary2926 83
	cmp al, 83
	je strftime$246

 strftime$109:
	; Case 254 £temporary2923 -> £temporary2926 85
	cmp al, 85
	je strftime$254

 strftime$110:
	; Case 261 £temporary2923 -> £temporary2926 119
	cmp al, 119
	je strftime$261

 strftime$111:
	; Case 269 £temporary2923 -> £temporary2926 87
	cmp al, 87
	je strftime$269

 strftime$112:
	; Case 276 £temporary2923 -> £temporary2926 120
	cmp al, 120
	je strftime$276

 strftime$113:
	; Case 290 £temporary2923 -> £temporary2926 88
	cmp al, 88
	je strftime$290

 strftime$114:
	; Case 302 £temporary2923 -> £temporary2926 121
	cmp al, 121
	je strftime$302

 strftime$115:
	; Case 311 £temporary2923 -> £temporary2926 89
	cmp al, 89
	je strftime$311

 strftime$116:
	; Case 320 £temporary2923 -> £temporary2926 90
	cmp al, 90
	je strftime$320

 strftime$117:
	; Case 326 £temporary2923 -> £temporary2926 37
	cmp al, 37
	je strftime$326

 strftime$118:
	; CaseEnd £temporary2923 -> £temporary2926
 ...
 strftime$125:
	; BinaryAdd £temporary2931 shortDayList £temporary2930
	mov rsi, [rbp + 60]
	add rsi, rax
 ...
 strftime$127:
	; Parameter pointer £temporary2928 -> £temporary2931 168
	mov rax, [rsi]
	mov [rbp + 168], rax
 ...
 strftime$136:
	; BinaryAdd £temporary2937 longDayList £temporary2936
	mov rsi, [rbp + 76]
	add rsi, rax
 ...
 strftime$138:
	; Parameter pointer £temporary2934 -> £temporary2937 168
	mov rax, [rsi]
	mov [rbp + 168], rax
 ...
 strftime$147:
	; BinaryAdd £temporary2943 shortMonthList £temporary2942
	mov rsi, [rbp + 68]
	add rsi, rax
 ...
 strftime$149:
	; Parameter pointer £temporary2940 -> £temporary2943 168
	mov rax, [rsi]
	mov [rbp + 168], rax
 ...
 strftime$156:
	; IntegralToIntegral £temporary2947 £temporary2945 -> tp
	mov eax, [rsi + 16]
	mov rbx, 4294967295
	and rax, rbx

 strftime$157:
	; UnsignedMultiply £temporary2948 £temporary2947 8
	xor rdx, rdx
	mul qword [int8$8#]

 strftime$158:
	; BinaryAdd £temporary2949 longMonthList £temporary2948
	mov rsi, [rbp + 84]
	add rsi, rax

 strftime$159:
	; Dereference £temporary2946 -> £temporary2949 £temporary2949 0

 strftime$160:
	; Parameter pointer £temporary2946 -> £temporary2949 168
	mov rax, [rsi]
	mov [rbp + 168], rax
 ...
 strftime$168:
	; BinaryAdd £temporary2952 £temporary2951 -> tp 1900
	mov eax, [rsi + 20]
	add eax, 1900
 ...
 strftime$171:
	; BinaryAdd £temporary2954 £temporary2953 -> tp 1
	mov eax, [rsi + 16]
	inc eax

 strftime$172:
	; Parameter signedint £temporary2954 180
	mov [rbp + 180], eax
 ...
 strftime$174:
	; Parameter signedint £temporary2955 -> tp 184
	mov eax, [rsi + 12]
	mov [rbp + 184], eax
 ...
 strftime$176:
	; Parameter signedint £temporary2956 -> tp 188
	mov eax, [rsi + 8]
	mov [rbp + 188], eax
 ...
 strftime$178:
	; Parameter signedint £temporary2957 -> tp 192
	mov eax, [rsi + 4]
	mov [rbp + 192], eax
 ...
 strftime$180:
	; Parameter signedint £temporary2958 -> tp 196
	mov eax, [rsi]
	mov [rbp + 196], eax
 ...
 strftime$188:
	; Parameter signedint £temporary2960 -> tp 176
	mov eax, [rsi + 12]
	mov [rbp + 176], eax
 ...
 strftime$196:
	; Parameter signedint £temporary2962 -> tp 176
	mov eax, [rsi + 8]
	mov [rbp + 176], eax
 ...
 strftime$204:
	; SignedModulo £temporary2965 £temporary2964 -> tp 12
	mov eax, [rsi + 8]
	xor edx, edx
	idiv dword [int4$12#]

 strftime$205:
	; Parameter signedint £temporary2965 176
	mov [rbp + 176], edx
 ...
 strftime$221:
	; BinaryAdd £temporary2970 £temporary2969 -> tp 1
	mov eax, [rsi + 16]
	inc eax

 strftime$222:
	; Parameter signedint £temporary2970 176
	mov [rbp + 176], eax
 ...
 strftime$230:
	; Parameter signedint £temporary2972 -> tp 176
	mov eax, [rsi + 4]
	mov [rbp + 176], eax
 ...
 strftime$238:
	; SignedGreaterThanEqual 241 £temporary2974 -> tp 12
	cmp dword [rsi + 8], 12
	jge strftime$241

 strftime$239:
	; Assign £temporary2976 "AM"
	mov rax, string_AM#
 ...
 strftime$241:
	; Assign £temporary2976 "PM"
	mov rax, string_PM#

 strftime$242:
	; Parameter pointer £temporary2976 176
	mov [rbp + 176], rax
 ...
 strftime$250:
	; Parameter signedint £temporary2978 -> tp 176
	mov eax, [rsi]
	mov [rbp + 176], eax
 ...
 strftime$280:
	; BinaryAdd £temporary2985 £temporary2984 -> tp 1900
	mov eax, [rsi + 20]
	add eax, 1900

 strftime$281:
	; Parameter signedint £temporary2985 176
	mov [rbp + 176], eax
 ...
 strftime$283:
	; BinaryAdd £temporary2987 £temporary2986 -> tp 1
	mov eax, [rsi + 16]
	inc eax

 strftime$284:
	; Parameter signedint £temporary2987 180
	mov [rbp + 180], eax
 ...
 strftime$286:
	; Parameter signedint £temporary2988 -> tp 184
	mov eax, [rsi + 12]
	mov [rbp + 184], eax
 ...
 strftime$296:
	; Parameter signedint £temporary2991 -> tp 180
	mov eax, [rsi + 4]
	mov [rbp + 180], eax
 ...
 strftime$298:
	; Parameter signedint £temporary2992 -> tp 184
	mov eax, [rsi]
	mov [rbp + 184], eax
 ...
 strftime$306:
	; SignedModulo £temporary2995 £temporary2994 -> tp 100
	mov eax, [rsi + 20]
	xor edx, edx
	idiv dword [int4$100#]
 ...
 strftime$316:
	; Parameter signedint £temporary2998 176
	mov [rbp + 176], eax
 ...
 strftime$332:
	; Dereference £temporary3002 -> add add 0
	mov rsi, rbp
	add rsi, 116
 ...
 strftime$334:
	; BinaryAdd £temporary3006 fmt £temporary3004
	mov rdi, [rbp + 36]
	add rdi, rax
 ...
 strftime$336:
	; Assign £temporary3002 -> add £temporary3003 -> £temporary3006
	mov al, [rdi]
	mov [rsi], al

 strftime$337:
	; Dereference £temporary3007 -> add add 0
	mov rsi, rbp
	add rsi, 116

 strftime$338:
	; Assign £temporary3007 -> add 0
	mov byte [rsi + 1], 0
 ...
 strftime$349:
	; BinaryAdd £temporary3010 £temporary3008 £temporary3009
	add eax, ebx

 strftime$350:
	; SignedGreaterThanEqual 358 £temporary3010 smax
	cmp eax, [rbp + 32]
	jge strftime$358
