...
section .text
 ...
 @6967$main$28:
	; Parameter 80 double £temporary3744
	fstp qword [rbp + 80]

 @6967$main$29:
	; Call 40 printf 16
	mov qword [rbp + 40], @6967$main$30
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 16
...
section .text
 ...
 divide$5:
	; SignedDivide £temporary3755 x y
	fdiv
...
section .text
 ...
 test$18:
	; Parameter 80 double £temporary3760
	fstp qword [rbp + 80]
