...
@10486$string_Please20input20a20value3A20#:
...
@10490$string_12E0202F2025f203D2025f0A#:
...
section .text
 ...
 @10483$main$1:
	...
	mov qword [rbp + 64], @10486$string_Please20input20a20value3A20#

 @10483$main$2:
	; Call 40 printf 0
	mov qword [rbp + 40], @10483$main$3
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	jmp printf
 ...
 @10483$main$5:
	...
	mov qword [rbp + 64], @10487$string_25lf#
 ...
 @10483$main$12:
	; Call 40 setjmp 0
	mov qword [rbp + 40], @10483$main$13
	mov [rbp + 48], rbp
	add rbp, 40
	jmp setjmp
 ...
 @10483$main$19:
	...
	mov qword [rbp + 64], @10490$string_12E0202F2025f203D2025f0A#
 ...
 @10483$main$25:
	; Call 80 inverse 0
	mov qword [rbp + 80], @10483$main$26
	mov [rbp + 88], rbp
	add rbp, 80
	jmp inverse
 ...
 @10483$main$29:
	; Call 40 printf 16
	mov qword [rbp + 40], @10483$main$30
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 16
 ...
 @10483$main$33:
	...
	mov qword [rbp + 64], @10491$string_25s0A#
 ...
 @10483$main$35:
	; Call 40 printf 8
	mov qword [rbp + 40], @10483$main$36
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 8
...
@10506$string_Division20by20Zero2E#:
...
section .text
 ...
 divide$10:
	...
	mov qword [rbp + 72], @10506$string_Division20by20Zero2E#
...
@10515$string_12E0202F2025f203D2025f0A#:
	; Initializer String 1.0 / %f = %f\n
	db "1.0 / %f = %f", 10, 0
...
section .text
 ...
 test$9:
	; Parameter 64 pointer "1.0 / %f = %f\n"
	mov qword [rbp + 64], @10515$string_12E0202F2025f203D2025f0A#
 ...
 test$23:
	; Parameter 64 pointer "%s\n"
	mov qword [rbp + 64], @10516$string_25s0A#
