...
@10749$string_Please20input20a20value3A20#:
...
@10753$string_12E0202F2025f203D2025f0A#:
...
section .text
 ...
 @10746$main$1:
	...
	mov qword [rbp + 64], @10749$string_Please20input20a20value3A20#

 @10746$main$2:
	; Call 40 printf 0
	mov qword [rbp + 40], @10746$main$3
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	jmp printf
 ...
 @10746$main$5:
	...
	mov qword [rbp + 64], @10750$string_25lf#

 @10746$main$6:
	; Address £temporary3638 x
	mov rsi, rbp
	add rsi, 32

 @10746$main$7:
	; Parameter 72 pointer £temporary3638
	mov [rbp + 72], rsi

 @10746$main$8:
	; Call 40 scanf 8
	mov qword [rbp + 40], @10746$main$9
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 8
 ...
 @10746$main$12:
	; Call 40 setjmp 0
	mov qword [rbp + 40], @10746$main$13
	mov [rbp + 48], rbp
	add rbp, 40
	jmp setjmp
 ...
 @10746$main$19:
	...
	mov qword [rbp + 64], @10753$string_12E0202F2025f203D2025f0A#
 ...
 @10746$main$25:
	; Call 80 inverse 0
	mov qword [rbp + 80], @10746$main$26
	mov [rbp + 88], rbp
	add rbp, 80
	jmp inverse
 ...
 @10746$main$28:
	; Parameter 80 double £temporary3643
	fstp qword [rbp + 80]

 @10746$main$29:
	; Call 40 printf 16
	mov qword [rbp + 40], @10746$main$30
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 16
 ...
 @10746$main$33:
	...
	mov qword [rbp + 64], @10754$string_25s0A#
 ...
 @10746$main$35:
	; Call 40 printf 8
	mov qword [rbp + 40], @10746$main$36
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 8
...
@10769$string_Division20by20Zero2E#:
...
section .text
 ...
 divide$5:
	; SignedDivide £temporary3654 x y
	fdiv
 ...
 divide$10:
	...
	mov qword [rbp + 72], @10769$string_Division20by20Zero2E#
...
@10778$string_12E0202F2025f203D2025f0A#:
	; Initializer String 1.0 / %f = %f\n
	db "1.0 / %f = %f", 10, 0
...
section .text
 ...
 test$5:
	; IntegralToIntegral £temporary3657 £temporary3656
	mov rax, 4294967295
	and rbx, rax

 test$6:
	; Assign message £temporary3657
	mov [rbp + 32], rbx
 ...
 test$9:
	; Parameter 64 pointer "1.0 / %f = %f\n"
	mov qword [rbp + 64], @10778$string_12E0202F2025f203D2025f0A#
 ...
 test$18:
	; Parameter 80 double £temporary3659
	fstp qword [rbp + 80]
 ...
 test$23:
	; Parameter 64 pointer "%s\n"
	mov qword [rbp + 64], @10779$string_25s0A#
