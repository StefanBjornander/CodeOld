...
@9101string_Please20input20a20value3A20#:
...
@9105string_12E0202F2025f203D2025f0A#:
...
section .text
 ...
 @9098$main$1:
	...
	mov qword [rbp + 64], @9101string_Please20input20a20value3A20#

 @9098$main$2:
	; Call 40 printf 0
	mov qword [rbp + 40], @9098$main$3
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	jmp printf
 ...
 @9098$main$5:
	...
	mov qword [rbp + 64], @9102string_25lf#
 ...
 @9098$main$19:
	...
	mov qword [rbp + 64], @9105string_12E0202F2025f203D2025f0A#
 ...
 @9098$main$33:
	...
	mov qword [rbp + 64], @9106string_25s0A#
...
@9121string_Division20by20Zero2E#:
...
section .text
 ...
 divide$10:
	...
	mov rax, @9121string_Division20by20Zero2E#
...
@9130string_12E0202F2025f203D2025f0A#:
	; Initializer String 1.0 / %f = %f\n
	db "1.0 / %f = %f", 10, 0
...
section .text
 ...
 test$9:
	; Parameter 64 pointer string_12E0202F2025f203D2025f0A#
	mov qword [rbp + 64], @9130string_12E0202F2025f203D2025f0A#
 ...
 test$23:
	; Parameter 64 pointer string_25s0A#
	mov qword [rbp + 64], @9131string_25s0A#
