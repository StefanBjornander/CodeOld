...
section .text
 ...
 @6941$main$15:
	; IntegralToIntegral £temporary3707 £temporary3706
	mov rax, 4294967295
	and rbx, rax

 @6941$main$16:
	; Assign message £temporary3707
	mov [rbp + 24], rbx
 ...
 @6941$main$28:
	; Parameter 80 double £temporary3709
	fstp qword [rbp + 80]
...
section .text
 ...
 divide$5:
	; SignedDivide £temporary3720 x y
	fdiv
 ...
 divide$10:
	; IntegralToIntegral £temporary3721 "Division by Zero."
	mov eax, string_Division20by20Zero2E#

 divide$11:
	; Parameter 72 signedint £temporary3721
	mov [rbp + 72], eax
