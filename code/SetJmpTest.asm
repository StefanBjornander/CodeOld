...
@10549string_Please20input20a20value3A20#:
...
@10553string_12E0202F2025f203D2025f0A#:
...
section .text
 ...
 @10546$main$1:
	...
	mov qword [rbp + 64], @10549string_Please20input20a20value3A20#

 @10546$main$2:
	; Call 40 printf 0
	mov qword [rbp + 40], @10546$main$3
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	jmp printf
 ...
 @10546$main$5:
	...
	mov qword [rbp + 64], @10550string_25lf#
 ...
 @10546$main$12:
	; Call 40 setjmp 0
	mov qword [rbp + 40], @10546$main$13
	mov [rbp + 48], rbp
	add rbp, 40
	jmp setjmp
 ...
 @10546$main$19:
	...
	mov qword [rbp + 64], @10553string_12E0202F2025f203D2025f0A#
 ...
 @10546$main$25:
	; Call 80 inverse 0
	mov qword [rbp + 80], @10546$main$26
	mov [rbp + 88], rbp
	add rbp, 80
	jmp inverse
 ...
 @10546$main$29:
	; Call 40 printf 16
	mov qword [rbp + 40], @10546$main$30
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 16
 ...
 @10546$main$33:
	...
	mov qword [rbp + 64], @10554string_25s0A#
 ...
 @10546$main$35:
	; Call 40 printf 8
	mov qword [rbp + 40], @10546$main$36
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 8
...
@10570string_Division20by20Zero2E#:
...
section .text
 ...
 divide$10:
	; IntegralToIntegral £temporary3343 string_Division20by20Zero2E#
...
@10579string_12E0202F2025f203D2025f0A#:
	; Initializer String 1.0 / %f = %f\n
	db "1.0 / %f = %f", 10, 0
...
section .text
 ...
 test$9:
	; Parameter 64 pointer string_12E0202F2025f203D2025f0A#
	mov qword [rbp + 64], @10579string_12E0202F2025f203D2025f0A#
 ...
 test$23:
	; Parameter 64 pointer string_25s0A#
	mov qword [rbp + 64], @10580string_25s0A#
...
section .text
 ...
 setjmp_test$1:
	; PushFloat Double$10#
	fld qword [@10588Double$10#]

 setjmp_test$2:
	; Parameter 48 double Double$10#
	fstp qword [rbp + 48]
 ...
 setjmp_test$11:
	; PushFloat Double$0.1#
	fld qword [@10594Double$0.1#]

 setjmp_test$12:
	; Parameter 48 double Double$0.1#
	fstp qword [rbp + 48]
