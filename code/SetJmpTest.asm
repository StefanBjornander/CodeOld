...
section .text
 ...
 divide$5:
	; SignedDivide £temporary3076 x y
	fdiv
 ...
 divide$10:
	; IntegralToIntegral £temporary3077 p
	mov rax, [rbp + 40]

 divide$11:
	; Parameter signedint £temporary3077 80
	mov [rbp + 80], eax
...
section .text
 ...
 setjmp_test$19:
	; Parameter double £temporary3085 80
	fstp qword [rbp + 80]
