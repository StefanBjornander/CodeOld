...
section .text
 ...
 @6941$main$6:
	; Address £temporary3643 x
	mov rsi, rbp
	add rsi, 32

 @6941$main$7:
	; Parameter pointer £temporary3643 72
	mov [rbp + 72], rsi

 @6941$main$8:
	; Call scanf 40 8
	mov qword [rbp + 40], @6941$main$9
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 8
 ...
 @6941$main$28:
	; Parameter double £temporary3648 80
	fstp qword [rbp + 80]

 @6941$main$29:
	; Call printf 40 16
	mov qword [rbp + 40], @6941$main$30
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 16
...
section .text
 ...
 divide$5:
	; SignedDivide £temporary3659 x y
	fdiv

 divide$6:
	; Return £temporary3659
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
	jmp rax
 ...
 divide$9:
	; IntegralToIntegral £temporary3660 "Division by Zero."
	mov rax, string_Division20by20Zero2E#

 divide$10:
	; Parameter signedint £temporary3660 72
	mov [rbp + 72], eax
