...
@10549$string_Please20input20a20value3A20#:
...
@10553$string_12E0202F2025f203D2025f0A#:
...
section .text
 ...
 @10546$main$1:
	...
	mov qword [rbp + 64], @10549$string_Please20input20a20value3A20#
 ...
 @10546$main$5:
	...
	mov qword [rbp + 64], @10550$string_25lf#
 ...
 @10546$main$19:
	...
	mov qword [rbp + 64], @10553$string_12E0202F2025f203D2025f0A#
 ...
 @10546$main$33:
	...
	mov qword [rbp + 64], @10554$string_25s0A#
...
@10570$string_Division20by20Zero2E#:
...
section .text
 ...
 divide$10:
	...
	mov rax, @10570$string_Division20by20Zero2E#
...
@10579$string_12E0202F2025f203D2025f0A#:
	; Initializer String 1.0 / %f = %f\n
	db "1.0 / %f = %f", 10, 0
...
section .text
 ...
 test$9:
	; Parameter 64 pointer "1.0 / %f = %f\n"
	mov qword [rbp + 64], @10579$string_12E0202F2025f203D2025f0A#
 ...
 test$23:
	; Parameter 64 pointer "%s\n"
	mov qword [rbp + 64], @10580$string_25s0A#
