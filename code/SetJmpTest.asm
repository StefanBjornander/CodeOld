...
@10564$string_Please20input20a20value3A20#:
...
@10568$string_12E0202F2025f203D2025f0A#:
...
section .text
 ...
 @10561$main$1:
	...
	mov qword [rbp + 64], @10564$string_Please20input20a20value3A20#

 @10561$main$2:
	; Call 40 printf 0
	mov qword [rbp + 40], @10561$main$3
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	jmp printf
 ...
 @10561$main$5:
	...
	mov qword [rbp + 64], @10565$string_25lf#

 @10561$main$6:
	; Address £temporary3340 x
	mov rsi, rbp
	add rsi, 32

 @10561$main$7:
	; Parameter 72 pointer £temporary3340
	mov [rbp + 72], rsi

 @10561$main$8:
	; Call 40 scanf 8
	mov qword [rbp + 40], @10561$main$9
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 8
 ...
 @10561$main$12:
	; Call 40 setjmp 0
	mov qword [rbp + 40], @10561$main$13
	mov [rbp + 48], rbp
	add rbp, 40
	jmp setjmp
 ...
 @10561$main$15:
	; IntegralToIntegral £temporary3343 £temporary3342
	mov rax, 4294967295
	and rbx, rax

 @10561$main$16:
	; Assign message £temporary3343
	mov [rbp + 24], rbx
 ...
 @10561$main$19:
	...
	mov qword [rbp + 64], @10568$string_12E0202F2025f203D2025f0A#
 ...
 @10561$main$25:
	; Call 80 inverse 0
	mov qword [rbp + 80], @10561$main$26
	mov [rbp + 88], rbp
	add rbp, 80
	jmp inverse
 ...
 @10561$main$28:
	; Parameter 80 double £temporary3345
	fstp qword [rbp + 80]

 @10561$main$29:
	; Call 40 printf 16
	mov qword [rbp + 40], @10561$main$30
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 16
 ...
 @10561$main$33:
	...
	mov qword [rbp + 64], @10569$string_25s0A#
 ...
 @10561$main$35:
	; Call 40 printf 8
	mov qword [rbp + 40], @10561$main$36
	mov [rbp + 48], rbp
	add rbp, 40
	mov rdi, rbp
	add rdi, 8
...
@10585$string_Division20by20Zero2E#:
...
section .text
 ...
 divide$10:
	; IntegralToIntegral £temporary3357 "Division by Zero."
	mov rax, @10585$string_Division20by20Zero2E#

 divide$11:
	; Parameter 72 signedint £temporary3357
	mov [rbp + 72], eax
...
@10594$string_12E0202F2025f203D2025f0A#:
	; Initializer String 1.0 / %f = %f\n
	db "1.0 / %f = %f", 10, 0
...
section .text
 ...
 test$9:
	; Parameter 64 pointer "1.0 / %f = %f\n"
	mov qword [rbp + 64], @10594$string_12E0202F2025f203D2025f0A#
 ...
 test$23:
	; Parameter 64 pointer "%s\n"
	mov qword [rbp + 64], @10595$string_25s0A#
