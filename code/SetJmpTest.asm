...
divide$5:	; £temporary4051 = x / y
	fdiv 

divide$6:	; return_value = £temporary4051
...
divide$17:	; £temporary4053 = int_to_int p (Pointer -> Signed_Int)
	mov rax, [rbp + 40]

divide$18:	; parameter £temporary4053, offset 80
	mov [rbp + 80], eax
...
invers$7:	; £temporary4060 = return_value

invers$8:	; return_value = £temporary4060
...
setjmp_test$5:	; £temporary4063 = return_value

setjmp_test$6:	; £temporary4064 = int_to_int £temporary4063 (Signed_Int -> Pointer)
	mov rax, 4294967295
	and rbx, rax

setjmp_test$7:	; p = £temporary4064
	mov [rbp + 32], rbx
...
setjmp_test$18:	; £temporary4066 = return_value

setjmp_test$19:	; parameter £temporary4066, offset 80
	fstp qword [rbp + 80]
