...
_start:
 ...
 main$2:
	; parameter string_argc3A2025i0A#, offset 92
	mov qword [rbp + 92], string_argc3A2025i0A#

 main$3:
	; parameter argc, offset 100
	mov eax, [rbp + 24]
	mov [rbp + 100], eax

 main$4:
	; call function noellipse-ellipse printf, extra 4
	mov qword [rbp + 68], main$5
	mov [rbp + 76], rbp
	add rbp, 68
	mov rdi, rbp
	add rdi, 4
 ...
 main$9:
	; parameter string_25i3A203C25s3E0A#, offset 96
	mov qword [rbp + 96], string_25i3A203C25s3E0A#

 main$10:
	; parameter index, offset 104
	mov eax, [rbp + 68]
	mov [rbp + 104], eax
 ...
 main$15:
	; parameter £temporary69 -> £temporary72, offset 108
	mov rax, [rsi]
	mov [rbp + 108], rax

 main$16:
	; call function noellipse-ellipse printf, extra 12
	mov qword [rbp + 72], main$17
	mov [rbp + 80], rbp
	add rbp, 72
	mov rdi, rbp
	add rdi, 12
 ...
 main$21:
	; parameter string_0A#, offset 96
	mov qword [rbp + 96], string_0A#

 main$22:
	; call function noellipse-ellipse printf, extra 0
	mov qword [rbp + 72], main$23
	mov [rbp + 80], rbp
	add rbp, 72
	mov rdi, rbp
	jmp printf
 ...
 main$37:
	; parameter £temporary81 -> £temporary84, offset 108
	mov rax, [rsi]
	mov [rbp + 108], rax

 main$38:
	; call function noellipse-ellipse printf, extra 12
	mov qword [rbp + 72], main$39
	mov [rbp + 80], rbp
	add rbp, 72
	mov rdi, rbp
	add rdi, 12
 ...
 main$47:
	; parameter int8$0#, offset 129
	mov qword [rbp + 129], 0

 main$48:
	; call function noellipse-noellipse mktime
	mov qword [rbp + 105], main$49
	mov [rbp + 113], rbp
	add rbp, 105
	jmp mktime
 ...
 main$51:
	; parameter string_Hello210A#, offset 129
	mov qword [rbp + 129], string_Hello210A#

 main$52:
	; call function noellipse-ellipse printf, extra 0
	mov qword [rbp + 105], main$53
	mov [rbp + 113], rbp
	add rbp, 105
	mov rdi, rbp
	jmp printf
 ...
 main$55:
	; parameter string_Please20write20a20character2C20a20string2C20an20integer2C20and20a20double3A20#, offset 129
	mov qword [rbp + 129], string_Please20write20a20character2C20a20string2C20an20integer2C20and20a20double3A20#

 main$56:
	; call function noellipse-ellipse printf, extra 0
	mov qword [rbp + 105], main$57
	mov [rbp + 113], rbp
	add rbp, 105
	mov rdi, rbp
	jmp printf
 ...
 main$59:
	; parameter string_25c2025s2025i2025lf#, offset 129
	mov qword [rbp + 129], string_25c2025s2025i2025lf#
 ...
 main$61:
	; parameter £temporary90, offset 137
	mov [rbp + 137], rsi

 main$62:
	; parameter s, offset 145
	mov [rbp + 145], rbp
	add qword [rbp + 145], 85
 ...
 main$64:
	; parameter £temporary91, offset 153
	mov [rbp + 153], rsi
 ...
 main$66:
	; parameter £temporary92, offset 161
	mov [rbp + 161], rsi

 main$67:
	; call function noellipse-ellipse scanf, extra 32
	mov qword [rbp + 105], main$68
	mov [rbp + 113], rbp
	add rbp, 105
	mov rdi, rbp
	add rdi, 32
 ...
 main$70:
	; parameter string_You20wrote20the20character202725c272C20the20string202225s222C20the20integer2025i2C20and20the20double2025f2E0A#, offset 129
	mov qword [rbp + 129], string_You20wrote20the20character202725c272C20the20string202225s222C20the20integer2025i2C20and20the20double2025f2E0A#
 ...
 main$72:
	; parameter £temporary94, offset 137
	mov [rbp + 137], eax

 main$73:
	; parameter s, offset 141
	mov [rbp + 141], rbp
	add qword [rbp + 141], 85

 main$74:
	; parameter i, offset 149
	mov eax, [rbp + 72]
	mov [rbp + 149], eax
 ...
 main$76:
	; parameter d, offset 153
	fstp qword [rbp + 153]

 main$77:
	; call function noellipse-ellipse printf, extra 24
	mov qword [rbp + 105], main$78
	mov [rbp + 113], rbp
	add rbp, 105
	mov rdi, rbp
	add rdi, 24
 ...
 main2$4:
	; parameter string_test12Etxt#, offset 48
	mov qword [rbp + 48], string_test12Etxt#

 main2$5:
	; parameter string_test22Etxt#, offset 56
	mov qword [rbp + 56], string_test22Etxt#

 main2$6:
	; call function noellipse-noellipse file_test
 ...
 main33$13:
	; parameter string_3C25s3E203C25s3E0A#, offset 88
	mov qword [rbp + 88], string_3C25s3E203C25s3E0A#

 main33$14:
	; parameter s, offset 96
	mov [rbp + 96], rbp
	add qword [rbp + 96], 24

 main33$15:
	; parameter t, offset 104
	mov [rbp + 104], rbp
 ...
 mainc$2:
	; parameter string_Please20write20a20character3A20#, offset 49
 ...
 mainc$6:
	; parameter string_25c#, offset 49
 ...
 mainc$8:
	; parameter £temporary19, offset 57
	mov [rbp + 57], rsi

 mainc$9:
	; call function noellipse-ellipse scanf, extra 8
 ...
 mainc$12:
	; parameter string_You20wrote20the20character202725c272E0A#, offset 49
 ...
 mainc$14:
	; parameter £temporary21, offset 57
	mov [rbp + 57], eax
 ...
 maini$2:
	; parameter string_Please20write20an20integer3A20#, offset 52
 ...
 maini$6:
	; parameter string_25i#, offset 52
 ...
 maini$8:
	; parameter £temporary25, offset 60
	mov [rbp + 60], rsi
 ...
 maini$12:
	; parameter string_You20wrote20the20integer2025i2E0A#, offset 52
	mov qword [rbp + 52], string_You20wrote20the20integer2025i2E0A#

 maini$13:
	; parameter i, offset 60
	mov eax, [rbp + 24]
	mov [rbp + 60], eax
 ...
 mains$2:
	; parameter string_Please20write20a20string3A20#, offset 68
 ...
 mains$6:
	; parameter string_25s#, offset 68
 ...
 mains$11:
	; parameter string_You20wrote20the20string202225s222E0A#, offset 68
 ...
 maint$1:
	; call function noellipse-noellipse limits_test
 ...
 maint$4:
	; call function noellipse-noellipse time_test
 ...
 mainY$1:
	; call function noellipse-noellipse malloc_test
 ...
 mainY$5:
	; parameter float8$10#, offset 48
	fstp qword [rbp + 48]

 mainY$6:
	; call function noellipse-noellipse setjmp_test
 ...
 mainX$7:
	; parameter string_25i3A2025i203C25c3E0A#, offset 65
	mov qword [rbp + 65], string_25i3A2025i203C25c3E0A#

 mainX$8:
	; parameter index, offset 73
	mov eax, [rbp + 36]
	mov [rbp + 73], eax
 ...
 mainX$10:
	; parameter £temporary43, offset 77
	mov [rbp + 77], eax
 ...
 mainX$12:
	; parameter £temporary44, offset 81
	mov [rbp + 81], eax
 ...
 mainX$18:
	; parameter string_0Aargc3A2025i0A#, offset 64
	mov qword [rbp + 64], string_0Aargc3A2025i0A#

 mainX$19:
	; parameter argc, offset 72
	mov eax, [rbp + 24]
	mov [rbp + 72], eax
 ...
 mainX$28:
	; £temporary51 = £temporary50 * int8$8#
	xor rdx, rdx
	mul qword [int8$8#]

 mainX$29:
	; £temporary52 = argv + £temporary51
	mov rsi, [rbp + 28]
	add rsi, rax
 ...
 mainX$42:
	; £temporary57 = £temporary56 * int8$8#
	xor rdx, rdx
	mul qword [int8$8#]

 mainX$43:
	; £temporary58 = argv + £temporary57
	mov rsi, [rbp + 28]
	add rsi, rax
 ...
 mainX$50:
	; £temporary63 = £temporary62 * int8$8#
	xor rdx, rdx
	mul qword [int8$8#]

 mainX$51:
	; £temporary64 = argv + £temporary63
	mov rsi, [rbp + 28]
	add rsi, rax
 ...
 main3$2:
	; parameter string_3A20#, offset 56
 ...
 main3$6:
	; parameter string_25lf#, offset 56
 ...
 main3$8:
	; parameter £temporary101, offset 64
	mov [rbp + 64], rsi
 ...
 main3$12:
	; parameter string_3C25f3E#, offset 56
 ...
 mains2$1:
	; push float float8$3.14#
	fld qword [float8$3.14#]

 mains2$2:
	; parameter float8$3.14#, offset 48
	fstp qword [rbp + 48]
 ...
 mains2$6:
	; parameter string_2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D2D0A#, offset 48
 ...
 mains2$19:
	; push float float8$2.71#
	fld qword [float8$2.71#]

 mains2$20:
	; parameter float8$2.71#, offset 48
	fstp qword [rbp + 48]
 ...
 char_main$1:
	; parameter int1$97#, offset 48
	mov byte [rbp + 48], 97

 char_main$2:
	; call function noellipse-noellipse character_test
 ...
 assert_test$2:
	; parameter string_Please20write20a20number2028not20620or207293A20#, offset 52
 ...
 assert_test$8:
	; parameter £temporary125, offset 60
	mov [rbp + 60], rsi
 ...
 assert_test$15:
	; parameter string_n20213D206#, offset 68
	mov qword [rbp + 68], string_n20213D206#

 assert_test$16:
	; parameter string_C3A5CUsers5CStefan5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CMain2Ec#, offset 76
 ...
 assert_test$24:
	; parameter n, offset 52
	mov eax, [rbp + 24]
	mov [rbp + 52], eax

 assert_test$25:
	; call function noellipse-noellipse assert_test2
 ...
 assert_test2$4:
	; parameter string_n20213D207#, offset 68
