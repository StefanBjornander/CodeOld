...
section .text
 ...
 strcpy$2:
	; Add £temporary2768 source £temporary2767
	mov rsi, [rbp + 32]
	add rsi, rax

 strcpy$3:
	; Dereference £temporary2766 £temporary2768 0

 strcpy$4:
	; Equal 14 £temporary2766 SignedChar$0#
	cmp byte [rsi], 0
	je strcpy$14
 ...
 strcpy$6:
	; Add £temporary2773 target £temporary2772
	mov rsi, [rbp + 24]
	add rsi, rax

 strcpy$7:
	; Dereference £temporary2771 £temporary2773 0
 ...
 strcpy$9:
	; Add £temporary2776 source £temporary2775
	mov rdi, [rbp + 32]
	add rdi, rax

 strcpy$10:
	; Dereference £temporary2774 £temporary2776 0

 strcpy$11:
	; Assign £temporary2771 £temporary2774
	mov al, [rdi]
	mov [rsi], al
 ...
 strcpy$15:
	; Add £temporary2779 target £temporary2778
	mov rsi, [rbp + 24]
	add rsi, rax
 ...
 strcpy$17:
	; Assign £temporary2777 SignedChar$0#
	mov byte [rsi], 0
...
section .text
 ...
 strncpy$3:
	; Add £temporary2783 source £temporary2782
	mov rsi, [rbp + 32]
	add rsi, rax

 strncpy$4:
	; Dereference £temporary2781 £temporary2783 0

 strncpy$5:
	; Equal 15 £temporary2781 SignedChar$0#
	cmp byte [rsi], 0
	je strncpy$15
 ...
 strncpy$7:
	; Add £temporary2789 target £temporary2788
	mov rsi, [rbp + 24]
	add rsi, rax
 ...
 strncpy$11:
	; Dereference £temporary2790 £temporary2792 0

 strncpy$12:
	; Assign £temporary2787 £temporary2790
	mov al, [rdi]
	mov [rsi], al
 ...
 strncpy$19:
	; Assign £temporary2795 SignedChar$0#
	mov byte [rsi], 0
...
section .text
 ...
 strcat$8:
	; Add £temporary2801 source £temporary2800
	mov rsi, [rbp + 32]
	add rsi, rax

 strcat$9:
	; Dereference £temporary2799 £temporary2801 0

 strcat$10:
	; Equal 21 £temporary2799 SignedChar$0#
	cmp byte [rsi], 0
	je strcat$21

 strcat$11:
	; Add £temporary2804 targetLength index
	mov eax, [rbp + 44]
	add eax, [rbp + 40]
 ...
 strcat$13:
	; Add £temporary2807 target £temporary2806
	mov rsi, [rbp + 24]
	add rsi, rax
 ...
 strcat$16:
	; Add £temporary2810 source £temporary2809
	mov rdi, [rbp + 32]
	add rdi, rax
 ...
 strcat$18:
	; Assign £temporary2805 £temporary2808
	mov al, [rdi]
	mov [rsi], al
 ...
 strcat$21:
	; Add £temporary2811 targetLength index
	mov eax, [rbp + 44]
	add eax, [rbp + 40]
 ...
 strcat$23:
	; Add £temporary2814 target £temporary2813
	mov rsi, [rbp + 24]
	add rsi, rax

 strcat$24:
	; Dereference £temporary2812 £temporary2814 0

 strcat$25:
	; Assign £temporary2812 SignedChar$0#
	mov byte [rsi], 0
...
section .text
 ...
 strncat$7:
	; Subtract £temporary2816 size SignedInt$1#
	mov eax, [rbp + 40]
	dec eax
 ...
 strncat$10:
	; Add £temporary2820 source £temporary2819
	mov rsi, [rbp + 32]
	add rsi, rax

 strncat$11:
	; Dereference £temporary2818 £temporary2820 0

 strncat$12:
	; Equal 23 £temporary2818 SignedChar$0#
	cmp byte [rsi], 0
	je strncat$23

 strncat$13:
	; Add £temporary2824 targetLength index
	mov eax, [rbp + 48]
	add eax, [rbp + 44]
 ...
 strncat$16:
	; Dereference £temporary2825 £temporary2827 0
 ...
 strncat$19:
	; Dereference £temporary2828 £temporary2830 0

 strncat$20:
	; Assign £temporary2825 £temporary2828
	mov al, [rdi]
	mov [rsi], al
 ...
 strncat$23:
	; Add £temporary2831 targetLength size
	mov eax, [rbp + 48]
	add eax, [rbp + 40]

 strncat$24:
	; Subtract £temporary2832 £temporary2831 SignedInt$1#
	dec eax
 ...
 strncat$28:
	; Assign £temporary2833 SignedChar$0#
	mov byte [rsi], 0
...
section .text
 ...
 strcmp$2:
	; Add £temporary2839 left £temporary2838
	mov rsi, [rbp + 24]
	add rsi, rax

 strcmp$3:
	; Dereference £temporary2837 £temporary2839 0

 strcmp$4:
	; NotEqual 11 £temporary2837 SignedChar$0#
	cmp byte [rsi], 0
	jne strcmp$11
 ...
 strcmp$6:
	; Add £temporary2843 right £temporary2842
	mov rsi, [rbp + 32]
	add rsi, rax

 strcmp$7:
	; Dereference £temporary2841 £temporary2843 0

 strcmp$8:
	; NotEqual 11 £temporary2841 SignedChar$0#
	cmp byte [rsi], 0
	jne strcmp$11
 ...
 strcmp$12:
	; Add £temporary2848 left £temporary2847
	mov rsi, [rbp + 24]
	add rsi, rax
 ...
 strcmp$15:
	; Add £temporary2851 right £temporary2850
	mov rdi, [rbp + 32]
	add rdi, rax
 ...
 strcmp$17:
	; GreaterThanEqual 20 £temporary2846 £temporary2849
	mov al, [rdi]
	cmp [rsi], al
	jge strcmp$20
 ...
 strcmp$21:
	; Add £temporary2855 left £temporary2854
	mov rsi, [rbp + 24]
	add rsi, rax

 strcmp$22:
	; Dereference £temporary2853 £temporary2855 0
 ...
 strcmp$24:
	; Add £temporary2858 right £temporary2857
	mov rdi, [rbp + 32]
	add rdi, rax

 strcmp$25:
	; Dereference £temporary2856 £temporary2858 0

 strcmp$26:
	; LessThanEqual 29 £temporary2853 £temporary2856
	mov al, [rdi]
	cmp [rsi], al
	jle strcmp$29
...
section .text
 ...
 strncmp$3:
	; Add £temporary2865 left £temporary2864
	mov rsi, [rbp + 24]
	add rsi, rax

 strncmp$4:
	; Dereference £temporary2863 £temporary2865 0

 strncmp$5:
	; NotEqual 12 £temporary2863 SignedChar$0#
	cmp byte [rsi], 0
	jne strncmp$12
 ...
 strncmp$7:
	; Add £temporary2869 right £temporary2868
	mov rsi, [rbp + 32]
	add rsi, rax
 ...
 strncmp$9:
	; NotEqual 12 £temporary2867 SignedChar$0#
	cmp byte [rsi], 0
	jne strncmp$12
 ...
 strncmp$13:
	; Add £temporary2874 left £temporary2873
	mov rsi, [rbp + 24]
	add rsi, rax
 ...
 strncmp$16:
	; Add £temporary2877 right £temporary2876
	mov rdi, [rbp + 32]
	add rdi, rax

 strncmp$17:
	; Dereference £temporary2875 £temporary2877 0

 strncmp$18:
	; GreaterThanEqual 21 £temporary2872 £temporary2875
	mov al, [rdi]
	cmp [rsi], al
	jge strncmp$21
 ...
 strncmp$22:
	; Add £temporary2881 left £temporary2880
	mov rsi, [rbp + 24]
	add rsi, rax

 strncmp$23:
	; Dereference £temporary2879 £temporary2881 0
 ...
 strncmp$25:
	; Add £temporary2884 right £temporary2883
	mov rdi, [rbp + 32]
	add rdi, rax

 strncmp$26:
	; Dereference £temporary2882 £temporary2884 0

 strncmp$27:
	; LessThanEqual 30 £temporary2879 £temporary2882
	mov al, [rdi]
	cmp [rsi], al
	jle strncmp$30
...
section .text
 ...
 strchr$4:
	; Add £temporary2889 text £temporary2888
	mov rsi, [rbp + 24]
	add rsi, rax

 strchr$5:
	; Dereference £temporary2887 £temporary2889 0

 strchr$6:
	; Equal 19 £temporary2887 SignedChar$0#
	cmp byte [rsi], 0
	je strchr$19
 ...
 strchr$8:
	; Add £temporary2894 text £temporary2893
	mov rsi, [rbp + 24]
	add rsi, rax
 ...
 strchr$12:
	; Add £temporary2898 text £temporary2897
	mov rbx, [rbp + 24]
	add rbx, rax
 ...
 strchr$14:
	; Address £temporary2899 £temporary2896
...
section .text
 ...
 strrchr$5:
	; Add £temporary2903 text £temporary2902
	mov rsi, [rbp + 24]
	add rsi, rax

 strrchr$6:
	; Dereference £temporary2901 £temporary2903 0

 strrchr$7:
	; Equal 19 £temporary2901 SignedChar$0#
	cmp byte [rsi], 0
	je strrchr$19
 ...
 strrchr$9:
	; Add £temporary2908 text £temporary2907
	mov rsi, [rbp + 24]
	add rsi, rax
 ...
 strrchr$13:
	; Add £temporary2912 text £temporary2911
	mov rsi, [rbp + 24]
	add rsi, rax

 strrchr$14:
	; Dereference £temporary2910 £temporary2912 0

 strrchr$15:
	; Address £temporary2913 £temporary2910
...
section .text
 ...
 strspn$2:
	; Add £temporary2916 mainString £temporary2915
	mov rsi, [rbp + 24]
	add rsi, rax
 ...
 strspn$4:
	; Equal 20 £temporary2914 SignedChar$0#
	cmp byte [rsi], 0
	je strspn$20
 ...
 strspn$8:
	; Add £temporary2921 mainString £temporary2920
	mov rsi, [rbp + 24]
	add rsi, rax

 strspn$9:
	; Dereference £temporary2919 £temporary2921 0

 strspn$10:
	; IntegralToIntegral £temporary2922 £temporary2919
	mov al, [rsi]
	and eax, 255
	cmp al, 0
	jge strspn$11
 ...
 strspn$15:
	; NotEqual 18 £temporary2923 Pointer$0#
	cmp rbx, 0
	jne strspn$18
...
section .text
 ...
 strcspn$2:
	; Add £temporary2927 mainString £temporary2926
	mov rsi, [rbp + 24]
	add rsi, rax

 strcspn$3:
	; Dereference £temporary2925 £temporary2927 0

 strcspn$4:
	; Equal 20 £temporary2925 SignedChar$0#
	cmp byte [rsi], 0
	je strcspn$20
 ...
 strcspn$8:
	; Add £temporary2932 mainString £temporary2931
	mov rsi, [rbp + 24]
	add rsi, rax

 strcspn$9:
	; Dereference £temporary2930 £temporary2932 0

 strcspn$10:
	; IntegralToIntegral £temporary2933 £temporary2930
	mov al, [rsi]
	and eax, 255
	cmp al, 0
	jge strcspn$11
 ...
 strcspn$15:
	; Equal 18 £temporary2934 Pointer$0#
	cmp rbx, 0
	je strcspn$18
...
section .text
 ...
 strpbrk$2:
	; Add £temporary2938 mainString £temporary2937
	mov rsi, [rbp + 24]
	add rsi, rax

 strpbrk$3:
	; Dereference £temporary2936 £temporary2938 0

 strpbrk$4:
	; Equal 24 £temporary2936 SignedChar$0#
	cmp byte [rsi], 0
	je strpbrk$24
 ...
 strpbrk$8:
	; Add £temporary2943 mainString £temporary2942
	mov rsi, [rbp + 24]
	add rsi, rax

 strpbrk$9:
	; Dereference £temporary2941 £temporary2943 0

 strpbrk$10:
	; IntegralToIntegral £temporary2944 £temporary2941
	mov al, [rsi]
	and eax, 255
	cmp al, 0
	jge strpbrk$11
 ...
 strpbrk$15:
	; Equal 22 £temporary2945 Pointer$0#
	cmp rbx, 0
	je strpbrk$22
 ...
 strpbrk$17:
	; Add £temporary2949 mainString £temporary2948
	mov rbx, [rbp + 24]
	add rbx, rax

 strpbrk$18:
	; Dereference £temporary2947 £temporary2949 0

 strpbrk$19:
	; Address £temporary2950 £temporary2947
...
section .text
 ...
 strstr$9:
	; Dereference £temporary2952 £temporary2954 0

 strstr$10:
	; Equal 29 £temporary2952 SignedChar$0#
	cmp byte [rsi], 0
	je strstr$29
 ...
 strstr$13:
	; Add £temporary2958 mainString £temporary2957
	mov rbx, [rbp + 24]
	add rbx, rax
 ...
 strstr$20:
	; NotEqual 27 £temporary2959 SignedInt$0#
	cmp ebx, 0
	jne strstr$27
 ...
 strstr$23:
	; Dereference £temporary2961 £temporary2963 0

 strstr$24:
	; Address £temporary2964 £temporary2961
...
section .text
 ...
 strlen$2:
	; Add £temporary2967 string £temporary2966
	mov rsi, [rbp + 24]
	add rsi, rax

 strlen$3:
	; Dereference £temporary2965 £temporary2967 0

 strlen$4:
	; Equal 7 £temporary2965 SignedChar$0#
	cmp byte [rsi], 0
	je strlen$7
...
section .text
 ...
 strerror$5:
	; Equal 15 localeConvPtr Pointer$0#
	cmp qword [rbp + 28], 0
	je strerror$15

 strerror$6:
	; Dereference £temporary2972 localeConvPtr 0
	mov rsi, [rbp + 28]

 strerror$7:
	; Assign messageList £temporary2972
	mov rax, [rsi + 56]
	mov [rbp + 36], rax

 strerror$8:
	; Equal 15 messageList Pointer$0#
	cmp qword [rbp + 36], 0
	je strerror$15

 strerror$9:
	; Multiply £temporary2975 errno SignedInt$8#
	mov eax, [rbp + 24]
	xor edx, edx
	imul dword [@8593SignedInt$8#]
 ...
 strerror$11:
	; Add £temporary2977 messageList £temporary2976
	mov rsi, [rbp + 36]
	add rsi, rax

 strerror$12:
	; Dereference £temporary2974 £temporary2977 0
...
section .text
 ...
 strtok:
	; Equal 42 string Pointer$0#
	cmp qword [rbp + 24], 0
	je strtok$42

 strtok$1:
	; Dereference £temporary2979 string 0
	mov rsi, [rbp + 24]

 strtok$2:
	; NotEqual 5 £temporary2979 SignedChar$0#
	cmp byte [rsi], 0
	jne strtok$5
 ...
 strtok$7:
	; Add £temporary2983 string £temporary2982
	mov rsi, [rbp + 24]
	add rsi, rax

 strtok$8:
	; Dereference £temporary2981 £temporary2983 0

 strtok$9:
	; Equal 35 £temporary2981 SignedChar$0#
	cmp byte [rsi], 0
	je strtok$35
 ...
 strtok$15:
	; IntegralToIntegral £temporary2989 £temporary2986
	mov al, [rsi]
	and eax, 255
	cmp al, 0
	jge strtok$16
 ...
 strtok$20:
	; Equal 33 £temporary2990 Pointer$0#
	cmp rbx, 0
	je strtok$33
 ...
 strtok$22:
	; Add £temporary2994 string £temporary2993
	mov rsi, [rbp + 24]
	add rsi, rax

 strtok$23:
	; Dereference £temporary2992 £temporary2994 0

 strtok$24:
	; Assign £temporary2992 SignedChar$0#
	mov byte [rsi], 0

 strtok$25:
	; Add £temporary2995 index SignedInt$1#
	mov eax, [rbp + 40]
	inc eax
 ...
 strtok$27:
	; Add £temporary2998 string £temporary2997
	mov rsi, [rbp + 24]
	add rsi, rax

 strtok$28:
	; Dereference £temporary2996 £temporary2998 0

 strtok$29:
	; Address £temporary2999 £temporary2996
 ...
 strtok$36:
	; Add £temporary3002 string £temporary3001
	mov rsi, [rbp + 24]
	add rsi, rax
 ...
 strtok$45:
	; Dereference £temporary3005 token 0
	mov rsi, [@8600$token]

 strtok$46:
	; NotEqual 49 £temporary3005 SignedChar$0#
	cmp byte [rsi], 0
	jne strtok$49
 ...
 strtok$53:
	; Equal 80 £temporary3007 SignedChar$0#
	cmp byte [rsi], 0
	je strtok$80
 ...
 strtok$58:
	; Dereference £temporary3012 £temporary3014 0

 strtok$59:
	; IntegralToIntegral £temporary3015 £temporary3012
	mov al, [rsi]
	and eax, 255
	cmp al, 0
	jge strtok$60
 ...
 strtok$64:
	; Equal 78 £temporary3016 Pointer$0#
	cmp rbx, 0
	je strtok$78
 ...
 strtok$68:
	; Dereference £temporary3018 £temporary3020 0

 strtok$69:
	; Assign £temporary3018 SignedChar$0#
	mov byte [rsi], 0

 strtok$70:
	; Add £temporary3021 index SignedInt$1#
	mov eax, [rbp + 40]
	inc eax
 ...
 strtok$73:
	; Dereference £temporary3022 £temporary3024 0

 strtok$74:
	; Address £temporary3025 £temporary3022
 ...
 strtok$83:
	; Dereference £temporary3026 £temporary3028 0

 strtok$84:
	; Address £temporary3029 £temporary3026
...
section .text
 ...
 memcpy$7:
	; Add £temporary3036 charTarget £temporary3035
	mov rsi, [rbp + 44]
	add rsi, rax

 memcpy$8:
	; Dereference £temporary3034 £temporary3036 0
 ...
 memcpy$10:
	; Add £temporary3039 charSource £temporary3038
	mov rdi, [rbp + 52]
	add rdi, rax

 memcpy$11:
	; Dereference £temporary3037 £temporary3039 0

 memcpy$12:
	; Assign £temporary3034 £temporary3037
	mov al, [rdi]
	mov [rsi], al
...
section .text
 ...
 memmove$5:
	; Subtract index size SignedInt$1#
	mov eax, [rbp + 40]
	dec eax
	mov [rbp + 60], eax

 memmove$6:
	; LessThan 27 index SignedInt$0#
	cmp dword [rbp + 60], 0
	jl memmove$27
 ...
 memmove$8:
	; Add £temporary3049 charTarget £temporary3048
	mov rsi, [rbp + 44]
	add rsi, rax
 ...
 memmove$11:
	; Add £temporary3052 charSource £temporary3051
	mov rdi, [rbp + 52]
	add rdi, rax

 memmove$12:
	; Dereference £temporary3050 £temporary3052 0

 memmove$13:
	; Assign £temporary3047 £temporary3050
	mov al, [rdi]
	mov [rsi], al
...
section .text
 ...
 memcmp$7:
	; Add £temporary3068 charLeft £temporary3067
	mov rsi, [rbp + 44]
	add rsi, rax

 memcmp$8:
	; Dereference £temporary3066 £temporary3068 0
 ...
 memcmp$10:
	; Add £temporary3071 charRight £temporary3070
	mov rdi, [rbp + 52]
	add rdi, rax

 memcmp$11:
	; Dereference £temporary3069 £temporary3071 0

 memcmp$12:
	; GreaterThanEqual 15 £temporary3066 £temporary3069
	mov al, [rdi]
	cmp [rsi], al
	jge memcmp$15
 ...
 memcmp$16:
	; Add £temporary3075 charLeft £temporary3074
	mov rsi, [rbp + 44]
	add rsi, rax
 ...
 memcmp$19:
	; Add £temporary3078 charRight £temporary3077
	mov rdi, [rbp + 52]
	add rdi, rax
 ...
 memcmp$21:
	; LessThanEqual 24 £temporary3073 £temporary3076
	mov al, [rdi]
	cmp [rsi], al
	jle memcmp$24
...
section .text
 ...
 memchr$7:
	; Add £temporary3086 charBlock £temporary3085
	mov rsi, [rbp + 44]
	add rsi, rax

 memchr$8:
	; Dereference £temporary3084 £temporary3086 0

 memchr$9:
	; NotEqual 17 £temporary3084 c
	mov al, [rbp + 52]
	cmp [rsi], al
	jne memchr$17
 ...
 memchr$11:
	; Add £temporary3090 charBlock £temporary3089
	mov rbx, [rbp + 44]
	add rbx, rax

 memchr$12:
	; Dereference £temporary3088 £temporary3090 0

 memchr$13:
	; Address £temporary3091 £temporary3088
...
section .text
 ...
 memset$7:
	; Add £temporary3099 charBlock £temporary3098
	mov rsi, [rbp + 40]
	add rsi, rax
