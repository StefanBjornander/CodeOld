...
section .text
 ...
 assert_testX$8:
	; parameter £temporary3077, offset 60
	mov [rbp + 60], rsi
 ...
 assert_testX$16:
	; parameter string_C3A5CUsers5CStefan5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CAssertTest2Ec#, offset 76
	mov qword [rbp + 76], string_C3A5CUsers5CStefan5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CAssertTest2Ec#

 assert_testX$17:
	; parameter int4$10#, offset 84
	mov dword [rbp + 84], 10
