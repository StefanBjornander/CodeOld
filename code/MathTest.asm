...
@10601$float8$minus6.28#:
	; Initializer Double -6.28
	dq -6.28

section .data

@10604$float8$minus3.14#:
	; Initializer Double -3.14
	dq -3.14

section .data

@10609$float8$minus1.57#:
...
section .text
 ...
 math_test_1x$1:
	; PushFloat -6.28
	fld qword [@10601$float8$minus6.28#]
 ...
 math_test_1x$6:
	; PushFloat -3.14
	fld qword [@10604$float8$minus3.14#]
 ...
 math_test_1x$11:
	; PushFloat -1.57
	fld qword [@10609$float8$minus1.57#]
...
@10627$string_2020acos2825f29203D2025f2C20errno203D2025i0A#:
...
section .text
 ...
 acos_test$1:
	...
	mov qword [rbp + 56], @10627$string_2020acos2825f29203D2025f2C20errno203D2025i0A#
...
@10633$string_2020atan2825f29203D2025f2C20errno203D2025i0A#:
...
section .text
 ...
 atan_test$1:
	...
	mov qword [rbp + 56], @10633$string_2020atan2825f29203D2025f2C20errno203D2025i0A#
...
@10644$float8$1.000010#:
	; Initializer Double 1.000010
	dq 1.000010

section .data

@10648$float8$0.999999#:
	; Initializer Double 0.999999
	dq 0.999999

section .data

@10650$float8$0.000010#:
	; Initializer Double 0.000010
	dq 0.000010

section .data

@10654$float8$minus0.000010#:
	; Initializer Double -0.000010
	dq -0.000010

section .data

@10656$float8$minus0.999999#:
	; Initializer Double -0.999999
	dq -0.999999

section .data

@10658$float8$minus1.0#:
	; Initializer Double -1.0
	dq -1.0

section .data

@10660$float8$minus1.000010#:
	; Initializer Double -1.000010
	dq -1.000010
...
@10675$float8$minus1.57#:
	; Initializer Double -1.57
	dq -1.57

section .data

@10678$float8$minus3.14#:
	; Initializer Double -3.14
	dq -3.14

section .data

@10682$float8$minus6.28#:
	; Initializer Double -6.28
	dq -6.28
...
@10720$float8$minus1.0#:
	; Initializer Double -1.0
	dq -1.0

section .data

@10722$float8$minus1.0#:
	; Initializer Double -1.0
	dq -1.0

section .data

@10724$float8$minus2.0#:
	; Initializer Double -2.0
	dq -2.0

section .data

@10726$float8$minus4.0#:
	; Initializer Double -4.0
	dq -4.0
...
section .text
 ...
 math_test$1:
	...
	fld qword [@10640$float8$0.333333333#]
 ...
 math_test$11:
	; PushFloat 1.000010
	fld qword [@10644$float8$1.000010#]
 ...
 math_test$21:
	; PushFloat 0.999999
	fld qword [@10648$float8$0.999999#]
 ...
 math_test$26:
	; PushFloat 0.000010
	fld qword [@10650$float8$0.000010#]
 ...
 math_test$36:
	; PushFloat -0.000010
	fld qword [@10654$float8$minus0.000010#]
 ...
 math_test$41:
	; PushFloat -0.999999
	fld qword [@10656$float8$minus0.999999#]
 ...
 math_test$46:
	; PushFloat -1.0
	fld qword [@10658$float8$minus1.0#]
 ...
 math_test$51:
	; PushFloat -1.000010
	fld qword [@10660$float8$minus1.000010#]
 ...
 math_test$71:
	; PushFloat -1.57
	fld qword [@10675$float8$minus1.57#]
 ...
 math_test$76:
	; PushFloat -3.14
	fld qword [@10678$float8$minus3.14#]
 ...
 math_test$81:
	; PushFloat -6.28
	fld qword [@10682$float8$minus6.28#]
 ...
 math_test$109:
	; PushFloat -2.0
	fld qword [@10698$float8$minus2.0#]
 ...
 math_test$123:
	; PushFloat -2.0
	fld qword [@10706$float8$minus2.0#]
 ...
 math_test$149:
	; PushFloat -1.0
	fld qword [@10720$float8$minus1.0#]
 ...
 math_test$151:
	; PushFloat -1.0
	fld qword [@10722$float8$minus1.0#]
 ...
 math_test$156:
	; PushFloat -2.0
	fld qword [@10724$float8$minus2.0#]
 ...
 math_test$158:
	; PushFloat -4.0
	fld qword [@10726$float8$minus4.0#]
...
@10728$string_3C25f3E0A#:
	; Initializer String <%f>\n
	db "<%f>", 10, 0

section .data

@10729$string_2020sin2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   sin(%f) = %f, errno = %i\n
	db "  sin(%f) = %f, errno = %i", 10, 0

section .data

@10732$string_2020cos2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   cos(%f) = %f, errno = %i\n
	db "  cos(%f) = %f, errno = %i", 10, 0

section .data

@10735$string_2020tan2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   tan(%f) = %f, errno = %i\n
	db "  tan(%f) = %f, errno = %i", 10, 0

section .data

@10738$string_2020asin2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   asin(%f) = %f, errno = %i\n
	db "  asin(%f) = %f, errno = %i", 10, 0

section .data

@10741$string_2020acos2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   acos(%f) = %f, errno = %i\n
	db "  acos(%f) = %f, errno = %i", 10, 0

section .data

@10744$string_2020atan2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   atan(%f) = %f, errno = %i\n
	db "  atan(%f) = %f, errno = %i", 10, 0

section .data

@10747$string_2020exp2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   exp(%f) = %f, errno = %i\n
	db "  exp(%f) = %f, errno = %i", 10, 0

section .data

@10750$string_2020log2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   log(%f) = %f, errno = %i\n
	db "  log(%f) = %f, errno = %i", 10, 0

section .data

@10753$string_2020log102825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   log10(%f) = %f, errno = %i\n
	db "  log10(%f) = %f, errno = %i", 10, 0

section .data

@10756$string_2020sinh2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   sinh(%f) = %f, errno = %i\n
	db "  sinh(%f) = %f, errno = %i", 10, 0

section .data

@10759$string_2020cosh2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   cosh(%f) = %f, errno = %i\n
	db "  cosh(%f) = %f, errno = %i", 10, 0

section .data

@10762$string_2020tanh2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   tanh(%f) = %f, errno = %i\n
	db "  tanh(%f) = %f, errno = %i", 10, 0

section .data

@10765$string_2020sqrt2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   sqrt(%f) = %f, errno = %i\n
	db "  sqrt(%f) = %f, errno = %i", 10, 0

section .data

@10768$string_2020floor2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   floor(%f) = %f, errno = %i\n
	db "  floor(%f) = %f, errno = %i", 10, 0

section .data

@10771$string_2020ceil2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   ceil(%f) = %f, errno = %i\n
	db "  ceil(%f) = %f, errno = %i", 10, 0

section .data

@10774$string_2020fabs2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   fabs(%f) = %f, errno = %i\n
	db "  fabs(%f) = %f, errno = %i", 10, 0

section .data

@10781$string_frexp202825f2C20p29203D202825f2C2025i292C20errno203D2025i0A#:
	; Initializer String frexp (%f, p) = (%f, %i), errno = %i\n
	db "frexp (%f, p) = (%f, %i), errno = %i", 10, 0

section .data

@10784$string_Error20message3A#:
	; Initializer String Error message:
	db "Error message:", 0

section .data

@10791$string_modf202825f2C20p29203D202825f2C2025f292C20errno203D2025i0A#:
	; Initializer String modf (%f, p) = (%f, %f), errno = %i\n
	db "modf (%f, p) = (%f, %f), errno = %i", 10, 0

section .data

@10794$string_Error20message3A#:
	; Initializer String Error message:
	db "Error message:", 0
...
section .text
 ...
 math_test_1$1:
	...
	mov qword [rbp + 56], @10728$string_3C25f3E0A#
 ...
 math_test_1$7:
	...
	mov qword [rbp + 56], @10729$string_2020sin2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$22:
	...
	mov qword [rbp + 56], @10732$string_2020cos2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$37:
	...
	mov qword [rbp + 56], @10735$string_2020tan2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$52:
	...
	mov qword [rbp + 56], @10738$string_2020asin2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$67:
	; Parameter 56 pointer "  acos(%f) = %f, errno = %i\n"
	mov qword [rbp + 56], @10741$string_2020acos2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$82:
	; Parameter 56 pointer "  atan(%f) = %f, errno = %i\n"
	mov qword [rbp + 56], @10744$string_2020atan2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$97:
	...
	mov qword [rbp + 56], @10747$string_2020exp2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$112:
	...
	mov qword [rbp + 56], @10750$string_2020log2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$127:
	...
	mov qword [rbp + 56], @10753$string_2020log102825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$142:
	...
	mov qword [rbp + 56], @10756$string_2020sinh2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$157:
	...
	mov qword [rbp + 56], @10759$string_2020cosh2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$172:
	...
	mov qword [rbp + 56], @10762$string_2020tanh2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$187:
	...
	mov qword [rbp + 56], @10765$string_2020sqrt2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$202:
	...
	mov qword [rbp + 56], @10768$string_2020floor2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$217:
	...
	mov qword [rbp + 56], @10771$string_2020ceil2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$232:
	...
	mov qword [rbp + 56], @10774$string_2020fabs2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$257:
	...
	mov qword [rbp + 68], @10781$string_frexp202825f2C20p29203D202825f2C2025i292C20errno203D2025i0A#
 ...
 math_test_1$268:
	...
	mov qword [rbp + 68], @10784$string_Error20message3A#
 ...
 math_test_1$284:
	...
	mov qword [rbp + 72], @10791$string_modf202825f2C20p29203D202825f2C2025f292C20errno203D2025i0A#
 ...
 math_test_1$296:
	...
	mov qword [rbp + 72], @10794$string_Error20message3A#
 ...
 math_test_1$301:
	...
	mov qword [rbp + 56], @10797$string_0A#
...
@10843$string_fmod2825f2C2025f29203D2025f2C20errno203D2025i0A#:
	; Initializer String fmod(%f, %f) = %f, errno = %i\n
	db "fmod(%f, %f) = %f, errno = %i", 10, 0

section .data

@10846$string_atan22825f2C2025f29203D2025f2C20errno203D2025i0A#:
	; Initializer String atan2(%f, %f) = %f, errno = %i\n
	db "atan2(%f, %f) = %f, errno = %i", 10, 0

section .data

@10849$string_pow2825f2C2025f29203D2025f2C20errno203D2025i0A#:
...
@10853$string_ldexp2825f2C2025i29203D2025f0A0A#:
...
section .text
 ...
 math_test_2$1:
	...
	mov qword [rbp + 64], @10843$string_fmod2825f2C2025f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_2$20:
	...
	mov qword [rbp + 64], @10846$string_atan22825f2C2025f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_2$39:
	...
	mov qword [rbp + 64], @10849$string_pow2825f2C2025f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_2$58:
	...
	mov qword [rbp + 64], @10852$string_0A#
 ...
 math_test_2$62:
	...
	mov qword [rbp + 64], @10853$string_ldexp2825f2C2025i29203D2025f0A0A#
