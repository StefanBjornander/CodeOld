...
@10999$float8$minus6.28#:
	; Initializer Double -6.28
	dq -6.28

section .data

@11002$float8$minus3.14#:
	; Initializer Double -3.14
	dq -3.14

section .data

@11007$float8$minus1.57#:
...
section .text
 ...
 math_test_1x$1:
	; PushFloat -6.28
	fld qword [@10999$float8$minus6.28#]
 ...
 math_test_1x$6:
	; PushFloat -3.14
	fld qword [@11002$float8$minus3.14#]
 ...
 math_test_1x$11:
	; PushFloat -1.57
	fld qword [@11007$float8$minus1.57#]
...
@11025$string_2020acos2825f29203D2025f2C20errno203D2025i0A#:
...
section .text
 ...
 acos_test$1:
	...
	mov qword [rbp + 56], @11025$string_2020acos2825f29203D2025f2C20errno203D2025i0A#
 ...
 acos_test$10:
	; Parameter 72 double £temporary3668
	fstp qword [rbp + 72]
...
@11032$string_2020atan2825f29203D2025f2C20errno203D2025i0A#:
...
section .text
 ...
 atan_test$1:
	...
	mov qword [rbp + 56], @11032$string_2020atan2825f29203D2025f2C20errno203D2025i0A#
 ...
 atan_test$10:
	; Parameter 72 double £temporary3673
	fstp qword [rbp + 72]
...
@11044$float8$1.000010#:
	; Initializer Double 1.000010
	dq 1.000010

section .data

@11048$float8$0.999999#:
	; Initializer Double 0.999999
	dq 0.999999

section .data

@11050$float8$0.000010#:
	; Initializer Double 0.000010
	dq 0.000010

section .data

@11054$float8$minus0.000010#:
	; Initializer Double -0.000010
	dq -0.000010

section .data

@11056$float8$minus0.999999#:
	; Initializer Double -0.999999
	dq -0.999999

section .data

@11058$float8$minus1.0#:
	; Initializer Double -1.0
	dq -1.0

section .data

@11060$float8$minus1.000010#:
	; Initializer Double -1.000010
	dq -1.000010
...
@11075$float8$minus1.57#:
	; Initializer Double -1.57
	dq -1.57

section .data

@11078$float8$minus3.14#:
	; Initializer Double -3.14
	dq -3.14

section .data

@11082$float8$minus6.28#:
	; Initializer Double -6.28
	dq -6.28
...
@11120$float8$minus1.0#:
	; Initializer Double -1.0
	dq -1.0

section .data

@11122$float8$minus1.0#:
	; Initializer Double -1.0
	dq -1.0

section .data

@11124$float8$minus2.0#:
	; Initializer Double -2.0
	dq -2.0

section .data

@11126$float8$minus4.0#:
	; Initializer Double -4.0
	dq -4.0
...
section .text
 ...
 math_test$1:
	...
	fld qword [@11040$float8$0.333333333#]
 ...
 math_test$11:
	; PushFloat 1.000010
	fld qword [@11044$float8$1.000010#]
 ...
 math_test$21:
	; PushFloat 0.999999
	fld qword [@11048$float8$0.999999#]
 ...
 math_test$26:
	; PushFloat 0.000010
	fld qword [@11050$float8$0.000010#]
 ...
 math_test$36:
	; PushFloat -0.000010
	fld qword [@11054$float8$minus0.000010#]
 ...
 math_test$41:
	; PushFloat -0.999999
	fld qword [@11056$float8$minus0.999999#]
 ...
 math_test$46:
	; PushFloat -1.0
	fld qword [@11058$float8$minus1.0#]
 ...
 math_test$51:
	; PushFloat -1.000010
	fld qword [@11060$float8$minus1.000010#]
 ...
 math_test$71:
	; PushFloat -1.57
	fld qword [@11075$float8$minus1.57#]
 ...
 math_test$76:
	; PushFloat -3.14
	fld qword [@11078$float8$minus3.14#]
 ...
 math_test$81:
	; PushFloat -6.28
	fld qword [@11082$float8$minus6.28#]
 ...
 math_test$109:
	; PushFloat -2.0
	fld qword [@11098$float8$minus2.0#]
 ...
 math_test$149:
	; PushFloat -1.0
	fld qword [@11120$float8$minus1.0#]
 ...
 math_test$151:
	; PushFloat -1.0
	fld qword [@11122$float8$minus1.0#]
 ...
 math_test$156:
	; PushFloat -2.0
	fld qword [@11124$float8$minus2.0#]
 ...
 math_test$158:
	; PushFloat -4.0
	fld qword [@11126$float8$minus4.0#]
...
@11128$string_3C25f3E0A#:
	; Initializer String <%f>\n
	db "<%f>", 10, 0

section .data

@11129$string_2020sin2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   sin(%f) = %f, errno = %i\n
	db "  sin(%f) = %f, errno = %i", 10, 0

section .data

@11133$string_2020cos2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   cos(%f) = %f, errno = %i\n
	db "  cos(%f) = %f, errno = %i", 10, 0

section .data

@11137$string_2020tan2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   tan(%f) = %f, errno = %i\n
	db "  tan(%f) = %f, errno = %i", 10, 0

section .data

@11141$string_2020asin2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   asin(%f) = %f, errno = %i\n
	db "  asin(%f) = %f, errno = %i", 10, 0

section .data

@11145$string_2020acos2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   acos(%f) = %f, errno = %i\n
	db "  acos(%f) = %f, errno = %i", 10, 0

section .data

@11149$string_2020atan2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   atan(%f) = %f, errno = %i\n
	db "  atan(%f) = %f, errno = %i", 10, 0

section .data

@11153$string_2020exp2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   exp(%f) = %f, errno = %i\n
	db "  exp(%f) = %f, errno = %i", 10, 0

section .data

@11157$string_2020log2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   log(%f) = %f, errno = %i\n
	db "  log(%f) = %f, errno = %i", 10, 0

section .data

@11161$string_2020log102825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   log10(%f) = %f, errno = %i\n
	db "  log10(%f) = %f, errno = %i", 10, 0

section .data

@11165$string_2020sinh2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   sinh(%f) = %f, errno = %i\n
	db "  sinh(%f) = %f, errno = %i", 10, 0

section .data

@11169$string_2020cosh2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   cosh(%f) = %f, errno = %i\n
	db "  cosh(%f) = %f, errno = %i", 10, 0

section .data

@11173$string_2020tanh2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   tanh(%f) = %f, errno = %i\n
	db "  tanh(%f) = %f, errno = %i", 10, 0

section .data

@11177$string_2020sqrt2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   sqrt(%f) = %f, errno = %i\n
	db "  sqrt(%f) = %f, errno = %i", 10, 0

section .data

@11181$string_2020floor2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   floor(%f) = %f, errno = %i\n
	db "  floor(%f) = %f, errno = %i", 10, 0

section .data

@11185$string_2020ceil2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   ceil(%f) = %f, errno = %i\n
	db "  ceil(%f) = %f, errno = %i", 10, 0

section .data

@11189$string_2020fabs2825f29203D2025f2C20errno203D2025i0A#:
	; Initializer String   fabs(%f) = %f, errno = %i\n
	db "  fabs(%f) = %f, errno = %i", 10, 0

section .data

@11197$string_frexp202825f2C20p29203D202825f2C2025i292C20errno203D2025i0A#:
	; Initializer String frexp (%f, p) = (%f, %i), errno = %i\n
	db "frexp (%f, p) = (%f, %i), errno = %i", 10, 0

section .data

@11200$string_Error20message3A#:
	; Initializer String Error message:
	db "Error message:", 0

section .data

@11208$string_modf202825f2C20p29203D202825f2C2025f292C20errno203D2025i0A#:
	; Initializer String modf (%f, p) = (%f, %f), errno = %i\n
	db "modf (%f, p) = (%f, %f), errno = %i", 10, 0

section .data

@11211$string_Error20message3A#:
	; Initializer String Error message:
	db "Error message:", 0
...
section .text
 ...
 math_test_1$1:
	...
	mov qword [rbp + 56], @11128$string_3C25f3E0A#
 ...
 math_test_1$7:
	...
	mov qword [rbp + 56], @11129$string_2020sin2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$22:
	...
	mov qword [rbp + 56], @11133$string_2020cos2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$37:
	...
	mov qword [rbp + 56], @11137$string_2020tan2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$52:
	...
	mov qword [rbp + 56], @11141$string_2020asin2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$61:
	; Parameter 72 double £temporary3752
	fstp qword [rbp + 72]
 ...
 math_test_1$67:
	; Parameter 56 pointer "  acos(%f) = %f, errno = %i\n"
	mov qword [rbp + 56], @11145$string_2020acos2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$82:
	; Parameter 56 pointer "  atan(%f) = %f, errno = %i\n"
	mov qword [rbp + 56], @11149$string_2020atan2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$91:
	; Parameter 72 double £temporary3756
	fstp qword [rbp + 72]
 ...
 math_test_1$97:
	...
	mov qword [rbp + 56], @11153$string_2020exp2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$112:
	...
	mov qword [rbp + 56], @11157$string_2020log2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$121:
	; Parameter 72 double £temporary3760
	fstp qword [rbp + 72]
 ...
 math_test_1$127:
	...
	mov qword [rbp + 56], @11161$string_2020log102825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$136:
	; Parameter 72 double £temporary3762
	fstp qword [rbp + 72]
 ...
 math_test_1$142:
	...
	mov qword [rbp + 56], @11165$string_2020sinh2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$157:
	...
	mov qword [rbp + 56], @11169$string_2020cosh2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$172:
	...
	mov qword [rbp + 56], @11173$string_2020tanh2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$187:
	...
	mov qword [rbp + 56], @11177$string_2020sqrt2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$202:
	...
	mov qword [rbp + 56], @11181$string_2020floor2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$217:
	...
	mov qword [rbp + 56], @11185$string_2020ceil2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$232:
	...
	mov qword [rbp + 56], @11189$string_2020fabs2825f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_1$250:
	; Address £temporary3778 j
	mov rsi, rbp
	add rsi, 32

 math_test_1$251:
	; Parameter 68 pointer £temporary3778
	mov [rbp + 68], rsi
 ...
 math_test_1$257:
	...
	mov qword [rbp + 68], @11197$string_frexp202825f2C20p29203D202825f2C2025i292C20errno203D2025i0A#
 ...
 math_test_1$268:
	...
	mov qword [rbp + 68], @11200$string_Error20message3A#
 ...
 math_test_1$277:
	; Address £temporary3783 w
	mov rsi, rbp
	add rsi, 32

 math_test_1$278:
	; Parameter 72 pointer £temporary3783
	mov [rbp + 72], rsi
 ...
 math_test_1$284:
	...
	mov qword [rbp + 72], @11208$string_modf202825f2C20p29203D202825f2C2025f292C20errno203D2025i0A#
 ...
 math_test_1$296:
	...
	mov qword [rbp + 72], @11211$string_Error20message3A#
 ...
 math_test_1$301:
	...
	mov qword [rbp + 56], @11215$string_0A#
...
@11261$string_fmod2825f2C2025f29203D2025f2C20errno203D2025i0A#:
	; Initializer String fmod(%f, %f) = %f, errno = %i\n
	db "fmod(%f, %f) = %f, errno = %i", 10, 0

section .data

@11265$string_atan22825f2C2025f29203D2025f2C20errno203D2025i0A#:
	; Initializer String atan2(%f, %f) = %f, errno = %i\n
	db "atan2(%f, %f) = %f, errno = %i", 10, 0

section .data

@11269$string_pow2825f2C2025f29203D2025f2C20errno203D2025i0A#:
...
@11274$string_ldexp2825f2C2025i29203D2025f0A0A#:
...
section .text
 ...
 math_test_2$1:
	...
	mov qword [rbp + 64], @11261$string_fmod2825f2C2025f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_2$14:
	; Parameter 88 double £temporary3847
	fstp qword [rbp + 88]
 ...
 math_test_2$20:
	...
	mov qword [rbp + 64], @11265$string_atan22825f2C2025f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_2$33:
	; Parameter 88 double £temporary3849
	fstp qword [rbp + 88]
 ...
 math_test_2$39:
	...
	mov qword [rbp + 64], @11269$string_pow2825f2C2025f29203D2025f2C20errno203D2025i0A#
 ...
 math_test_2$52:
	; Parameter 88 double £temporary3851
	fstp qword [rbp + 88]
 ...
 math_test_2$58:
	...
	mov qword [rbp + 64], @11273$string_0A#
 ...
 math_test_2$62:
	...
	mov qword [rbp + 64], @11274$string_ldexp2825f2C2025i29203D2025f0A0A#
 ...
 math_test_2$66:
	; FloatingToIntegral £temporary3854 y
	fistp dword [container4bytes#]
	mov eax, [container4bytes#]

 math_test_2$67:
	; Parameter 80 signedint £temporary3854
	mov [rbp + 80], eax
 ...
 math_test_2$72:
	; FloatingToIntegral £temporary3855 y
	fistp dword [container4bytes#]
	mov eax, [container4bytes#]

 math_test_2$73:
	; Parameter 116 signedint £temporary3855
	mov [rbp + 116], eax
 ...
 math_test_2$77:
	; Parameter 84 double £temporary3856
	fstp qword [rbp + 84]
