...
section .text
 ...
 character_test$2:
	; IntegralToIntegral £temporary3023 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$3:
	; Parameter signedint £temporary3023 57
	mov [rbp + 57], eax
 ...
 character_test$8:
	; IntegralToIntegral £temporary3025 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$9:
	; Parameter signedint £temporary3025 57
	mov [rbp + 57], eax
 ...
 character_test$11:
	; IntegralToIntegral £temporary3026 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$12:
	; Parameter signedint £temporary3026 85
	mov [rbp + 85], eax
 ...
 character_test$15:
	; GetReturnValue £temporary3027

 character_test$16:
	; Equal 19 £temporary3027 0
	cmp ebx, 0
	je character_test$19

 character_test$17:
	; Assign £temporary3029 "Yes"
	mov rax, string_Yes#
 ...
 character_test$19:
	; Assign £temporary3029 "No"
	mov rax, string_No#

 character_test$20:
	; Parameter pointer £temporary3029 61
	mov [rbp + 61], rax
 ...
 character_test$25:
	; IntegralToIntegral £temporary3031 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$26:
	; Parameter signedint £temporary3031 57
	mov [rbp + 57], eax
 ...
 character_test$28:
	; IntegralToIntegral £temporary3032 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$29:
	; Parameter signedint £temporary3032 85
	mov [rbp + 85], eax
 ...
 character_test$33:
	; Equal 36 £temporary3033 0
	cmp ebx, 0
	je character_test$36

 character_test$34:
	; Assign £temporary3035 "Yes"
	mov rax, string_Yes#
 ...
 character_test$36:
	; Assign £temporary3035 "No"
	mov rax, string_No#

 character_test$37:
	; Parameter pointer £temporary3035 61
	mov [rbp + 61], rax
 ...
 character_test$42:
	; IntegralToIntegral £temporary3037 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$43:
	; Parameter signedint £temporary3037 57
	mov [rbp + 57], eax
 ...
 character_test$45:
	; IntegralToIntegral £temporary3038 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$46:
	; Parameter signedint £temporary3038 85
	mov [rbp + 85], eax
 ...
 character_test$50:
	; Equal 53 £temporary3039 0
	cmp ebx, 0
	je character_test$53

 character_test$51:
	; Assign £temporary3041 "Yes"
	mov rax, string_Yes#
 ...
 character_test$53:
	; Assign £temporary3041 "No"
	mov rax, string_No#

 character_test$54:
	; Parameter pointer £temporary3041 61
	mov [rbp + 61], rax
 ...
 character_test$59:
	; IntegralToIntegral £temporary3043 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$60:
	; Parameter signedint £temporary3043 57
	mov [rbp + 57], eax
 ...
 character_test$62:
	; IntegralToIntegral £temporary3044 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$63:
	; Parameter signedint £temporary3044 85
	mov [rbp + 85], eax
 ...
 character_test$67:
	; Equal 70 £temporary3045 0
	cmp ebx, 0
	je character_test$70

 character_test$68:
	; Assign £temporary3047 "Yes"
	mov rax, string_Yes#
 ...
 character_test$70:
	; Assign £temporary3047 "No"
	mov rax, string_No#

 character_test$71:
	; Parameter pointer £temporary3047 61
	mov [rbp + 61], rax
 ...
 character_test$76:
	; IntegralToIntegral £temporary3049 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$77:
	; Parameter signedint £temporary3049 57
	mov [rbp + 57], eax
 ...
 character_test$79:
	; IntegralToIntegral £temporary3050 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$80:
	; Parameter signedint £temporary3050 85
	mov [rbp + 85], eax
 ...
 character_test$84:
	; Equal 87 £temporary3051 0
	cmp ebx, 0
	je character_test$87

 character_test$85:
	; Assign £temporary3053 "Yes"
	mov rax, string_Yes#
 ...
 character_test$87:
	; Assign £temporary3053 "No"
	mov rax, string_No#

 character_test$88:
	; Parameter pointer £temporary3053 61
	mov [rbp + 61], rax
 ...
 character_test$93:
	; IntegralToIntegral £temporary3055 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$94:
	; Parameter signedint £temporary3055 57
	mov [rbp + 57], eax
 ...
 character_test$96:
	; IntegralToIntegral £temporary3056 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$97:
	; Parameter signedint £temporary3056 85
	mov [rbp + 85], eax
 ...
 character_test$101:
	; Equal 104 £temporary3057 0
	cmp ebx, 0
	je character_test$104

 character_test$102:
	; Assign £temporary3059 "Yes"
	mov rax, string_Yes#
 ...
 character_test$104:
	; Assign £temporary3059 "No"
	mov rax, string_No#

 character_test$105:
	; Parameter pointer £temporary3059 61
	mov [rbp + 61], rax
 ...
 character_test$110:
	; IntegralToIntegral £temporary3061 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$111:
	; Parameter signedint £temporary3061 57
	mov [rbp + 57], eax
 ...
 character_test$113:
	; IntegralToIntegral £temporary3062 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$114:
	; Parameter signedint £temporary3062 85
	mov [rbp + 85], eax
 ...
 character_test$118:
	; Equal 121 £temporary3063 0
	cmp ebx, 0
	je character_test$121

 character_test$119:
	; Assign £temporary3065 "Yes"
	mov rax, string_Yes#
 ...
 character_test$121:
	; Assign £temporary3065 "No"
	mov rax, string_No#

 character_test$122:
	; Parameter pointer £temporary3065 61
	mov [rbp + 61], rax
 ...
 character_test$127:
	; IntegralToIntegral £temporary3067 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$128:
	; Parameter signedint £temporary3067 57
	mov [rbp + 57], eax
 ...
 character_test$130:
	; IntegralToIntegral £temporary3068 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$131:
	; Parameter signedint £temporary3068 85
	mov [rbp + 85], eax
 ...
 character_test$135:
	; Equal 138 £temporary3069 0
	cmp ebx, 0
	je character_test$138

 character_test$136:
	; Assign £temporary3071 "Yes"
	mov rax, string_Yes#
 ...
 character_test$138:
	; Assign £temporary3071 "No"
	mov rax, string_No#

 character_test$139:
	; Parameter pointer £temporary3071 61
	mov [rbp + 61], rax
 ...
 character_test$144:
	; IntegralToIntegral £temporary3073 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$145:
	; Parameter signedint £temporary3073 57
	mov [rbp + 57], eax
 ...
 character_test$148:
	; Parameter signedint £temporary3074 85
	mov [rbp + 85], eax
 ...
 character_test$152:
	; Equal 155 £temporary3075 0
	cmp ebx, 0
	je character_test$155

 character_test$153:
	; Assign £temporary3077 "Yes"
	mov rax, string_Yes#
 ...
 character_test$155:
	; Assign £temporary3077 "No"
	mov rax, string_No#

 character_test$156:
	; Parameter pointer £temporary3077 61
	mov [rbp + 61], rax
 ...
 character_test$161:
	; IntegralToIntegral £temporary3079 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$162:
	; Parameter signedint £temporary3079 57
	mov [rbp + 57], eax
 ...
 character_test$165:
	; Parameter signedint £temporary3080 85
	mov [rbp + 85], eax
 ...
 character_test$169:
	; Equal 172 £temporary3081 0
	cmp ebx, 0
	je character_test$172

 character_test$170:
	; Assign £temporary3083 "Yes"
	mov rax, string_Yes#
 ...
 character_test$172:
	; Assign £temporary3083 "No"
	mov rax, string_No#

 character_test$173:
	; Parameter pointer £temporary3083 61
	mov [rbp + 61], rax
 ...
 character_test$178:
	; IntegralToIntegral £temporary3085 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$179:
	; Parameter signedint £temporary3085 57
	mov [rbp + 57], eax
 ...
 character_test$182:
	; Parameter signedint £temporary3086 85
	mov [rbp + 85], eax
 ...
 character_test$185:
	; GetReturnValue £temporary3087

 character_test$186:
	; Equal 189 £temporary3087 0
	cmp ebx, 0
	je character_test$189

 character_test$187:
	; Assign £temporary3089 "Yes"
	mov rax, string_Yes#
 ...
 character_test$189:
	; Assign £temporary3089 "No"
	mov rax, string_No#

 character_test$190:
	; Parameter pointer £temporary3089 61
	mov [rbp + 61], rax
 ...
 character_test$195:
	; IntegralToIntegral £temporary3091 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$196:
	; Parameter signedint £temporary3091 57
	mov [rbp + 57], eax
 ...
 character_test$199:
	; Parameter signedint £temporary3092 85
	mov [rbp + 85], eax
 ...
 character_test$204:
	; IntegralToIntegral £temporary3095 £temporary3094
	and ebx, 255
	cmp bl, 0
 ...
 character_test$205:
	; Parameter signedint £temporary3095 61
	mov [rbp + 61], ebx
 ...
 character_test$210:
	; IntegralToIntegral £temporary3097 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$211:
	; Parameter signedint £temporary3097 57
	mov [rbp + 57], eax
 ...
 character_test$214:
	; Parameter signedint £temporary3098 85
	mov [rbp + 85], eax
 ...
 character_test$219:
	; IntegralToIntegral £temporary3101 £temporary3100
	and ebx, 255
	cmp bl, 0
 ...
 character_test$220:
	; Parameter signedint £temporary3101 61
	mov [rbp + 61], ebx
