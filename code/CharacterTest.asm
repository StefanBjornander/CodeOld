...
@7746string_ascii2025i0A#:
	; Initializer String ascii %i\n
	db "ascii %i", 10, 0

section .data

@7747string_islower282725c2729203D2025s0A#:
...
@7751string_isupper282725c2729203D2025s0A#:
...
@7755string_isalpha282725c2729203D2025s0A#:
...
@7759string_isdigit282725c2729203D2025s0A#:
...
@7763string_isalnum282725c2729203D2025s0A#:
...
@7767string_isxdigit282725c2729203D2025s0A#:
...
@7771string_isgraph282725c2729203D2025s0A#:
...
@7775string_isprint282725c2729203D2025s0A#:
...
@7779string_ispunct282725c2729203D2025s0A#:
...
@7783string_iscntrl282725c2729203D2025s0A#:
...
@7787string_isspace282725c2729203D2025s0A#:
...
@7791string_tolower282725c2729203D202725c270A#:
	; Initializer String tolower('%c') = '%c'\n
	db "tolower(", 39, "%c", 39, ") = ", 39, "%c", 39, 10, 0

section .data

@7792string_toupper282725c2729203D202725c270A0A#:
...
section .text
 ...
 character_testX$1:
	...
	mov qword [rbp + 49], @7746string_ascii2025i0A#
 ...
 character_testX$7:
	...
	mov qword [rbp + 49], @7747string_islower282725c2729203D2025s0A#
 ...
 character_testX$24:
	...
	mov qword [rbp + 49], @7751string_isupper282725c2729203D2025s0A#
 ...
 character_testX$41:
	...
	mov qword [rbp + 49], @7755string_isalpha282725c2729203D2025s0A#
 ...
 character_testX$58:
	...
	mov qword [rbp + 49], @7759string_isdigit282725c2729203D2025s0A#
 ...
 character_testX$75:
	...
	mov qword [rbp + 49], @7763string_isalnum282725c2729203D2025s0A#
 ...
 character_testX$92:
	...
	mov qword [rbp + 49], @7767string_isxdigit282725c2729203D2025s0A#
 ...
 character_testX$109:
	...
	mov qword [rbp + 49], @7771string_isgraph282725c2729203D2025s0A#
 ...
 character_testX$126:
	...
	mov qword [rbp + 49], @7775string_isprint282725c2729203D2025s0A#
 ...
 character_testX$143:
	...
	mov qword [rbp + 49], @7779string_ispunct282725c2729203D2025s0A#
 ...
 character_testX$160:
	...
	mov qword [rbp + 49], @7783string_iscntrl282725c2729203D2025s0A#
 ...
 character_testX$177:
	...
	mov qword [rbp + 49], @7787string_isspace282725c2729203D2025s0A#
 ...
 character_testX$194:
	...
	mov qword [rbp + 49], @7791string_tolower282725c2729203D202725c270A#
 ...
 character_testX$209:
	...
	mov qword [rbp + 49], @7792string_toupper282725c2729203D202725c270A0A#
