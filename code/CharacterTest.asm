...
section .text
 ...
 character_test$2:
	; IntegralToIntegral £temporary2874 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$3:
	; Parameter signedint £temporary2874 57
	mov [rbp + 57], eax
 ...
 character_test$8:
	; IntegralToIntegral £temporary2876 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$9:
	; Parameter signedint £temporary2876 57
	mov [rbp + 57], eax
 ...
 character_test$11:
	; IntegralToIntegral £temporary2877 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$12:
	; Parameter signedint £temporary2877 85
	mov [rbp + 85], eax
 ...
 character_test$16:
	; Equal 19 £temporary2878 0
	cmp ebx, 0
	je character_test$19

 character_test$17:
	; Assign £temporary2880 "Yes"
	mov rax, string_Yes#
 ...
 character_test$19:
	; Assign £temporary2880 "No"
	mov rax, string_No#

 character_test$20:
	; Parameter pointer £temporary2880 61
	mov [rbp + 61], rax
 ...
 character_test$25:
	; IntegralToIntegral £temporary2882 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$26:
	; Parameter signedint £temporary2882 57
	mov [rbp + 57], eax
 ...
 character_test$28:
	; IntegralToIntegral £temporary2883 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$29:
	; Parameter signedint £temporary2883 85
	mov [rbp + 85], eax
 ...
 character_test$32:
	; GetReturnValue £temporary2884

 character_test$33:
	; Equal 36 £temporary2884 0
	cmp ebx, 0
	je character_test$36

 character_test$34:
	; Assign £temporary2886 "Yes"
	mov rax, string_Yes#
 ...
 character_test$36:
	; Assign £temporary2886 "No"
	mov rax, string_No#

 character_test$37:
	; Parameter pointer £temporary2886 61
	mov [rbp + 61], rax
 ...
 character_test$42:
	; IntegralToIntegral £temporary2888 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$43:
	; Parameter signedint £temporary2888 57
	mov [rbp + 57], eax
 ...
 character_test$46:
	; Parameter signedint £temporary2889 85
	mov [rbp + 85], eax
 ...
 character_test$50:
	; Equal 53 £temporary2890 0
	cmp ebx, 0
	je character_test$53

 character_test$51:
	; Assign £temporary2892 "Yes"
	mov rax, string_Yes#
 ...
 character_test$53:
	; Assign £temporary2892 "No"
	mov rax, string_No#

 character_test$54:
	; Parameter pointer £temporary2892 61
	mov [rbp + 61], rax
 ...
 character_test$60:
	; Parameter signedint £temporary2894 57
	mov [rbp + 57], eax
 ...
 character_test$62:
	; IntegralToIntegral £temporary2895 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$63:
	; Parameter signedint £temporary2895 85
	mov [rbp + 85], eax
 ...
 character_test$67:
	; Equal 70 £temporary2896 0
	cmp ebx, 0
	je character_test$70

 character_test$68:
	; Assign £temporary2898 "Yes"
	mov rax, string_Yes#
 ...
 character_test$70:
	; Assign £temporary2898 "No"
	mov rax, string_No#

 character_test$71:
	; Parameter pointer £temporary2898 61
	mov [rbp + 61], rax
 ...
 character_test$77:
	; Parameter signedint £temporary2900 57
	mov [rbp + 57], eax
 ...
 character_test$79:
	; IntegralToIntegral £temporary2901 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$80:
	; Parameter signedint £temporary2901 85
	mov [rbp + 85], eax
 ...
 character_test$84:
	; Equal 87 £temporary2902 0
	cmp ebx, 0
	je character_test$87

 character_test$85:
	; Assign £temporary2904 "Yes"
	mov rax, string_Yes#
 ...
 character_test$87:
	; Assign £temporary2904 "No"
	mov rax, string_No#

 character_test$88:
	; Parameter pointer £temporary2904 61
	mov [rbp + 61], rax
 ...
 character_test$94:
	; Parameter signedint £temporary2906 57
	mov [rbp + 57], eax
 ...
 character_test$96:
	; IntegralToIntegral £temporary2907 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$97:
	; Parameter signedint £temporary2907 85
	mov [rbp + 85], eax
 ...
 character_test$100:
	; GetReturnValue £temporary2908

 character_test$101:
	; Equal 104 £temporary2908 0
	cmp ebx, 0
	je character_test$104

 character_test$102:
	; Assign £temporary2910 "Yes"
	mov rax, string_Yes#
 ...
 character_test$104:
	; Assign £temporary2910 "No"
	mov rax, string_No#

 character_test$105:
	; Parameter pointer £temporary2910 61
	mov [rbp + 61], rax
 ...
 character_test$111:
	; Parameter signedint £temporary2912 57
	mov [rbp + 57], eax
 ...
 character_test$113:
	; IntegralToIntegral £temporary2913 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$114:
	; Parameter signedint £temporary2913 85
	mov [rbp + 85], eax
 ...
 character_test$118:
	; Equal 121 £temporary2914 0
	cmp ebx, 0
	je character_test$121

 character_test$119:
	; Assign £temporary2916 "Yes"
	mov rax, string_Yes#
 ...
 character_test$121:
	; Assign £temporary2916 "No"
	mov rax, string_No#

 character_test$122:
	; Parameter pointer £temporary2916 61
	mov [rbp + 61], rax
 ...
 character_test$128:
	; Parameter signedint £temporary2918 57
	mov [rbp + 57], eax
 ...
 character_test$130:
	; IntegralToIntegral £temporary2919 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$131:
	; Parameter signedint £temporary2919 85
	mov [rbp + 85], eax
 ...
 character_test$134:
	; GetReturnValue £temporary2920

 character_test$135:
	; Equal 138 £temporary2920 0
	cmp ebx, 0
	je character_test$138

 character_test$136:
	; Assign £temporary2922 "Yes"
	mov rax, string_Yes#
 ...
 character_test$138:
	; Assign £temporary2922 "No"
	mov rax, string_No#

 character_test$139:
	; Parameter pointer £temporary2922 61
	mov [rbp + 61], rax
 ...
 character_test$145:
	; Parameter signedint £temporary2924 57
	mov [rbp + 57], eax
 ...
 character_test$147:
	; IntegralToIntegral £temporary2925 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$148:
	; Parameter signedint £temporary2925 85
	mov [rbp + 85], eax
 ...
 character_test$152:
	; Equal 155 £temporary2926 0
	cmp ebx, 0
	je character_test$155

 character_test$153:
	; Assign £temporary2928 "Yes"
	mov rax, string_Yes#
 ...
 character_test$155:
	; Assign £temporary2928 "No"
	mov rax, string_No#

 character_test$156:
	; Parameter pointer £temporary2928 61
	mov [rbp + 61], rax
 ...
 character_test$162:
	; Parameter signedint £temporary2930 57
	mov [rbp + 57], eax
 ...
 character_test$164:
	; IntegralToIntegral £temporary2931 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$165:
	; Parameter signedint £temporary2931 85
	mov [rbp + 85], eax
 ...
 character_test$169:
	; Equal 172 £temporary2932 0
	cmp ebx, 0
	je character_test$172

 character_test$170:
	; Assign £temporary2934 "Yes"
	mov rax, string_Yes#
 ...
 character_test$172:
	; Assign £temporary2934 "No"
	mov rax, string_No#

 character_test$173:
	; Parameter pointer £temporary2934 61
	mov [rbp + 61], rax
 ...
 character_test$179:
	; Parameter signedint £temporary2936 57
	mov [rbp + 57], eax
 ...
 character_test$181:
	; IntegralToIntegral £temporary2937 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$182:
	; Parameter signedint £temporary2937 85
	mov [rbp + 85], eax
 ...
 character_test$186:
	; Equal 189 £temporary2938 0
	cmp ebx, 0
	je character_test$189

 character_test$187:
	; Assign £temporary2940 "Yes"
	mov rax, string_Yes#
 ...
 character_test$189:
	; Assign £temporary2940 "No"
	mov rax, string_No#

 character_test$190:
	; Parameter pointer £temporary2940 61
	mov [rbp + 61], rax
 ...
 character_test$196:
	; Parameter signedint £temporary2942 57
	mov [rbp + 57], eax
 ...
 character_test$198:
	; IntegralToIntegral £temporary2943 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$199:
	; Parameter signedint £temporary2943 85
	mov [rbp + 85], eax
 ...
 character_test$203:
	; IntegralToIntegral £temporary2945 £temporary2944
	cmp ebx, 0
 ...
 character_test$204:
	; IntegralToIntegral £temporary2946 £temporary2945
	and ebx, 255
	cmp bl, 0
 ...
 character_test$205:
	; Parameter signedint £temporary2946 61
	mov [rbp + 61], ebx
 ...
 character_test$211:
	; Parameter signedint £temporary2948 57
	mov [rbp + 57], eax
 ...
 character_test$213:
	; IntegralToIntegral £temporary2949 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$214:
	; Parameter signedint £temporary2949 85
	mov [rbp + 85], eax
 ...
 character_test$220:
	; Parameter signedint £temporary2952 61
	mov [rbp + 61], ebx
