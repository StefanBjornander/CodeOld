...
@9165$string_ascii2025i0A#:
	; Initializer String ascii %i\n
	db "ascii %i", 10, 0

section .data

@9166$string_islower282725c2729203D2025s0A#:
...
@9171$string_isupper282725c2729203D2025s0A#:
...
@9176$string_isalpha282725c2729203D2025s0A#:
...
@9181$string_isdigit282725c2729203D2025s0A#:
...
@9186$string_isalnum282725c2729203D2025s0A#:
...
@9191$string_isxdigit282725c2729203D2025s0A#:
...
@9196$string_isgraph282725c2729203D2025s0A#:
...
@9201$string_isprint282725c2729203D2025s0A#:
...
@9206$string_ispunct282725c2729203D2025s0A#:
...
@9211$string_iscntrl282725c2729203D2025s0A#:
...
@9216$string_isspace282725c2729203D2025s0A#:
...
@9221$string_tolower282725c2729203D202725c270A#:
	; Initializer String tolower('%c') = '%c'\n
	db "tolower(", 39, "%c", 39, ") = ", 39, "%c", 39, 10, 0

section .data

@9222$string_toupper282725c2729203D202725c270A0A#:
...
section .text
 ...
 character_testX$1:
	...
	mov qword [rbp + 49], @9165$string_ascii2025i0A#
 ...
 character_testX$7:
	...
	mov qword [rbp + 49], @9166$string_islower282725c2729203D2025s0A#

 character_testX$8:
	; IntegralToIntegral £temporary3148 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_testX$9:
	; Parameter 57 signedint £temporary3148
	mov [rbp + 57], eax
 ...
 character_testX$11:
	; IntegralToIntegral £temporary3149 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_testX$12:
	; Parameter 85 signedint £temporary3149
	mov [rbp + 85], eax
 ...
 character_testX$16:
	; Equal 19 £temporary3150 0
	cmp ebx, 0
	je character_testX$19

 character_testX$17:
	; Assign £temporary3152 "Yes"
	mov rax, @9169$string_Yes#
 ...
 character_testX$19:
	; Assign £temporary3152 "No"
	mov rax, @9170$string_No#

 character_testX$20:
	; Parameter 61 pointer £temporary3152
	mov [rbp + 61], rax
 ...
 character_testX$24:
	...
	mov qword [rbp + 49], @9171$string_isupper282725c2729203D2025s0A#

 character_testX$25:
	; IntegralToIntegral £temporary3154 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_testX$26:
	; Parameter 57 signedint £temporary3154
	mov [rbp + 57], eax
 ...
 character_testX$28:
	; IntegralToIntegral £temporary3155 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_testX$29:
	; Parameter 85 signedint £temporary3155
	mov [rbp + 85], eax
 ...
 character_testX$32:
	; GetReturnValue £temporary3156

 character_testX$33:
	; Equal 36 £temporary3156 0
	cmp ebx, 0
	je character_testX$36

 character_testX$34:
	; Assign £temporary3158 "Yes"
	mov rax, @9174$string_Yes#
 ...
 character_testX$36:
	; Assign £temporary3158 "No"
	mov rax, @9175$string_No#

 character_testX$37:
	; Parameter 61 pointer £temporary3158
	mov [rbp + 61], rax
 ...
 character_testX$41:
	...
	mov qword [rbp + 49], @9176$string_isalpha282725c2729203D2025s0A#
 ...
 character_testX$43:
	; Parameter 57 signedint £temporary3160
	mov [rbp + 57], eax
 ...
 character_testX$45:
	; IntegralToIntegral £temporary3161 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_testX$46:
	; Parameter 85 signedint £temporary3161
	mov [rbp + 85], eax
 ...
 character_testX$50:
	; Equal 53 £temporary3162 0
	cmp ebx, 0
	je character_testX$53

 character_testX$51:
	; Assign £temporary3164 "Yes"
	mov rax, @9179$string_Yes#
 ...
 character_testX$53:
	; Assign £temporary3164 "No"
	mov rax, @9180$string_No#

 character_testX$54:
	; Parameter 61 pointer £temporary3164
	mov [rbp + 61], rax
 ...
 character_testX$58:
	...
	mov qword [rbp + 49], @9181$string_isdigit282725c2729203D2025s0A#
 ...
 character_testX$60:
	; Parameter 57 signedint £temporary3166
	mov [rbp + 57], eax
 ...
 character_testX$62:
	; IntegralToIntegral £temporary3167 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_testX$63:
	; Parameter 85 signedint £temporary3167
	mov [rbp + 85], eax
 ...
 character_testX$66:
	; GetReturnValue £temporary3168

 character_testX$67:
	; Equal 70 £temporary3168 0
	cmp ebx, 0
	je character_testX$70

 character_testX$68:
	; Assign £temporary3170 "Yes"
	mov rax, @9184$string_Yes#
 ...
 character_testX$70:
	; Assign £temporary3170 "No"
	mov rax, @9185$string_No#

 character_testX$71:
	; Parameter 61 pointer £temporary3170
	mov [rbp + 61], rax
 ...
 character_testX$75:
	...
	mov qword [rbp + 49], @9186$string_isalnum282725c2729203D2025s0A#
 ...
 character_testX$77:
	; Parameter 57 signedint £temporary3172
	mov [rbp + 57], eax
 ...
 character_testX$80:
	; Parameter 85 signedint £temporary3173
	mov [rbp + 85], eax
 ...
 character_testX$84:
	; Equal 87 £temporary3174 0
	cmp ebx, 0
	je character_testX$87

 character_testX$85:
	; Assign £temporary3176 "Yes"
	mov rax, @9189$string_Yes#
 ...
 character_testX$87:
	; Assign £temporary3176 "No"
	mov rax, @9190$string_No#

 character_testX$88:
	; Parameter 61 pointer £temporary3176
	mov [rbp + 61], rax
 ...
 character_testX$92:
	...
	mov qword [rbp + 49], @9191$string_isxdigit282725c2729203D2025s0A#
 ...
 character_testX$94:
	; Parameter 57 signedint £temporary3178
	mov [rbp + 57], eax
 ...
 character_testX$97:
	; Parameter 85 signedint £temporary3179
	mov [rbp + 85], eax
 ...
 character_testX$101:
	; Equal 104 £temporary3180 0
	cmp ebx, 0
	je character_testX$104

 character_testX$102:
	; Assign £temporary3182 "Yes"
	mov rax, @9194$string_Yes#
 ...
 character_testX$104:
	; Assign £temporary3182 "No"
	mov rax, @9195$string_No#

 character_testX$105:
	; Parameter 61 pointer £temporary3182
	mov [rbp + 61], rax
 ...
 character_testX$109:
	...
	mov qword [rbp + 49], @9196$string_isgraph282725c2729203D2025s0A#
 ...
 character_testX$111:
	; Parameter 57 signedint £temporary3184
	mov [rbp + 57], eax
 ...
 character_testX$114:
	; Parameter 85 signedint £temporary3185
	mov [rbp + 85], eax
 ...
 character_testX$117:
	; GetReturnValue £temporary3186

 character_testX$118:
	; Equal 121 £temporary3186 0
	cmp ebx, 0
	je character_testX$121

 character_testX$119:
	; Assign £temporary3188 "Yes"
	mov rax, @9199$string_Yes#
 ...
 character_testX$121:
	; Assign £temporary3188 "No"
	mov rax, @9200$string_No#

 character_testX$122:
	; Parameter 61 pointer £temporary3188
	mov [rbp + 61], rax
 ...
 character_testX$126:
	...
	mov qword [rbp + 49], @9201$string_isprint282725c2729203D2025s0A#
 ...
 character_testX$128:
	; Parameter 57 signedint £temporary3190
	mov [rbp + 57], eax
 ...
 character_testX$131:
	; Parameter 85 signedint £temporary3191
	mov [rbp + 85], eax
 ...
 character_testX$135:
	; Equal 138 £temporary3192 0
	cmp ebx, 0
	je character_testX$138

 character_testX$136:
	; Assign £temporary3194 "Yes"
	mov rax, @9204$string_Yes#
 ...
 character_testX$138:
	; Assign £temporary3194 "No"
	mov rax, @9205$string_No#

 character_testX$139:
	; Parameter 61 pointer £temporary3194
	mov [rbp + 61], rax
 ...
 character_testX$143:
	...
	mov qword [rbp + 49], @9206$string_ispunct282725c2729203D2025s0A#
 ...
 character_testX$145:
	; Parameter 57 signedint £temporary3196
	mov [rbp + 57], eax
 ...
 character_testX$148:
	; Parameter 85 signedint £temporary3197
	mov [rbp + 85], eax
 ...
 character_testX$151:
	; GetReturnValue £temporary3198

 character_testX$152:
	; Equal 155 £temporary3198 0
	cmp ebx, 0
	je character_testX$155

 character_testX$153:
	; Assign £temporary3200 "Yes"
	mov rax, @9209$string_Yes#
 ...
 character_testX$155:
	; Assign £temporary3200 "No"
	mov rax, @9210$string_No#

 character_testX$156:
	; Parameter 61 pointer £temporary3200
	mov [rbp + 61], rax
 ...
 character_testX$160:
	...
	mov qword [rbp + 49], @9211$string_iscntrl282725c2729203D2025s0A#
 ...
 character_testX$162:
	; Parameter 57 signedint £temporary3202
	mov [rbp + 57], eax
 ...
 character_testX$165:
	; Parameter 85 signedint £temporary3203
	mov [rbp + 85], eax
 ...
 character_testX$169:
	; Equal 172 £temporary3204 0
	cmp ebx, 0
	je character_testX$172

 character_testX$170:
	; Assign £temporary3206 "Yes"
	mov rax, @9214$string_Yes#
 ...
 character_testX$172:
	; Assign £temporary3206 "No"
	mov rax, @9215$string_No#

 character_testX$173:
	; Parameter 61 pointer £temporary3206
	mov [rbp + 61], rax
 ...
 character_testX$177:
	...
	mov qword [rbp + 49], @9216$string_isspace282725c2729203D2025s0A#
 ...
 character_testX$179:
	; Parameter 57 signedint £temporary3208
	mov [rbp + 57], eax
 ...
 character_testX$182:
	; Parameter 85 signedint £temporary3209
	mov [rbp + 85], eax
 ...
 character_testX$185:
	; GetReturnValue £temporary3210

 character_testX$186:
	; Equal 189 £temporary3210 0
	cmp ebx, 0
	je character_testX$189

 character_testX$187:
	; Assign £temporary3212 "Yes"
	mov rax, @9219$string_Yes#
 ...
 character_testX$189:
	; Assign £temporary3212 "No"
	mov rax, @9220$string_No#

 character_testX$190:
	; Parameter 61 pointer £temporary3212
	mov [rbp + 61], rax
 ...
 character_testX$194:
	...
	mov qword [rbp + 49], @9221$string_tolower282725c2729203D202725c270A#
 ...
 character_testX$196:
	; Parameter 57 signedint £temporary3214
	mov [rbp + 57], eax
 ...
 character_testX$199:
	; Parameter 85 signedint £temporary3215
	mov [rbp + 85], eax
 ...
 character_testX$204:
	; IntegralToIntegral £temporary3218 £temporary3217
	and ebx, 255
	cmp bl, 0
 ...
 character_testX$205:
	; Parameter 61 signedint £temporary3218
	mov [rbp + 61], ebx
 ...
 character_testX$209:
	...
	mov qword [rbp + 49], @9222$string_toupper282725c2729203D202725c270A0A#
 ...
 character_testX$211:
	; Parameter 57 signedint £temporary3220
	mov [rbp + 57], eax
 ...
 character_testX$214:
	; Parameter 85 signedint £temporary3221
	mov [rbp + 85], eax
 ...
 character_testX$217:
	; GetReturnValue £temporary3222

 character_testX$218:
	; IntegralToIntegral £temporary3223 £temporary3222
	cmp ebx, 0
 ...
 character_testX$219:
	; IntegralToIntegral £temporary3224 £temporary3223
	and ebx, 255
	cmp bl, 0
 ...
 character_testX$220:
	; Parameter 61 signedint £temporary3224
	mov [rbp + 61], ebx
