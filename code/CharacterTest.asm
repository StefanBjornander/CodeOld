...
@9365$string_ascii2025i0A#:
	; Initializer String ascii %i\n
	db "ascii %i", 10, 0

section .data

@9366$string_islower282725c2729203D2025s0A#:
...
@9371$string_isupper282725c2729203D2025s0A#:
...
@9376$string_isalpha282725c2729203D2025s0A#:
...
@9381$string_isdigit282725c2729203D2025s0A#:
...
@9386$string_isalnum282725c2729203D2025s0A#:
...
@9391$string_isxdigit282725c2729203D2025s0A#:
...
@9396$string_isgraph282725c2729203D2025s0A#:
...
@9401$string_isprint282725c2729203D2025s0A#:
...
@9406$string_ispunct282725c2729203D2025s0A#:
...
@9411$string_iscntrl282725c2729203D2025s0A#:
...
@9416$string_isspace282725c2729203D2025s0A#:
...
@9421$string_tolower282725c2729203D202725c270A#:
	; Initializer String tolower('%c') = '%c'\n
	db "tolower(", 39, "%c", 39, ") = ", 39, "%c", 39, 10, 0

section .data

@9422$string_toupper282725c2729203D202725c270A0A#:
...
section .text
 ...
 character_testX$1:
	...
	mov qword [rbp + 49], @9365$string_ascii2025i0A#
 ...
 character_testX$7:
	...
	mov qword [rbp + 49], @9366$string_islower282725c2729203D2025s0A#
 ...
 character_testX$11:
	; IntegralToIntegral £temporary3419 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_testX$12:
	; Parameter 85 signedint £temporary3419
	mov [rbp + 85], eax
 ...
 character_testX$15:
	; GetReturnValue £temporary3420

 character_testX$16:
	; Equal 19 £temporary3420 0
	cmp ebx, 0
	je character_testX$19

 character_testX$17:
	; Assign £temporary3422 "Yes"
	mov eax, @9369$string_Yes#
 ...
 character_testX$19:
	; Assign £temporary3422 "No"
	mov eax, @9370$string_No#

 character_testX$20:
	; Parameter 61 pointer £temporary3422
	mov [rbp + 61], eax
 ...
 character_testX$24:
	...
	mov qword [rbp + 49], @9371$string_isupper282725c2729203D2025s0A#

 character_testX$25:
	; IntegralToIntegral £temporary3424 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_testX$26:
	; Parameter 57 signedint £temporary3424
	mov [rbp + 57], eax
 ...
 character_testX$28:
	; IntegralToIntegral £temporary3425 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_testX$29:
	; Parameter 85 signedint £temporary3425
	mov [rbp + 85], eax
 ...
 character_testX$33:
	; Equal 36 £temporary3426 0
	cmp ebx, 0
	je character_testX$36

 character_testX$34:
	; Assign £temporary3428 "Yes"
	mov eax, @9374$string_Yes#
 ...
 character_testX$36:
	; Assign £temporary3428 "No"
	mov eax, @9375$string_No#

 character_testX$37:
	; Parameter 61 pointer £temporary3428
	mov [rbp + 61], eax
 ...
 character_testX$41:
	...
	mov qword [rbp + 49], @9376$string_isalpha282725c2729203D2025s0A#

 character_testX$42:
	; IntegralToIntegral £temporary3430 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_testX$43:
	; Parameter 57 signedint £temporary3430
	mov [rbp + 57], eax
 ...
 character_testX$45:
	; IntegralToIntegral £temporary3431 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_testX$46:
	; Parameter 85 signedint £temporary3431
	mov [rbp + 85], eax
 ...
 character_testX$50:
	; Equal 53 £temporary3432 0
	cmp ebx, 0
	je character_testX$53

 character_testX$51:
	; Assign £temporary3434 "Yes"
	mov eax, @9379$string_Yes#
 ...
 character_testX$53:
	; Assign £temporary3434 "No"
	mov eax, @9380$string_No#

 character_testX$54:
	; Parameter 61 pointer £temporary3434
	mov [rbp + 61], eax
 ...
 character_testX$58:
	...
	mov qword [rbp + 49], @9381$string_isdigit282725c2729203D2025s0A#
 ...
 character_testX$60:
	; Parameter 57 signedint £temporary3436
	mov [rbp + 57], eax
 ...
 character_testX$62:
	; IntegralToIntegral £temporary3437 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_testX$63:
	; Parameter 85 signedint £temporary3437
	mov [rbp + 85], eax
 ...
 character_testX$67:
	; Equal 70 £temporary3438 0
	cmp ebx, 0
	je character_testX$70

 character_testX$68:
	; Assign £temporary3440 "Yes"
	mov eax, @9384$string_Yes#
 ...
 character_testX$70:
	; Assign £temporary3440 "No"
	mov eax, @9385$string_No#

 character_testX$71:
	; Parameter 61 pointer £temporary3440
	mov [rbp + 61], eax
 ...
 character_testX$75:
	...
	mov qword [rbp + 49], @9386$string_isalnum282725c2729203D2025s0A#
 ...
 character_testX$77:
	; Parameter 57 signedint £temporary3442
	mov [rbp + 57], eax
 ...
 character_testX$80:
	; Parameter 85 signedint £temporary3443
	mov [rbp + 85], eax
 ...
 character_testX$84:
	; Equal 87 £temporary3444 0
	cmp ebx, 0
	je character_testX$87

 character_testX$85:
	; Assign £temporary3446 "Yes"
	mov eax, @9389$string_Yes#
 ...
 character_testX$87:
	; Assign £temporary3446 "No"
	mov eax, @9390$string_No#

 character_testX$88:
	; Parameter 61 pointer £temporary3446
	mov [rbp + 61], eax
 ...
 character_testX$92:
	...
	mov qword [rbp + 49], @9391$string_isxdigit282725c2729203D2025s0A#
 ...
 character_testX$94:
	; Parameter 57 signedint £temporary3448
	mov [rbp + 57], eax
 ...
 character_testX$97:
	; Parameter 85 signedint £temporary3449
	mov [rbp + 85], eax
 ...
 character_testX$101:
	; Equal 104 £temporary3450 0
	cmp ebx, 0
	je character_testX$104

 character_testX$102:
	; Assign £temporary3452 "Yes"
	mov eax, @9394$string_Yes#
 ...
 character_testX$104:
	...
	mov eax, @9395$string_No#

 character_testX$105:
	; Parameter 61 pointer £temporary3452
	mov [rbp + 61], eax
 ...
 character_testX$109:
	...
	mov qword [rbp + 49], @9396$string_isgraph282725c2729203D2025s0A#
 ...
 character_testX$111:
	; Parameter 57 signedint £temporary3454
	mov [rbp + 57], eax
 ...
 character_testX$114:
	; Parameter 85 signedint £temporary3455
	mov [rbp + 85], eax
 ...
 character_testX$118:
	; Equal 121 £temporary3456 0
	cmp ebx, 0
	je character_testX$121

 character_testX$119:
	; Assign £temporary3458 "Yes"
	mov eax, @9399$string_Yes#
 ...
 character_testX$121:
	...
	mov eax, @9400$string_No#

 character_testX$122:
	; Parameter 61 pointer £temporary3458
	mov [rbp + 61], eax
 ...
 character_testX$126:
	...
	mov qword [rbp + 49], @9401$string_isprint282725c2729203D2025s0A#
 ...
 character_testX$128:
	; Parameter 57 signedint £temporary3460
	mov [rbp + 57], eax
 ...
 character_testX$131:
	; Parameter 85 signedint £temporary3461
	mov [rbp + 85], eax
 ...
 character_testX$135:
	; Equal 138 £temporary3462 0
	cmp ebx, 0
	je character_testX$138

 character_testX$136:
	; Assign £temporary3464 "Yes"
	mov eax, @9404$string_Yes#
 ...
 character_testX$138:
	...
	mov eax, @9405$string_No#

 character_testX$139:
	; Parameter 61 pointer £temporary3464
	mov [rbp + 61], eax
 ...
 character_testX$143:
	...
	mov qword [rbp + 49], @9406$string_ispunct282725c2729203D2025s0A#
 ...
 character_testX$145:
	; Parameter 57 signedint £temporary3466
	mov [rbp + 57], eax
 ...
 character_testX$148:
	; Parameter 85 signedint £temporary3467
	mov [rbp + 85], eax
 ...
 character_testX$152:
	; Equal 155 £temporary3468 0
	cmp ebx, 0
	je character_testX$155

 character_testX$153:
	; Assign £temporary3470 "Yes"
	mov eax, @9409$string_Yes#
 ...
 character_testX$155:
	...
	mov eax, @9410$string_No#

 character_testX$156:
	; Parameter 61 pointer £temporary3470
	mov [rbp + 61], eax
 ...
 character_testX$160:
	...
	mov qword [rbp + 49], @9411$string_iscntrl282725c2729203D2025s0A#
 ...
 character_testX$162:
	; Parameter 57 signedint £temporary3472
	mov [rbp + 57], eax
 ...
 character_testX$165:
	; Parameter 85 signedint £temporary3473
	mov [rbp + 85], eax
 ...
 character_testX$169:
	; Equal 172 £temporary3474 0
	cmp ebx, 0
	je character_testX$172

 character_testX$170:
	; Assign £temporary3476 "Yes"
	mov eax, @9414$string_Yes#
 ...
 character_testX$172:
	...
	mov eax, @9415$string_No#

 character_testX$173:
	; Parameter 61 pointer £temporary3476
	mov [rbp + 61], eax
 ...
 character_testX$177:
	...
	mov qword [rbp + 49], @9416$string_isspace282725c2729203D2025s0A#
 ...
 character_testX$179:
	; Parameter 57 signedint £temporary3478
	mov [rbp + 57], eax
 ...
 character_testX$182:
	; Parameter 85 signedint £temporary3479
	mov [rbp + 85], eax
 ...
 character_testX$186:
	; Equal 189 £temporary3480 0
	cmp ebx, 0
	je character_testX$189

 character_testX$187:
	; Assign £temporary3482 "Yes"
	mov eax, @9419$string_Yes#
 ...
 character_testX$189:
	...
	mov eax, @9420$string_No#

 character_testX$190:
	; Parameter 61 pointer £temporary3482
	mov [rbp + 61], eax
 ...
 character_testX$194:
	...
	mov qword [rbp + 49], @9421$string_tolower282725c2729203D202725c270A#
 ...
 character_testX$196:
	; Parameter 57 signedint £temporary3484
	mov [rbp + 57], eax
 ...
 character_testX$199:
	; Parameter 85 signedint £temporary3485
	mov [rbp + 85], eax
 ...
 character_testX$203:
	; IntegralToIntegral £temporary3487 £temporary3486
	cmp ebx, 0
 ...
 character_testX$204:
	; IntegralToIntegral £temporary3488 £temporary3487
	and ebx, 255
	cmp bl, 0
 ...
 character_testX$205:
	; Parameter 61 signedint £temporary3488
	mov [rbp + 61], ebx
 ...
 character_testX$209:
	...
	mov qword [rbp + 49], @9422$string_toupper282725c2729203D202725c270A0A#
 ...
 character_testX$211:
	; Parameter 57 signedint £temporary3490
	mov [rbp + 57], eax
 ...
 character_testX$214:
	; Parameter 85 signedint £temporary3491
	mov [rbp + 85], eax
 ...
 character_testX$219:
	; IntegralToIntegral £temporary3494 £temporary3493
	and ebx, 255
	cmp bl, 0
 ...
 character_testX$220:
	; Parameter 61 signedint £temporary3494
	mov [rbp + 61], ebx
