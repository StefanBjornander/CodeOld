...
section .text
 ...
 character_test$3:
	; Parameter signedint £temporary2892 57
	mov [rbp + 57], eax
 ...
 character_test$152:
	; Equal 155 £temporary2944 0
	cmp ebx, 0
	je character_test$155

 character_test$153:
	; Assign £temporary2946 "Yes"
	mov rax, string_Yes#
 ...
 character_test$155:
	; Assign £temporary2946 "No"
	mov rax, string_No#

 character_test$156:
	; Parameter pointer £temporary2946 61
	mov [rbp + 61], rax
 ...
 character_test$169:
	; Equal 172 £temporary2950 0
	cmp ebx, 0
	je character_test$172

 character_test$170:
	; Assign £temporary2952 "Yes"
	mov rax, string_Yes#
 ...
 character_test$172:
	; Assign £temporary2952 "No"
	mov rax, string_No#

 character_test$173:
	; Parameter pointer £temporary2952 61
	mov [rbp + 61], rax
 ...
 character_test$179:
	; Parameter signedint £temporary2954 57
	mov [rbp + 57], eax
 ...
 character_test$181:
	; IntegralToIntegral £temporary2955 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$182:
	; Parameter signedint £temporary2955 85
	mov [rbp + 85], eax
 ...
 character_test$186:
	; Equal 189 £temporary2956 0
	cmp ebx, 0
	je character_test$189

 character_test$187:
	; Assign £temporary2958 "Yes"
	mov rax, string_Yes#
 ...
 character_test$189:
	; Assign £temporary2958 "No"
	mov rax, string_No#

 character_test$190:
	; Parameter pointer £temporary2958 61
	mov [rbp + 61], rax
 ...
 character_test$196:
	; Parameter signedint £temporary2960 57
	mov [rbp + 57], eax
 ...
 character_test$198:
	; IntegralToIntegral £temporary2961 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$199:
	; Parameter signedint £temporary2961 85
	mov [rbp + 85], eax
 ...
 character_test$205:
	; Parameter signedint £temporary2964 61
	mov [rbp + 61], ebx
 ...
 character_test$211:
	; Parameter signedint £temporary2966 57
	mov [rbp + 57], eax
 ...
 character_test$213:
	; IntegralToIntegral £temporary2967 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
 ...
 character_test$214:
	; Parameter signedint £temporary2967 85
	mov [rbp + 85], eax
 ...
 character_test$220:
	; Parameter signedint £temporary2970 61
	mov [rbp + 61], ebx
