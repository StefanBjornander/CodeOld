...
section .text
 ...
 fopen$6:
	; NotEqual 21 £temporary722.open -> £temporary725 0
	cmp dword [rsi], 0
	jne fopen$21
...
section .text
 ...
 fflush$7:
	; Equal 21 £temporary772.open -> £temporary775 0
	cmp dword [rsi], 0
	je fflush$21
...
section .text
 ...
 fclose$14:
	; Equal 28 £temporary791.open -> £temporary794 0
	cmp dword [rsi], 0
	je fclose$28
...
section .text
 ...
 fgetc$10:
	; SignedLessThanEqual 14 £temporary812 0
	cmp ebx, 0
	jle fgetc$14
