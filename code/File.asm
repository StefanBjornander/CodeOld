...
section .text
 ...
 fflush$5:
	; BinaryAdd £temporary657 g_fileArray £temporary656
	mov rsi, g_fileArray
	add rsi, rax
 ...
 fflush$11:
	; BinaryAdd £temporary661 g_fileArray £temporary660
	mov rsi, g_fileArray
	add rsi, rax
...
section .text
 ...
 fclose$12:
	; BinaryAdd £temporary676 g_fileArray £temporary675
	mov rsi, g_fileArray
	add rsi, rax
 ...
 fclose$18:
	; BinaryAdd £temporary680 g_fileArray £temporary679
	mov rsi, g_fileArray
	add rsi, rax
...
section .text
 ...
 fgets$2:
	; BinarySubtract £temporary702 size 1
	mov eax, [rbp + 32]
	dec eax
 ...
 fgets$15:
	; BinaryAdd £temporary711 text £temporary710
	mov rsi, [rbp + 24]
	add rsi, rax
 ...
 fgets$22:
	; BinaryAdd £temporary716 text £temporary715
	mov rsi, [rbp + 24]
	add rsi, rax
 ...
 fgets$31:
	; BinaryAdd £temporary723 text £temporary722
	mov rsi, [rbp + 24]
	add rsi, rax
...
section .text
 ...
 gets$15:
	; BinarySubtract £temporary736 size 1
	mov eax, [rbp + 32]
	dec eax
 ...
 gets$17:
	; BinaryAdd £temporary739 s £temporary738
	mov rsi, [rbp + 24]
	add rsi, rax
