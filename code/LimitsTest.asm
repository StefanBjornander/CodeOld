...
@9474$string_ULONG_MAX203D2025lx0A#:
	; Initializer String ULONG_MAX = %lx\n
	db "ULONG_MAX = %lx", 10, 0

section .data

@9476$string_ULONG_MAX203D2025lX0A#:
	; Initializer String ULONG_MAX = %lX\n
	db "ULONG_MAX = %lX", 10, 0
...
section .text
 ...
 limits_test$1:
	...
	mov qword [rbp + 48], @9442$string_CHAR_BIT203D2025i0A#
 ...
 limits_test$6:
	...
	mov qword [rbp + 48], @9444$string_CHAR_MIN203D2025i0A0A#
 ...
 limits_test$11:
	...
	mov qword [rbp + 48], @9447$string_CHAR_MAX203D2025i0A#
 ...
 limits_test$16:
	...
	mov qword [rbp + 48], @9450$string_UCHAR_MAX203D2025u0A0A#
 ...
 limits_test$21:
	...
	mov qword [rbp + 48], @9453$string_SHRT_MIN203D2025i0A#
 ...
 limits_test$26:
	...
	mov qword [rbp + 48], @9456$string_SHRT_MAX203D2025i0A#
 ...
 limits_test$31:
	...
	mov qword [rbp + 48], @9459$string_USHRT_MAX203D2025u0A0A#
 ...
 limits_test$36:
	...
	mov qword [rbp + 48], @9462$string_INT_MIN203D2025i0A#
 ...
 limits_test$41:
	...
	mov qword [rbp + 48], @9464$string_INT_MAX203D2025i0A#
 ...
 limits_test$46:
	...
	mov qword [rbp + 48], @9466$string_UINT_MAX203D2025u0A0A#
 ...
 limits_test$51:
	...
	mov qword [rbp + 48], @9468$string_LONG_MIN203D2025li0A#
 ...
 limits_test$56:
	...
	mov qword [rbp + 48], @9470$string_LONG_MAX203D2025li0A#
 ...
 limits_test$66:
	...
	mov qword [rbp + 48], @9474$string_ULONG_MAX203D2025lx0A#
 ...
 limits_test$71:
	; Parameter 48 pointer "ULONG_MAX = %lX\n"
	mov qword [rbp + 48], @9476$string_ULONG_MAX203D2025lX0A#
