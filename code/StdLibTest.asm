...
section .text
 ...
 compare:
	; IntegralToIntegral £temporary4144 valuePtr1
	mov rsi, [rbp + 24]

 compare$1:
	; Dereference £temporary4145 -> £temporary4144 £temporary4144 0

 compare$2:
	; Assign intValue1 £temporary4145 -> £temporary4144
	mov eax, [rsi]
	mov [rbp + 40], eax

 compare$3:
	; IntegralToIntegral £temporary4146 valuePtr2
	mov rsi, [rbp + 32]

 compare$4:
	; Dereference £temporary4147 -> £temporary4146 £temporary4146 0

 compare$5:
	; Assign intValue2 £temporary4147 -> £temporary4146
	mov eax, [rsi]
	mov [rbp + 44], eax
...
section .text
 ...
 reverse_compare:
	; IntegralToIntegral £temporary4152 valuePtr1
	mov rsi, [rbp + 24]

 reverse_compare$1:
	; Dereference £temporary4153 -> £temporary4152 £temporary4152 0

 reverse_compare$2:
	; Assign intValue1 £temporary4153 -> £temporary4152
	mov eax, [rsi]
	mov [rbp + 40], eax

 reverse_compare$3:
	; IntegralToIntegral £temporary4154 valuePtr2
	mov rsi, [rbp + 32]

 reverse_compare$4:
	; Dereference £temporary4155 -> £temporary4154 £temporary4154 0

 reverse_compare$5:
	; Assign intValue2 £temporary4155 -> £temporary4154
	mov eax, [rsi]
	mov [rbp + 44], eax
...
@13595$string_div_t20quot2025i20rem2025i0A#:
...
section .text
 ...
 print_div$1:
	...
	mov qword [rbp + 56], @13595$string_div_t20quot2025i20rem2025i0A#
...
@13602$string_ldiv_t20quot2025li20rem2025li0A#:
...
section .text
 ...
 print_ldiv$1:
	...
	mov qword [rbp + 64], @13602$string_ldiv_t20quot2025li20rem2025li0A#
...
section .text
 ...
 exit_handle1x$1:
	...
	mov qword [rbp + 48], @13609$string_exit10A#
...
section .text
 ...
 exit_handle2x$1:
	...
	mov qword [rbp + 48], @13612$string_exit20A#
...
section .text
 ...
 exit_handle3x$1:
	...
	mov qword [rbp + 48], @13615$string_exit30A#
...
section .text
 ...
 hello$1:
	...
	mov qword [rbp + 48], @13618$string_HelloFFF#
...
section .text
 ...
 qtest$1:
	...
	mov qword [rbp + 56], @13622$string_f3A2025u0A#

 qtest$2:
	; IntegralToIntegral £temporary4180 f
	mov rax, [rbp + 24]

 qtest$3:
	; Parameter 64 unsigned int £temporary4180
	mov [rbp + 64], eax
...
section .text
 ...
 stdlib_testZ$1:
	...
	mov qword [rbp + 48], @13626$string_hello3A2025u0A#

 stdlib_testZ$2:
	; IntegralToIntegral £temporary4183 hello
	mov rax, hello

 stdlib_testZ$3:
	; Parameter 56 unsigned int £temporary4183
	mov [rbp + 56], eax
 ...
 stdlib_testZ$11:
	...
	mov qword [rbp + 48], @13627$string_Y#
...
@13634$string_atof28221232E4562229203D2025f0A#:
	; Initializer String atof("123.456") = %f\n
	db "atof(", 34, "123.456", 34, ") = %f", 10, 0

section .data

@13635$string_1232E456#:
	; Initializer String 123.456
	db "123.456", 0

section .data

@13636$string_strtod28221232E456789abc222C2026p29203D202825f2C2025s290A#:
	; Initializer String strtod("123.456789abc", &p) = (%f, %s)\n
	db "strtod(", 34, "123.456789abc", 34, ", &p) = (%f, %s)", 10, 0

section .data

@13637$string_1232E456789abc#:
	; Initializer String 123.456789abc
	db "123.456789abc", 0

section .data

@13638$string_0Agetenv2822path2229203D2025s0A#:
	; Initializer String \ngetenv("path") = %s\n
...
@13640$string_system2822dir22290A#:
...
@13642$string_0Aabs282D329203D2025i2C20abs28329203D2025i0A#:
	; Initializer String \nabs(-3) = %i, abs(3) = %i\n
	db 10, "abs(-3) = %i, abs(3) = %i", 10, 0

section .data

@13647$string_labs282D3l29203D2025li2C20labs283l29203D2025li0A0A#:
	; Initializer String labs(-3l) = %li, labs(3l) = %li\n\n
	db "labs(-3l) = %li, labs(3l) = %li", 10, 10, 0

section .data

@13657$string_div_t28102C20329203D202825i2C2025i290A#:
	; Initializer String div_t(10, 3) = (%i, %i)\n
	db "div_t(10, 3) = (%i, %i)", 10, 0

section .data

@13659$string_div_t28102C20329203D202825i2C2025i290A0A#:
	; Initializer String div_t(10, 3) = (%i, %i)\n\n
	db "div_t(10, 3) = (%i, %i)", 10, 10, 0

section .data

@13665$string_ldiv_t28102C20329203D202825li2C2025li290A#:
	; Initializer String ldiv_t(10, 3) = (%li, %li)\n
	db "ldiv_t(10, 3) = (%li, %li)", 10, 0

section .data

@13667$string_ldiv_t28102C20329203D202825li2C2025li290A0A#:
	; Initializer String ldiv_t(10, 3) = (%li, %li)\n\n
	db "ldiv_t(10, 3) = (%li, %li)", 10, 10, 0

section .data

@13684$string_0AA20List2013A20#:
	; Initializer String \nA List 1: 
	db 10, "A List 1: ", 0
...
@13714$string_0A0ASearch3A0A#:
	; Initializer String \n\nSearch:\n
	db 10, 10, "Search:", 10, 0

section .data

@13732$string_20202825i2C2025i290A#:
...
section .text
 ...
 stdlib_test$1:
	...
	mov qword [rbp + 56], @13634$string_atof28221232E4562229203D2025f0A#
 ...
 stdlib_test$3:
	...
	mov qword [rbp + 88], @13635$string_1232E456#
 ...
 stdlib_test$7:
	; Parameter 64 double £temporary4187
	fstp qword [rbp + 64]
 ...
 stdlib_test$11:
	...
	mov qword [rbp + 56], @13636$string_strtod28221232E456789abc222C2026p29203D202825f2C2025s290A#
 ...
 stdlib_test$13:
	...
	mov qword [rbp + 88], @13637$string_1232E456789abc#

 stdlib_test$14:
	; Address £temporary4189 p
	mov rsi, rbp
	add rsi, 24

 stdlib_test$15:
	; Parameter 96 pointer £temporary4189
	mov [rbp + 96], rsi
 ...
 stdlib_test$19:
	; Parameter 64 double £temporary4190
	fstp qword [rbp + 64]
 ...
 stdlib_test$24:
	...
	mov qword [rbp + 48], @13638$string_0Agetenv2822path2229203D2025s0A#
 ...
 stdlib_test$26:
	...
	mov qword [rbp + 80], @13639$string_path#
 ...
 stdlib_test$34:
	...
	mov qword [rbp + 48], @13640$string_system2822dir22290A#
 ...
 stdlib_test$38:
	...
	mov qword [rbp + 48], @13641$string_dir#
 ...
 stdlib_test$42:
	; Parameter 48 pointer "\nabs(-3) = %i, abs(3) = %i\n"
	mov qword [rbp + 48], @13642$string_0Aabs282D329203D2025i2C20abs28329203D2025i0A#
 ...
 stdlib_test$48:
	; Parameter 56 signedint £temporary4196
	mov [rbp + 56], ebx
 ...
 stdlib_test$54:
	; Parameter 60 signedint £temporary4197
	mov [rbp + 60], ebx
 ...
 stdlib_test$58:
	...
	mov qword [rbp + 48], @13647$string_labs282D3l29203D2025li2C20labs283l29203D2025li0A0A#
 ...
 stdlib_test$64:
	; Parameter 56 signed long int £temporary4199
	mov [rbp + 56], rbx
 ...
 stdlib_test$70:
	; Parameter 64 signed long int £temporary4200
	mov [rbp + 64], rbx
 ...
 stdlib_test$78:
	; GetReturnValue £temporary4202 -> £temporary4203

 stdlib_test$79:
	; AssignInitSize i £temporary4202 -> £temporary4203
	mov rsi, rbp
	add rsi, 24
	mov al, 8

 stdlib_test$80:
	; Assign i £temporary4202 -> £temporary4203
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 stdlib_test$82:
	...
	mov qword [rbp + 56], @13657$string_div_t28102C20329203D202825i2C2025i290A#
 ...
 stdlib_test$92:
	; GetReturnValue £temporary4207 -> £temporary4208

 stdlib_test$93:
	; AssignInitSize j £temporary4207 -> £temporary4208
	mov rsi, rbp
	add rsi, 32
	mov al, 8

 stdlib_test$94:
	; Assign j £temporary4207 -> £temporary4208
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 stdlib_test$96:
	...
	mov qword [rbp + 64], @13659$string_div_t28102C20329203D202825i2C2025i290A0A#
 ...
 stdlib_test$106:
	; GetReturnValue £temporary4212 -> £temporary4213

 stdlib_test$107:
	; AssignInitSize li £temporary4212 -> £temporary4213
	mov rsi, rbp
	add rsi, 24
	mov al, 16

 stdlib_test$108:
	; Assign li £temporary4212 -> £temporary4213
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 stdlib_test$110:
	...
	mov qword [rbp + 64], @13665$string_ldiv_t28102C20329203D202825li2C2025li290A#
 ...
 stdlib_test$120:
	; GetReturnValue £temporary4217 -> £temporary4218

 stdlib_test$121:
	; AssignInitSize lj £temporary4217 -> £temporary4218
	mov rsi, rbp
	add rsi, 40
	mov al, 16

 stdlib_test$122:
	; Assign lj £temporary4217 -> £temporary4218
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 stdlib_test$124:
	...
	mov qword [rbp + 80], @13667$string_ldiv_t28102C20329203D202825li2C2025li290A0A#
 ...
 stdlib_test$135:
	...
	mov qword [rbp + 72], @13684$string_0AA20List2013A20#
 ...
 stdlib_test$141:
	...
	mov qword [rbp + 72], @13688$string_25i20#

 stdlib_test$142:
	; Multiply £temporary4230 index 4
	mov eax, [rbp + 44]
	xor edx, edx
	imul dword [@13690$int4$4#]
 ...
 stdlib_test$144:
	; BinaryAdd £temporary4232 list £temporary4231
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 stdlib_test$145:
	; Dereference £temporary4233 -> £temporary4232 £temporary4232 0

 stdlib_test$146:
	; Parameter 80 signedint £temporary4233 -> £temporary4232
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$152:
	; Parameter 72 pointer "\nB List 2: "
	mov qword [rbp + 72], @13692$string_0AB20List2023A20#
 ...
 stdlib_test$165:
	; Parameter 72 pointer "%i "
	mov qword [rbp + 72], @13699$string_25i20#

 stdlib_test$166:
	; Multiply £temporary4240 index 4
	mov eax, [rbp + 44]
	xor edx, edx
	imul dword [@13701$int4$4#]

 stdlib_test$167:
	; IntegralToIntegral £temporary4241 £temporary4240
	mov rbx, 4294967295
	and rax, rbx

 stdlib_test$168:
	; BinaryAdd £temporary4242 list £temporary4241
	mov rsi, rbp
	add rsi, 24
	add rsi, rax
 ...
 stdlib_test$170:
	; Parameter 80 signedint £temporary4243 -> £temporary4242
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$176:
	; Parameter 72 pointer "\nC List 3: "
	mov qword [rbp + 72], @13703$string_0AC20List2033A20#
 ...
 stdlib_test$189:
	; Parameter 72 pointer "%i "
	mov qword [rbp + 72], @13710$string_25i20#

 stdlib_test$190:
	; Multiply £temporary4250 index 4
	mov eax, [rbp + 44]
	xor edx, edx
	imul dword [@13712$int4$4#]

 stdlib_test$191:
	; IntegralToIntegral £temporary4251 £temporary4250
	mov rbx, 4294967295
	and rax, rbx

 stdlib_test$192:
	; BinaryAdd £temporary4252 list £temporary4251
	mov rsi, rbp
	add rsi, 24
	add rsi, rax
 ...
 stdlib_test$194:
	; Parameter 80 signedint £temporary4253 -> £temporary4252
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$200:
	; Parameter 72 pointer "\n\nSearch:\n"
	mov qword [rbp + 72], @13714$string_0A0ASearch3A0A#
 ...
 stdlib_test$206:
	; Address £temporary4258 key
	mov rsi, rbp
	add rsi, 44

 stdlib_test$207:
	; Parameter 72 pointer £temporary4258
	mov [rbp + 72], rsi
 ...
 stdlib_test$215:
	; IntegralToIntegral £temporary4261 £temporary4260

 stdlib_test$216:
	; Assign p £temporary4261
	mov [rbp + 48], rbx
 ...
 stdlib_test$218:
	; BinarySubtract £temporary4263 p list
	mov rax, [rbp + 48]
	mov rbx, rbp
	add rbx, 24
	sub rax, rbx
 ...
 stdlib_test$219:
	; IntegralToIntegral £temporary4264 £temporary4263

 stdlib_test$220:
	; Divide £temporary4266 £temporary4264 4
	xor edx, edx
	idiv dword [@13728$int4$4#]
 ...
 stdlib_test$222:
	; Assign £temporary4266 -1
	mov eax, -1

 stdlib_test$223:
	; Assign index £temporary4266
	mov [rbp + 56], eax
 ...
 stdlib_test$225:
	...
	mov qword [rbp + 84], @13732$string_20202825i2C2025i290A#
 ...
 stdlib_test$233:
	...
	mov qword [rbp + 68], @13733$string_0A#
