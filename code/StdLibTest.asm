...
section .text
 ...
 compare:
	; IntegralToIntegral £temporary3767 valuePtr1
	mov rsi, [rbp + 24]

 compare$1:
	; Dereference £temporary3768 -> £temporary3767 £temporary3767 0

 compare$2:
	; Assign intValue1 £temporary3768 -> £temporary3767
	mov eax, [rsi]
	mov [rbp + 40], eax

 compare$3:
	; IntegralToIntegral £temporary3769 valuePtr2
	mov rsi, [rbp + 32]

 compare$4:
	; Dereference £temporary3770 -> £temporary3769 £temporary3769 0

 compare$5:
	; Assign intValue2 £temporary3770 -> £temporary3769
	mov eax, [rsi]
	mov [rbp + 44], eax
 ...
 compare$12:
	; Assign £temporary3773 1
	mov ebx, 1

 compare$13:
	; Assign £temporary3774 £temporary3773

 compare$14:
	; Return £temporary3774
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
	jmp rax
...
section .text
 ...
 reverse_compare:
	; IntegralToIntegral £temporary3775 valuePtr1
	mov rsi, [rbp + 24]

 reverse_compare$1:
	; Dereference £temporary3776 -> £temporary3775 £temporary3775 0

 reverse_compare$2:
	; Assign intValue1 £temporary3776 -> £temporary3775
	mov eax, [rsi]
	mov [rbp + 40], eax

 reverse_compare$3:
	; IntegralToIntegral £temporary3777 valuePtr2
	mov rsi, [rbp + 32]

 reverse_compare$4:
	; Dereference £temporary3778 -> £temporary3777 £temporary3777 0

 reverse_compare$5:
	; Assign intValue2 £temporary3778 -> £temporary3777
	mov eax, [rsi]
	mov [rbp + 44], eax
 ...
 reverse_compare$12:
	; Assign £temporary3781 -1
	mov ebx, -1

 reverse_compare$13:
	; Assign £temporary3782 £temporary3781

 reverse_compare$14:
	; Return £temporary3782
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
	jmp rax
...
section .text
 ...
 stdlib_test$6:
	; Address £temporary3792 p
	mov rsi, rbp
	add rsi, 324

 stdlib_test$7:
	; Parameter pointer £temporary3792 380
	mov [rbp + 380], rsi
 ...
 stdlib_test$20:
	; Address £temporary3795 q
	mov rsi, rbp
	add rsi, 332

 stdlib_test$21:
	; Parameter pointer £temporary3795 396
	mov [rbp + 396], rsi
 ...
 stdlib_test$29:
	; Address £temporary3797 r
	mov rsi, rbp
	add rsi, 340

 stdlib_test$30:
	; Parameter pointer £temporary3797 404
	mov [rbp + 404], rsi
 ...
 stdlib_test$49:
	; Parameter signedint £temporary3800 412
	mov [rbp + 412], ebx
 ...
 stdlib_test$59:
	; Parameter signed long int £temporary3802 412
	mov [rbp + 412], rbx
 ...
 stdlib_test$88:
	; Parameter pointer £temporary3807 56
	mov [rbp + 56], rbx
 ...
 stdlib_test$106:
	; Parameter signedint £temporary3811 56
	mov [rbp + 56], ebx
 ...
 stdlib_test$112:
	; Parameter signedint £temporary3812 60
	mov [rbp + 60], ebx
 ...
 stdlib_test$118:
	; Parameter signed long int £temporary3813 64
	mov [rbp + 64], rbx
 ...
 stdlib_test$124:
	; Parameter signed long int £temporary3814 72
	mov [rbp + 72], rbx
 ...
 stdlib_test$132:
	; GetReturnValue £temporary3816 -> £temporary3817

 stdlib_test$133:
	; Assign i £temporary3816 -> £temporary3817
	mov rsi, rbp
	add rsi, 24
	mov al, 8
 ...
 stdlib_test$149:
	; GetReturnValue £temporary3822 -> £temporary3823

 stdlib_test$150:
	; Assign li £temporary3822 -> £temporary3823
	mov rsi, rbp
	add rsi, 24
	mov al, 16
 ...
 stdlib_test$174:
	; IntegralToIntegral £temporary3836 index
	mov eax, [rbp + 44]
	mov rbx, 4294967295
	and rax, rbx

 stdlib_test$175:
	; UnsignedMultiply £temporary3838 £temporary3836 4
	xor rdx, rdx
	mul qword [int8$4#]

 stdlib_test$176:
	; BinaryAdd £temporary3837 list £temporary3838
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 stdlib_test$177:
	; Dereference £temporary3839 -> £temporary3837 £temporary3837 0

 stdlib_test$178:
	; Parameter signedint £temporary3839 -> £temporary3837 80
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$198:
	; IntegralToIntegral £temporary3846 index
	mov eax, [rbp + 44]
	mov rbx, 4294967295
	and rax, rbx

 stdlib_test$199:
	; UnsignedMultiply £temporary3848 £temporary3846 4
	xor rdx, rdx
	mul qword [int8$4#]

 stdlib_test$200:
	; BinaryAdd £temporary3847 list £temporary3848
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 stdlib_test$201:
	; Dereference £temporary3849 -> £temporary3847 £temporary3847 0

 stdlib_test$202:
	; Parameter signedint £temporary3849 -> £temporary3847 80
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$222:
	; IntegralToIntegral £temporary3856 index
	mov eax, [rbp + 44]
	mov rbx, 4294967295
	and rax, rbx

 stdlib_test$223:
	; UnsignedMultiply £temporary3858 £temporary3856 4
	xor rdx, rdx
	mul qword [int8$4#]

 stdlib_test$224:
	; BinaryAdd £temporary3857 list £temporary3858
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 stdlib_test$225:
	; Dereference £temporary3859 -> £temporary3857 £temporary3857 0

 stdlib_test$226:
	; Parameter signedint £temporary3859 -> £temporary3857 80
	mov eax, [rsi]
	mov [rbp + 80], eax
 ...
 stdlib_test$238:
	; Address £temporary3864 key
	mov rsi, rbp
	add rsi, 44

 stdlib_test$239:
	; Parameter pointer £temporary3864 72
	mov [rbp + 72], rsi
 ...
 stdlib_test$250:
	; BinarySubtract £temporary3870 p list
	mov rax, [rbp + 48]
	sub rax, rbp
	sub rax, 24

 stdlib_test$251:
	; UnsignedDivide £temporary3869 £temporary3870 4
	xor rdx, rdx
	div qword [int8$4#]

 stdlib_test$252:
	; IntegralToIntegral £temporary3871 £temporary3869

 stdlib_test$253:
	; Assign £temporary3872 £temporary3871
 ...
 stdlib_test$255:
	; Assign £temporary3872 -1
	mov eax, -1

 stdlib_test$256:
	; Assign index £temporary3872
	mov [rbp + 56], eax
