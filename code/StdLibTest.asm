...
section .text
 ...
 compare:
	; IntegralToIntegral £temporary4353 valuePtr1
	mov rsi, [rbp + 24]
 ...
 compare$2:
	; Assign intValue1 £temporary4354 -> £temporary4353
	mov eax, [rsi]
	mov [rbp + 40], eax

 compare$3:
	; IntegralToIntegral £temporary4355 valuePtr2
	mov rsi, [rbp + 32]

 compare$4:
	; Dereference £temporary4356 -> £temporary4355 £temporary4355 0

 compare$5:
	; Assign intValue2 £temporary4356 -> £temporary4355
	mov eax, [rsi]
	mov [rbp + 44], eax
...
section .text
 ...
 reverse_compare:
	; IntegralToIntegral £temporary4361 valuePtr1
	mov rsi, [rbp + 24]
 ...
 reverse_compare$2:
	; Assign intValue1 £temporary4362 -> £temporary4361
	mov eax, [rsi]
	mov [rbp + 40], eax

 reverse_compare$3:
	; IntegralToIntegral £temporary4363 valuePtr2
	mov rsi, [rbp + 32]

 reverse_compare$4:
	; Dereference £temporary4364 -> £temporary4363 £temporary4363 0

 reverse_compare$5:
	; Assign intValue2 £temporary4364 -> £temporary4363
	mov eax, [rsi]
	mov [rbp + 44], eax
...
section .text
 ...
 qtest$2:
	; IntegralToIntegral £temporary4389 f
	mov rax, [rbp + 24]

 qtest$3:
	; Parameter unsigned int £temporary4389 64
	mov [rbp + 64], eax
...
section .text
 ...
 stdlib_testZ$2:
	; IntegralToIntegral £temporary4392 hello
	mov rax, hello

 stdlib_testZ$3:
	; Parameter unsigned int £temporary4392 56
	mov [rbp + 56], eax
...
section .text
 ...
 stdlib_test$7:
	; Parameter double £temporary4396 64
	fstp qword [rbp + 64]
 ...
 stdlib_test$14:
	; Address £temporary4398 p
	mov rsi, rbp
	add rsi, 24

 stdlib_test$15:
	; Parameter pointer £temporary4398 96
	mov [rbp + 96], rsi
 ...
 stdlib_test$19:
	; Parameter double £temporary4399 64
	fstp qword [rbp + 64]
 ...
 stdlib_test$30:
	; Parameter pointer £temporary4401 56
	mov [rbp + 56], rbx
 ...
 stdlib_test$48:
	; Parameter signedint £temporary4405 56
	mov [rbp + 56], ebx
 ...
 stdlib_test$54:
	; Parameter signedint £temporary4406 60
	mov [rbp + 60], ebx
 ...
 stdlib_test$64:
	; Parameter signed long int £temporary4408 56
	mov [rbp + 56], rbx
 ...
 stdlib_test$70:
	; Parameter signed long int £temporary4409 64
	mov [rbp + 64], rbx
 ...
 stdlib_test$79:
	; AssignInitSize i £temporary4411 -> £temporary4412
	mov rsi, rbp
	add rsi, 24
	mov al, 8

 stdlib_test$80:
	; Assign i £temporary4411 -> £temporary4412
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 stdlib_test$93:
	; AssignInitSize j £temporary4416 -> £temporary4417
	mov rsi, rbp
	add rsi, 32
	mov al, 8

 stdlib_test$94:
	; Assign j £temporary4416 -> £temporary4417
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 stdlib_test$107:
	; AssignInitSize li £temporary4421 -> £temporary4422
	mov rsi, rbp
	add rsi, 24
	mov al, 16
 ...
 stdlib_test$120:
	; GetReturnValue £temporary4426 -> £temporary4427

 stdlib_test$121:
	; AssignInitSize lj £temporary4426 -> £temporary4427
	mov rsi, rbp
	add rsi, 40
	mov al, 16

 stdlib_test$122:
	; Assign lj £temporary4426 -> £temporary4427
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 stdlib_test$206:
	; Address £temporary4467 key
	mov rsi, rbp
	add rsi, 44

 stdlib_test$207:
	; Parameter pointer £temporary4467 72
	mov [rbp + 72], rsi
 ...
 stdlib_test$215:
	; IntegralToIntegral £temporary4470 £temporary4469

 stdlib_test$216:
	; Assign p £temporary4470
	mov [rbp + 48], rbx
 ...
 stdlib_test$218:
	; BinarySubtract £temporary4473 p list
	mov rax, [rbp + 48]
	mov rbx, rbp
	add rbx, 24
	sub rax, rbx
 ...
 stdlib_test$219:
	; UnsignedDivide £temporary4472 £temporary4473 4
	xor rdx, rdx
	div qword [int8$4#]

 stdlib_test$220:
	; IntegralToIntegral £temporary4475 £temporary4472
 ...
 stdlib_test$222:
	; Assign £temporary4475 -1
	mov eax, -1

 stdlib_test$223:
	; Assign index £temporary4475
	mov [rbp + 56], eax
