...
section .text
 ...
 file_test$6:
	; Assign inFilePtrPtr £temporary3888
	mov [rbp + 40], rbx
 ...
 file_test$13:
	; Assign outFilePtrPtr £temporary3889
	mov [rbp + 48], rbx
 ...
 file_test$42:
	; Address £temporary3898 size
	mov rsi, rbp
	add rsi, 56

 file_test$43:
	; Parameter pointer £temporary3898 104
	mov [rbp + 104], rsi
 ...
 file_test$52:
	; Parameter double £temporary3902 96
	fstp qword [rbp + 96]
 ...
 file_test$60:
	; Address £temporary3904 inValue
	mov rsi, rbp
	add rsi, 64

 file_test$61:
	; Parameter pointer £temporary3904 120
	mov [rbp + 120], rsi
 ...
 file_test$105:
	; Parameter pointer £temporary3912 92
	mov [rbp + 92], rbx
 ...
 file_test$129:
	; Parameter pointer £temporary3917 84
	mov [rbp + 84], rbx
 ...
 file_test$166:
	; Address £temporary3926 size
	mov rsi, rbp
	add rsi, 52

 file_test$167:
	; Parameter pointer £temporary3926 96
	mov [rbp + 96], rsi
 ...
 file_test$203:
	; Assign inFilePtr £temporary3934
	mov [rbp + 56], rbx
 ...
 file_test$210:
	; Assign outFilePtr £temporary3935
	mov [rbp + 64], rbx
 ...
 file_test$240:
	; IntegralToIntegral £temporary3945 £temporary3944
	cmp ebx, 0
	jge file_test$241
	neg ebx
	neg bl
 ...
 file_test$241:
	; Assign c £temporary3945
	mov [rbp + 72], bl

 file_test$242:
	; IntegralToIntegral £temporary3946 c
	mov al, [rbp + 72]
	and eax, 255
	cmp al, 0
	jge file_test$243
 ...
 file_test$246:
	; Parameter signedint £temporary3948 97
	mov [rbp + 97], eax
 ...
 file_test$271:
	; Assign outFilePtr £temporary3955
	mov [rbp + 40], rbx
 ...
 file_test$286:
	; Address £temporary3960 size
	mov rsi, rbp
	add rsi, 48

 file_test$287:
	; Parameter pointer £temporary3960 80
	mov [rbp + 80], rsi
 ...
 file_test$295:
	; SignedMultiply £temporary3964 index index
	mov eax, [rbp + 52]
	xor edx, edx
	imul dword [rbp + 52]

 file_test$296:
	; IntegralToFloating £temporary3965 £temporary3964
 ...
 file_test$299:
	; Address £temporary3966 value
	mov rsi, rbp
	add rsi, 56

 file_test$300:
	; Parameter pointer £temporary3966 88
	mov [rbp + 88], rsi
 ...
 file_test$318:
	; Assign inFilePtr £temporary3969
	mov [rbp + 40], rbx
 ...
 file_test$332:
	; Address £temporary3974 size
	mov rsi, rbp
	add rsi, 48

 file_test$333:
	; Parameter pointer £temporary3974 160
	mov [rbp + 160], rsi
 ...
 file_test$345:
	; Address £temporary3977 arr
	mov rsi, rbp
	add rsi, 56

 file_test$346:
	; Parameter pointer £temporary3977 160
	mov [rbp + 160], rsi
 ...
 file_test$361:
	; IntegralToIntegral £temporary3983 index
	mov eax, [rbp + 52]
	mov rbx, 4294967295
	and rax, rbx

 file_test$362:
	; UnsignedMultiply £temporary3984 £temporary3983 8
	xor rdx, rdx
	mul qword [Array_8#]

 file_test$363:
	; BinaryAdd £temporary3985 arr £temporary3984
	mov rsi, rbp
	add rsi, 56
	add rsi, rax

 file_test$364:
	; Dereference £temporary3982 -> £temporary3985 £temporary3985 0

 file_test$365:
	; PushFloat £temporary3982 -> £temporary3985
	fld qword [rsi]

 file_test$366:
	; Parameter double £temporary3982 -> £temporary3985 172
	fstp qword [rbp + 172]
 ...
 file_test$381:
	; Assign inFilePtr £temporary3988
	mov [rbp + 40], rbx
 ...
 file_test$396:
	; Parameter pointer £temporary3993 80
	mov [rbp + 80], rsi
 ...
 file_test$411:
	; Parameter pointer £temporary3998 88
	mov [rbp + 88], rsi
 ...
 file_test$440:
	; Assign inFilePtr £temporary4003
	mov [rbp + 40], rbx
 ...
 file_test$454:
	; Address £temporary4008 size
	mov rsi, rbp
	add rsi, 48

 file_test$455:
	; Parameter pointer £temporary4008 76
	mov [rbp + 76], rsi
 ...
 file_test$464:
	; SignedMultiply £temporary4010 size 8
	mov eax, [rbp + 48]
	xor edx, edx
	imul dword [int4$8#]

 file_test$465:
	; Parameter signedint £temporary4010 88
	mov [rbp + 88], eax
 ...
 file_test$474:
	; Assign p £temporary4013
	mov [rbp + 60], rbx

 file_test$475:
	; IntegralToIntegral £temporary4014 size
	mov eax, [rbp + 48]
	mov rbx, 4294967295
	and rax, rbx

 file_test$476:
	; UnsignedMultiply £temporary4016 £temporary4014 8
	xor rdx, rdx
	mul qword [int8$8#]

 file_test$477:
	; BinaryAdd endPtr p £temporary4016
	mov rbx, [rbp + 60]
	add rbx, rax
	mov [rbp + 68], rbx
 ...
 file_test$509:
	; IntegralToIntegral £temporary4026 index
	mov eax, [rbp + 56]
	mov rbx, 4294967295
	and rax, rbx

 file_test$510:
	; UnsignedMultiply £temporary4027 £temporary4026 8
	xor rdx, rdx
	mul qword [int8$8#]

 file_test$511:
	; BinaryAdd £temporary4028 p £temporary4027
	mov rsi, [rbp + 60]
	add rsi, rax

 file_test$512:
	; Dereference £temporary4025 -> £temporary4028 £temporary4028 0

 file_test$513:
	; PushFloat £temporary4025 -> £temporary4028
	fld qword [rsi]

 file_test$514:
	; Parameter double £temporary4025 -> £temporary4028 112
	fstp qword [rbp + 112]
 ...
 file_test$591:
	; Assign outFilePtr £temporary4093
	mov [rbp + 248], rbx
 ...
 file_test$641:
	; Address £temporary4108 person
	mov rsi, rbp
	add rsi, 196

 file_test$642:
	; Parameter pointer £temporary4108 288
	mov [rbp + 288], rsi
 ...
 file_test$669:
	; Assign inFilePtr £temporary4115
	mov [rbp + 40], rbx
 ...
 file_test$693:
	; IntegralToIntegral £temporary4122 £temporary4121

 file_test$694:
	; Assign u £temporary4122
	mov [rbp + 48], ebx
 ...
 file_test$701:
	; IntegralToIntegral £temporary4125 £temporary4124
	cmp ebx, 0
	jge file_test$702
	neg ebx
	neg bl
 ...
 file_test$704:
	; IntegralToIntegral £temporary4126 c
	mov al, [rbp + 52]
	and eax, 255
	cmp al, 0
	jge file_test$705
 ...
 file_test$705:
	; Parameter signedint £temporary4126 77
	mov [rbp + 77], eax
 ...
 file_test$731:
	; Equal 734 £temporary4132 0
	cmp ebx, 0
	je file_test$734

 file_test$732:
	; Assign £temporary4134 "Yes"
	mov rax, string_Yes#
 ...
 file_test$734:
	; Assign £temporary4134 "No"
	mov rax, string_No#

 file_test$735:
	; Parameter pointer £temporary4134 72
	mov [rbp + 72], rax
 ...
 file_test$745:
	; Equal 748 £temporary4136 0
	cmp ebx, 0
	je file_test$748

 file_test$746:
	; Assign £temporary4138 "Yes"
	mov rax, string_Yes#
 ...
 file_test$748:
	; Assign £temporary4138 "No"
	mov rax, string_No#

 file_test$749:
	; Parameter pointer £temporary4138 72
	mov [rbp + 72], rax
 ...
 file_test$758:
	; Assign inOutFilePtr £temporary4140
	mov [rbp + 48], rbx
 ...
 file_test$775:
	; Assign tempFilePtr £temporary4145
	mov [rbp + 40], rbx
 ...
 file_test$793:
	; IntegralToIntegral £temporary4151 £temporary4150
	cmp ebx, 0
	jge file_test$794
	neg ebx
	neg bl
 ...
 file_test$794:
	; Assign c £temporary4151
	mov [rbp + 56], bl

 file_test$795:
	; IntegralToIntegral £temporary4152 c
	mov al, [rbp + 56]
	and eax, 255
	cmp al, 0
	jge file_test$796
 ...
 file_test$799:
	; IntegralToIntegral £temporary4154 c
	mov al, [rbp + 56]
	and eax, 255
	cmp al, 0
	jge file_test$800
 ...
 file_test$800:
	; Parameter signedint £temporary4154 81
	mov [rbp + 81], eax
 ...
 file_test$804:
	; Parameter signedint £temporary4155 81
	mov [rbp + 81], ebx
 ...
 file_test$823:
	; IntegralToIntegral £temporary4161 £temporary4160
	cmp ebx, 0
	jge file_test$824
	neg ebx
	neg bl
 ...
 file_test$829:
	; Parameter signedint £temporary4164 81
	mov [rbp + 81], eax
