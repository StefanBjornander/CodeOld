...
section .text
 ...
 file_test$6:
	; Assign inFilePtrPtr £temporary3973
	mov [rbp + 40], rbx
 ...
 file_test$13:
	; Assign outFilePtrPtr £temporary3974
	mov [rbp + 48], rbx
 ...
 file_test$18:
	; Parameter pointer "inFilePtrPtr != NULL" 96
 ...
 file_test$42:
	; Address £temporary3983 size
	mov rsi, rbp
	add rsi, 56

 file_test$43:
	; Parameter pointer £temporary3983 104
	mov [rbp + 104], rsi
 ...
 file_test$52:
	; Parameter double £temporary3987 96
	fstp qword [rbp + 96]
 ...
 file_test$60:
	; Address £temporary3989 inValue
	mov rsi, rbp
	add rsi, 64

 file_test$61:
	; Parameter pointer £temporary3989 120
	mov [rbp + 120], rsi
 ...
 file_test$74:
	; Parameter pointer inFilePtrPtr 80
	mov rax, [rbp + 40]
	mov [rbp + 80], rax
 ...
 file_test$78:
	; Parameter pointer outFilePtrPtr 80
	mov rax, [rbp + 48]
	mov [rbp + 80], rax
 ...
 file_test$105:
	; Parameter pointer £temporary3997 92
	mov [rbp + 92], rbx
 ...
 file_test$129:
	; Parameter pointer £temporary4002 84
	mov [rbp + 84], rbx
 ...
 file_test$138:
	; Assign inFilePtr £temporary4004
	mov [rbp + 40], rbx
 ...
 file_test$166:
	; Address £temporary4011 size
	mov rsi, rbp
	add rsi, 52

 file_test$167:
	; Parameter pointer £temporary4011 96
	mov [rbp + 96], rsi
 ...
 file_test$203:
	; Assign inFilePtr £temporary4019
	mov [rbp + 56], rbx
 ...
 file_test$215:
	; Parameter pointer "inFilePtr != NULL" 112
 ...
 file_test$240:
	; IntegralToIntegral £temporary4030 £temporary4029
	cmp ebx, 0
	jge file_test$241
	neg ebx
	neg bl
 ...
 file_test$241:
	; Assign c £temporary4030
	mov [rbp + 72], bl

 file_test$242:
	; IntegralToIntegral £temporary4031 c
	mov al, [rbp + 72]
	and eax, 255
	cmp al, 0
	jge file_test$243
 ...
 file_test$245:
	; IntegralToIntegral £temporary4033 c
	mov al, [rbp + 72]
	and eax, 255
	cmp al, 0
	jge file_test$246
 ...
 file_test$246:
	; Parameter signedint £temporary4033 97
	mov [rbp + 97], eax
 ...
 file_test$287:
	; Parameter pointer £temporary4045 80
	mov [rbp + 80], rsi
 ...
 file_test$300:
	; Parameter pointer £temporary4051 88
	mov [rbp + 88], rsi
 ...
 file_test$333:
	; Parameter pointer £temporary4059 160
	mov [rbp + 160], rsi

 file_test$334:
	; Parameter signedint 4 168
	mov dword [rbp + 168], 4

 file_test$335:
	; Parameter signedint 1 172
	mov dword [rbp + 172], 1

 file_test$336:
	; Parameter pointer inFilePtr 176
	mov rax, [rbp + 40]
	mov [rbp + 176], rax
 ...
 file_test$345:
	; Address £temporary4062 arr
	mov rsi, rbp
	add rsi, 56

 file_test$346:
	; Parameter pointer £temporary4062 160
	mov [rbp + 160], rsi

 file_test$347:
	; Parameter signedint 80 168
 ...
 file_test$353:
	; Parameter pointer inFilePtr 160
	mov rax, [rbp + 40]
	mov [rbp + 160], rax
 ...
 file_test$361:
	; IntegralToIntegral £temporary4068 index
	mov eax, [rbp + 52]
	mov rbx, 4294967295
	and rax, rbx

 file_test$362:
	; UnsignedMultiply £temporary4069 £temporary4068 8
	xor rdx, rdx
	mul qword [Array_8#]

 file_test$363:
	; BinaryAdd £temporary4070 arr £temporary4069
	mov rsi, rbp
	add rsi, 56
	add rsi, rax

 file_test$364:
	; Dereference £temporary4067 -> £temporary4070 £temporary4070 0

 file_test$365:
	; PushFloat £temporary4067 -> £temporary4070
	fld qword [rsi]

 file_test$366:
	; Parameter double £temporary4067 -> £temporary4070 172
	fstp qword [rbp + 172]
 ...
 file_test$380:
	; GetReturnValue £temporary4073

 file_test$381:
	; Assign inFilePtr £temporary4073
	mov [rbp + 40], rbx
 ...
 file_test$386:
	; Parameter pointer "inFilePtr != NULL" 96
 ...
 file_test$395:
	; Address £temporary4078 size
	mov rsi, rbp
	add rsi, 48

 file_test$396:
	; Parameter pointer £temporary4078 80
	mov [rbp + 80], rsi
 ...
 file_test$410:
	; Address £temporary4083 value
	mov rsi, rbp
	add rsi, 56

 file_test$411:
	; Parameter pointer £temporary4083 88
	mov [rbp + 88], rsi
 ...
 file_test$440:
	; Assign inFilePtr £temporary4088
	mov [rbp + 40], rbx
 ...
 file_test$454:
	; Address £temporary4093 size
	mov rsi, rbp
	add rsi, 48

 file_test$455:
	; Parameter pointer £temporary4093 76
	mov [rbp + 76], rsi
 ...
 file_test$464:
	; SignedMultiply £temporary4095 size 8
	mov eax, [rbp + 48]
	xor edx, edx
	imul dword [int4$8#]

 file_test$465:
	; Parameter signedint £temporary4095 88
	mov [rbp + 88], eax
 ...
 file_test$474:
	; Assign p £temporary4098
	mov [rbp + 60], rbx

 file_test$475:
	; IntegralToIntegral £temporary4099 size
	mov eax, [rbp + 48]
	mov rbx, 4294967295
	and rax, rbx

 file_test$476:
	; UnsignedMultiply £temporary4101 £temporary4099 8
	xor rdx, rdx
	mul qword [int8$8#]

 file_test$477:
	; BinaryAdd endPtr p £temporary4101
	mov rbx, [rbp + 60]
	add rbx, rax
	mov [rbp + 68], rbx
 ...
 file_test$482:
	; Parameter pointer "p != NULL" 116
	mov qword [rbp + 116], string_p20213D20NULL#

 file_test$483:
	; Parameter pointer "C:\Users\Stefan\Documents\vagrant\homestead\code\code\FileTest.c" 124
 ...
 file_test$492:
	; Parameter pointer p 108
	mov rax, [rbp + 60]
	mov [rbp + 108], rax

 file_test$493:
	; Parameter signedint total 116
	mov eax, [rbp + 52]
	mov [rbp + 116], eax

 file_test$494:
	; Parameter pointer endPtr 120
	mov rax, [rbp + 68]
	mov [rbp + 120], rax
 ...
 file_test$499:
	; Parameter signedint total 108
	mov eax, [rbp + 52]
	mov [rbp + 108], eax

 file_test$500:
	; Parameter signedint 1 112
	mov dword [rbp + 112], 1

 file_test$501:
	; Parameter pointer inFilePtr 116
	mov rax, [rbp + 40]
	mov [rbp + 116], rax
 ...
 file_test$509:
	; IntegralToIntegral £temporary4111 index
	mov eax, [rbp + 56]
	mov rbx, 4294967295
	and rax, rbx

 file_test$510:
	; UnsignedMultiply £temporary4112 £temporary4111 8
	xor rdx, rdx
	mul qword [int8$8#]

 file_test$511:
	; BinaryAdd £temporary4113 p £temporary4112
	mov rsi, [rbp + 60]
	add rsi, rax

 file_test$512:
	; Dereference £temporary4110 -> £temporary4113 £temporary4113 0

 file_test$513:
	; PushFloat £temporary4110 -> £temporary4113
	fld qword [rsi]

 file_test$514:
	; Parameter double £temporary4110 -> £temporary4113 112
	fstp qword [rbp + 112]
 ...
 file_test$591:
	; Assign outFilePtr £temporary4178
	mov [rbp + 248], rbx
 ...
 file_test$597:
	; GetReturnValue £temporary4179

 file_test$598:
	; Assign inFilePtr £temporary4179
	mov [rbp + 256], rbx
 ...
 file_test$603:
	; Parameter pointer "outFilePtr != NULL" 304
 ...
 file_test$624:
	; Parameter pointer personVector 288
	mov [rbp + 288], rbp
	add qword [rbp + 288], 40

 file_test$625:
	; Parameter signedint 156 296
 ...
 file_test$627:
	; Parameter pointer outFilePtr 304
	mov rax, [rbp + 248]
	mov [rbp + 304], rax
 ...
 file_test$631:
	; Parameter pointer outFilePtr 288
	mov rax, [rbp + 248]
	mov [rbp + 288], rax
 ...
 file_test$641:
	; Address £temporary4193 person
	mov rsi, rbp
	add rsi, 196

 file_test$642:
	; Parameter pointer £temporary4193 288
	mov [rbp + 288], rsi
 ...
 file_test$669:
	; Assign inFilePtr £temporary4200
	mov [rbp + 40], rbx
 ...
 file_test$693:
	; IntegralToIntegral £temporary4207 £temporary4206

 file_test$694:
	; Assign u £temporary4207
	mov [rbp + 48], ebx
 ...
 file_test$701:
	; IntegralToIntegral £temporary4210 £temporary4209
	cmp ebx, 0
	jge file_test$702
	neg ebx
	neg bl
 ...
 file_test$704:
	; IntegralToIntegral £temporary4211 c
	mov al, [rbp + 52]
	and eax, 255
	cmp al, 0
	jge file_test$705
 ...
 file_test$705:
	; Parameter signedint £temporary4211 77
	mov [rbp + 77], eax
 ...
 file_test$731:
	; Equal 734 £temporary4217 0
	cmp ebx, 0
	je file_test$734

 file_test$732:
	; Assign £temporary4219 "Yes"
	mov eax, string_Yes#
 ...
 file_test$734:
	; Assign £temporary4219 "No"
	mov eax, string_No#

 file_test$735:
	; Parameter pointer £temporary4219 72
	mov [rbp + 72], eax
 ...
 file_test$745:
	; Equal 748 £temporary4221 0
	cmp ebx, 0
	je file_test$748

 file_test$746:
	; Assign £temporary4223 "Yes"
	mov eax, string_Yes#
 ...
 file_test$748:
	; Assign £temporary4223 "No"
	mov eax, string_No#

 file_test$749:
	; Parameter pointer £temporary4223 72
	mov [rbp + 72], eax
 ...
 file_test$758:
	; Assign inOutFilePtr £temporary4225
	mov [rbp + 48], rbx
 ...
 file_test$775:
	; Assign tempFilePtr £temporary4230
	mov [rbp + 40], rbx
 ...
 file_test$794:
	; Assign c £temporary4236
	mov [rbp + 56], bl

 file_test$795:
	; IntegralToIntegral £temporary4237 c
	mov al, [rbp + 56]
	and eax, 255
	cmp al, 0
	jge file_test$796
 ...
 file_test$799:
	; IntegralToIntegral £temporary4239 c
	mov al, [rbp + 56]
	and eax, 255
	cmp al, 0
	jge file_test$800
 ...
 file_test$800:
	; Parameter signedint £temporary4239 81
	mov [rbp + 81], eax
 ...
 file_test$804:
	; Parameter signedint £temporary4240 81
	mov [rbp + 81], ebx
 ...
 file_test$823:
	; IntegralToIntegral £temporary4246 £temporary4245
	cmp ebx, 0
	jge file_test$824
	neg ebx
	neg bl
 ...
 file_test$824:
	; Assign c £temporary4246
	mov [rbp + 56], bl

 file_test$825:
	; IntegralToIntegral £temporary4247 c
	mov al, [rbp + 56]
	and eax, 255
	cmp al, 0
	jge file_test$826
 ...
 file_test$828:
	; IntegralToIntegral £temporary4249 c
	mov al, [rbp + 56]
	and eax, 255
	cmp al, 0
	jge file_test$829
 ...
 file_test$829:
	; Parameter signedint £temporary4249 81
	mov [rbp + 81], eax
