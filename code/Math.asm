...
frexp$4:	; £temporary545 -> p = *p
	mov rsi, [rbp + 32]

frexp$5:	; £temporary545 -> p = int4$0#
	mov dword [rsi], 0
...
frexp$30:	; £temporary546 -> p = £temporary552
	mov [rsi], eax
...
frexp$40:	; £temporary554 -> p = *p
	mov rsi, [rbp + 32]

frexp$41:	; £temporary555 = int_to_float £temporary554 -> p (Signed_Int -> Double)
	fild word [rsi]
...
modf$33:	; pop float £temporary877 -> p
	fstp qword [rsi]
