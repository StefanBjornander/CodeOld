...
section .text
 ...
 rec$1:
	; InspectRegister £temporary4396 bp
 ...
 rec$7:
	; Dereference £temporary4398 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 28]

 rec$8:
	; Parameter 72 unsigned int £temporary4398 -> lowHeapPtr
	mov eax, [rsi]
	mov [rbp + 72], eax
...
section .text
 ...
 malloc_test6$1:
	; InspectRegister £temporary4414 bp

 malloc_test6$2:
	; IntegralToIntegral £temporary4415 £temporary4414
	and ebp, 65535

 malloc_test6$3:
	; Assign stackTop £temporary4415
	mov [rbp + 28], ebp
 ...
 malloc_test6$17:
	; Dereference £temporary4419 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 32]

 malloc_test6$18:
	; Parameter 96 unsigned int £temporary4419 -> lowHeapPtr
	mov eax, [rsi]
	mov [rbp + 96], eax
