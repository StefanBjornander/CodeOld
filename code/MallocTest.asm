...
section .text
 ...
 rec$1:
	; InspectRegister £temporary4455 bp

 rec$2:
	; IntegralToIntegral £temporary4456 £temporary4455
	and ebp, 65535

 rec$3:
	; Assign stackTop £temporary4456
	mov [rbp + 24], ebp
 ...
 rec$7:
	; Dereference £temporary4457 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 28]

 rec$8:
	; Parameter 72 unsigned int £temporary4457 -> lowHeapPtr
	mov eax, [rsi]
	mov [rbp + 72], eax
...
section .text
 ...
 malloc_test6$1:
	; InspectRegister £temporary4473 bp

 malloc_test6$2:
	; IntegralToIntegral £temporary4474 £temporary4473
	and ebp, 65535

 malloc_test6$3:
	; Assign stackTop £temporary4474
	mov [rbp + 28], ebp
 ...
 malloc_test6$17:
	; Dereference £temporary4478 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 32]

 malloc_test6$18:
	; Parameter 96 unsigned int £temporary4478 -> lowHeapPtr
	mov eax, [rsi]
	mov [rbp + 96], eax
