...
section .text
 ...
 rec$1:
	; InspectRegister £temporary3741 bp
 ...
 rec$8:
	; Dereference £temporary3743 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 28]

 rec$9:
	; Parameter unsigned int £temporary3743 -> lowHeapPtr 72
	mov eax, [rsi]
	mov [rbp + 72], eax
...
section .text
 ...
 malloc_test6$1:
	; InspectRegister £temporary3759 bp
 ...
 malloc_test6$18:
	; Dereference £temporary3764 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 32]

 malloc_test6$19:
	; Parameter unsigned int £temporary3764 -> lowHeapPtr 96
	mov eax, [rsi]
	mov [rbp + 96], eax
