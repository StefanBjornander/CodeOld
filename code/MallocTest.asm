...
section .text
 ...
 malloc_test3$19:
	; GetReturnValue £temporary4318

 malloc_test3$20:
	; Assign c £temporary4318
	mov [rbp + 40], rbx
...
section .text
 ...
 rec$1:
	; InspectRegister £temporary4328 bp
 ...
 rec$7:
	; Dereference £temporary4330 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 28]

 rec$8:
	; Parameter unsigned int £temporary4330 -> lowHeapPtr 72
	mov eax, [rsi]
	mov [rbp + 72], eax
...
section .text
 ...
 malloc_test6$1:
	; InspectRegister £temporary4346 bp
 ...
 malloc_test6$17:
	; Dereference £temporary4351 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 32]

 malloc_test6$18:
	; Parameter unsigned int £temporary4351 -> lowHeapPtr 96
	mov eax, [rsi]
	mov [rbp + 96], eax
