...
section .text
 ...
 rec:
	; InspectRegister £temporary4350 bp

 rec$1:
	; IntegralToIntegral £temporary4351 £temporary4350
	and ebp, 65535

 rec$2:
	; Assign stackTop £temporary4351
	mov [rbp + 24], ebp
 ...
 rec$7:
	; Dereference £temporary4352 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 28]

 rec$8:
	; Parameter unsigned int £temporary4352 -> lowHeapPtr 72
	mov eax, [rsi]
	mov [rbp + 72], eax
...
section .text
 ...
 malloc_test6:
	; InspectRegister £temporary4368 bp

 malloc_test6$1:
	; IntegralToIntegral £temporary4369 £temporary4368
	and ebp, 65535

 malloc_test6$2:
	; Assign stackTop £temporary4369
	mov [rbp + 28], ebp
 ...
 malloc_test6$17:
	; Dereference £temporary4373 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 32]

 malloc_test6$18:
	; Parameter unsigned int £temporary4373 -> lowHeapPtr 96
	mov eax, [rsi]
	mov [rbp + 96], eax
