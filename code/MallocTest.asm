...
section .text
 ...
 rec$7:
	; Dereference £temporary4415 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 28]

 rec$8:
	; Parameter unsigned int £temporary4415 -> lowHeapPtr 72
	mov eax, [rsi]
	mov [rbp + 72], eax
...
section .text
 ...
 malloc_test6$1:
	; InspectRegister £temporary4431 bp

 malloc_test6$2:
	; IntegralToIntegral £temporary4432 £temporary4431
	and ebp, 65535

 malloc_test6$3:
	; Assign stackTop £temporary4432
	mov [rbp + 28], ebp
 ...
 malloc_test6$17:
	; Dereference £temporary4436 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 32]

 malloc_test6$18:
	; Parameter unsigned int £temporary4436 -> lowHeapPtr 96
	mov eax, [rsi]
	mov [rbp + 96], eax
