...
section .text
 ...
 malloc_test3$5:
	; GetReturnValue £temporary4329

 malloc_test3$6:
	; Assign a £temporary4329
	mov [rbp + 24], rbx
...
section .text
 ...
 rec:
	; InspectRegister £temporary4341 bp

 rec$1:
	; IntegralToIntegral £temporary4342 £temporary4341
	and ebp, 65535

 rec$2:
	; Assign stackTop £temporary4342
	mov [rbp + 24], ebp
 ...
 rec$7:
	; Dereference £temporary4343 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 28]

 rec$8:
	; Parameter unsigned int £temporary4343 -> lowHeapPtr 72
	mov eax, [rsi]
	mov [rbp + 72], eax
...
section .text
 ...
 malloc_test6:
	; InspectRegister £temporary4359 bp

 malloc_test6$1:
	; IntegralToIntegral £temporary4360 £temporary4359
	and ebp, 65535

 malloc_test6$2:
	; Assign stackTop £temporary4360
	mov [rbp + 28], ebp
 ...
 malloc_test6$17:
	; Dereference £temporary4364 -> lowHeapPtr lowHeapPtr 0
	mov rsi, [rbp + 32]

 malloc_test6$18:
	; Parameter unsigned int £temporary4364 -> lowHeapPtr 96
	mov eax, [rsi]
	mov [rbp + 96], eax
