...
section .text
 ...
 @3648$isDigitInBase$1:
	; IntegralToIntegral £temporary991 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
	jge @3648$isDigitInBase$2
	neg al
	neg eax

 @3648$isDigitInBase$2:
	; Parameter 53 signedint £temporary991
	mov [rbp + 53], eax

 @3648$isDigitInBase$3:
	; Call 29 isdigit 0
	mov qword [rbp + 29], @3648$isDigitInBase$4
	mov [rbp + 37], rbp
	add rbp, 29
	jmp isdigit

 @3648$isDigitInBase$4:
	; PostCall 29

 @3648$isDigitInBase$5:
	; GetReturnValue £temporary992

 @3648$isDigitInBase$6:
	; Equal 17 £temporary992 0
	cmp ebx, 0
	je @3648$isDigitInBase$17

 @3648$isDigitInBase$7:
	; BinarySubtract £temporary993 c 48
	mov al, [rbp + 24]
	sub al, 48

 @3648$isDigitInBase$8:
	; IntegralToIntegral £temporary994 £temporary993
	and eax, 255
	cmp al, 0
	jge @3648$isDigitInBase$9
	neg al
	neg eax

 @3648$isDigitInBase$9:
	; Assign value £temporary994
	mov [rbp + 29], eax

 @3648$isDigitInBase$10:
	; LessThan 14 value 0
	cmp dword [rbp + 29], 0
	jl @3648$isDigitInBase$14

 @3648$isDigitInBase$11:
	; GreaterThanEqual 14 value base
	mov eax, [rbp + 25]
	cmp [rbp + 29], eax
	jge @3648$isDigitInBase$14

 @3648$isDigitInBase$12:
	; Assign £temporary998 1
	mov ebx, 1

 @3648$isDigitInBase$13:
	; Jump 15
	jmp @3648$isDigitInBase$15

 @3648$isDigitInBase$14:
	; Assign £temporary998 0
	mov ebx, 0

 @3648$isDigitInBase$15:
	; SetReturnValue

 @3648$isDigitInBase$16:
	; Return £temporary998
	mov rax, [rbp]
	mov rdi, [rbp + 16]
	mov rbp, [rbp + 8]
 ...
 @3648$isDigitInBase$17:
	; PreCall 29 System.Collections.Generic.HashSet`1[CCompiler.Symbol] 0

 @3648$isDigitInBase$18:
	; IntegralToIntegral £temporary999 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
	jge @3648$isDigitInBase$19
	neg al
	neg eax

 @3648$isDigitInBase$19:
	; Parameter 53 signedint £temporary999
	mov [rbp + 53], eax

 @3648$isDigitInBase$20:
	; Call 29 islower 0
	mov qword [rbp + 29], @3648$isDigitInBase$21
	mov [rbp + 37], rbp
	add rbp, 29
	jmp islower

 @3648$isDigitInBase$21:
	; PostCall 29

 @3648$isDigitInBase$22:
	; GetReturnValue £temporary1000

 @3648$isDigitInBase$23:
	; Equal 34 £temporary1000 0
	cmp ebx, 0
	je @3648$isDigitInBase$34

 @3648$isDigitInBase$24:
	; BinarySubtract £temporary1001 c 97
	mov al, [rbp + 24]
	sub al, 97

 @3648$isDigitInBase$25:
	; IntegralToIntegral £temporary1002 £temporary1001
	and eax, 255
	cmp al, 0
	jge @3648$isDigitInBase$26
	neg al
	neg eax

 @3648$isDigitInBase$26:
	; BinaryAdd value £temporary1002 10
	add eax, 10
	mov [rbp + 29], eax

 @3648$isDigitInBase$27:
	; LessThan 31 value 0
	cmp dword [rbp + 29], 0
	jl @3648$isDigitInBase$31

 @3648$isDigitInBase$28:
	; GreaterThanEqual 31 value base
	mov eax, [rbp + 25]
	cmp [rbp + 29], eax
	jge @3648$isDigitInBase$31

 @3648$isDigitInBase$29:
	; Assign £temporary1007 1
	mov ebx, 1

 @3648$isDigitInBase$30:
	; Jump 32
	jmp @3648$isDigitInBase$32

 @3648$isDigitInBase$31:
	; Assign £temporary1007 0
	mov ebx, 0

 @3648$isDigitInBase$32:
	; SetReturnValue

 @3648$isDigitInBase$33:
 ...
 @3648$isDigitInBase$34:
	; PreCall 29 System.Collections.Generic.HashSet`1[CCompiler.Symbol] 0

 @3648$isDigitInBase$35:
	; IntegralToIntegral £temporary1008 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
	jge @3648$isDigitInBase$36
	neg al
	neg eax

 @3648$isDigitInBase$36:
	; Parameter 53 signedint £temporary1008
	mov [rbp + 53], eax

 @3648$isDigitInBase$37:
	; Call 29 isupper 0
	mov qword [rbp + 29], @3648$isDigitInBase$38
	mov [rbp + 37], rbp
	add rbp, 29
	jmp isupper

 @3648$isDigitInBase$38:
	; PostCall 29

 @3648$isDigitInBase$39:
	; GetReturnValue £temporary1009

 @3648$isDigitInBase$40:
	; Equal 51 £temporary1009 0
	cmp ebx, 0
	je @3648$isDigitInBase$51

 @3648$isDigitInBase$41:
	; BinarySubtract £temporary1010 c 65
	mov al, [rbp + 24]
	sub al, 65

 @3648$isDigitInBase$42:
	; IntegralToIntegral £temporary1011 £temporary1010
	and eax, 255
	cmp al, 0
	jge @3648$isDigitInBase$43
	neg al
	neg eax

 @3648$isDigitInBase$43:
	; BinaryAdd value £temporary1011 10
	add eax, 10
	mov [rbp + 29], eax

 @3648$isDigitInBase$44:
	; LessThan 48 value 0
	cmp dword [rbp + 29], 0
	jl @3648$isDigitInBase$48

 @3648$isDigitInBase$45:
	; GreaterThanEqual 48 value base
	mov eax, [rbp + 25]
	cmp [rbp + 29], eax
	jge @3648$isDigitInBase$48

 @3648$isDigitInBase$46:
	; Assign £temporary1016 1
	mov ebx, 1

 @3648$isDigitInBase$47:
	; Jump 49
	jmp @3648$isDigitInBase$49

 @3648$isDigitInBase$48:
	; Assign £temporary1016 0
	mov ebx, 0

 @3648$isDigitInBase$49:
	; SetReturnValue

 @3648$isDigitInBase$50:
 ...
 @3648$isDigitInBase$51:
	; SetReturnValue

 @3648$isDigitInBase$52:
	; Return 0
	mov ebx, 0
	mov rax, [rbp]
	mov rdi, [rbp + 16]
...
section .text
 ...
 @3683$digitToValue$3:
	; Call 25 isdigit 0
	mov qword [rbp + 25], @3683$digitToValue$4
	mov [rbp + 33], rbp
	add rbp, 25
	jmp isdigit
 ...
 @3683$digitToValue$11:
	; PreCall 25 System.Collections.Generic.HashSet`1[CCompiler.Symbol] 0

 @3683$digitToValue$12:
	; IntegralToIntegral £temporary1024 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
	jge @3683$digitToValue$13
	neg al
	neg eax

 @3683$digitToValue$13:
	; Parameter 49 signedint £temporary1024
	mov [rbp + 49], eax

 @3683$digitToValue$14:
	; Call 25 islower 0
	mov qword [rbp + 25], @3683$digitToValue$15
	mov [rbp + 33], rbp
	add rbp, 25
	jmp islower

 @3683$digitToValue$15:
	; PostCall 25

 @3683$digitToValue$16:
	; GetReturnValue £temporary1025

 @3683$digitToValue$17:
	; Equal 23 £temporary1025 0
	cmp ebx, 0
	je @3683$digitToValue$23

 @3683$digitToValue$18:
	; BinarySubtract £temporary1026 c 97
	mov bl, [rbp + 24]
	sub bl, 97

 @3683$digitToValue$19:
	; IntegralToIntegral £temporary1027 £temporary1026
	and ebx, 255
	cmp bl, 0
	jge @3683$digitToValue$20
	neg bl
	neg ebx

 @3683$digitToValue$20:
	; BinaryAdd £temporary1028 £temporary1027 10
	add ebx, 10

 @3683$digitToValue$21:
	; SetReturnValue

 @3683$digitToValue$22:
 ...
 @3683$digitToValue$23:
	; PreCall 25 System.Collections.Generic.HashSet`1[CCompiler.Symbol] 0

 @3683$digitToValue$24:
	; IntegralToIntegral £temporary1029 c
	mov al, [rbp + 24]
	and eax, 255
	cmp al, 0
	jge @3683$digitToValue$25
	neg al
	neg eax

 @3683$digitToValue$25:
	; Parameter 49 signedint £temporary1029
	mov [rbp + 49], eax

 @3683$digitToValue$26:
	; Call 25 isupper 0
	mov qword [rbp + 25], @3683$digitToValue$27
	mov [rbp + 33], rbp
	add rbp, 25
	jmp isupper

 @3683$digitToValue$27:
	; PostCall 25

 @3683$digitToValue$28:
	; GetReturnValue £temporary1030

 @3683$digitToValue$29:
	; Equal 35 £temporary1030 0
	cmp ebx, 0
	je @3683$digitToValue$35

 @3683$digitToValue$30:
	; BinarySubtract £temporary1031 c 65
	mov bl, [rbp + 24]
	sub bl, 65

 @3683$digitToValue$31:
	; IntegralToIntegral £temporary1032 £temporary1031
	and ebx, 255
	cmp bl, 0
	jge @3683$digitToValue$32
	neg bl
	neg ebx

 @3683$digitToValue$32:
	; BinaryAdd £temporary1033 £temporary1032 10
	add ebx, 10

 @3683$digitToValue$33:
	; SetReturnValue

 @3683$digitToValue$34:
 ...
 @3683$digitToValue$35:
	; SetReturnValue

 @3683$digitToValue$36:
	; Return 0
	mov ebx, 0
	mov rax, [rbp]
	mov rdi, [rbp + 16]
