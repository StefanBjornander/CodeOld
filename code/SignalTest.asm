...
@11313string_Floating20point20error3A2025i0A#:
...
section .text
 ...
 floating_point_error$1:
	...
	mov qword [rbp + 52], @11313string_Floating20point20error3A2025i0A#
...
section .text
 ...
 exit_handle1$1:
	...
	mov qword [rbp + 48], @11317string_exit10A#
...
section .text
 ...
 exit_handle2$1:
	...
	mov qword [rbp + 48], @11320string_exit20A#
...
section .text
 ...
 exit_handle3$1:
	...
	mov qword [rbp + 48], @11323string_exit30A#
...
section .text
 ...
 signal_test$4:
	...
	mov qword [rbp + 60], @11331string_25i0A#
