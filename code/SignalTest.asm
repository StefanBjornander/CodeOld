...
@13103$string_Floating20point20error3A2025i0A#:
...
section .text
 ...
 floating_point_error$1:
	...
	mov qword [rbp + 52], @13103$string_Floating20point20error3A2025i0A#
...
section .text
 ...
 exit_handle1$1:
	...
	mov qword [rbp + 48], @13107$string_exit10A#
...
section .text
 ...
 exit_handle2$1:
	...
	mov qword [rbp + 48], @13110$string_exit20A#
...
section .text
 ...
 exit_handle3$1:
	...
	mov qword [rbp + 48], @13113$string_exit30A#
...
section .text
 ...
 signal_test$4:
	...
	mov qword [rbp + 60], @13123$string_25i0A#
