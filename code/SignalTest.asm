...
section .text
 ...
 floating_point_error$1:
	; parameter string_Floating20point20error3A2025i0A#, offset 52
 ...
 signal_test$4:
	; parameter string_25i0A#, offset 60
 ...
 signal_test$9:
	; parameter exit_handle1, offset 60
	mov qword [rbp + 60], exit_handle1

 signal_test$10:
	; call function noellipse-noellipse atexit
 ...
 signal_test$13:
	; parameter exit_handle2, offset 60
 ...
 signal_test$17:
	; parameter exit_handle3, offset 60
 ...
 signal_test$21:
	; parameter int4$0#, offset 60
	mov dword [rbp + 60], 0

 signal_test$22:
	; call function noellipse-noellipse exit
