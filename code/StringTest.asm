...
@10159$string_Hello2C20World21#:
	; Initializer String Hello, World!
	db "Hello, World!", 0

section .data

@10168$string_strlen282225s2229203D2025i0A#:
	; Initializer String strlen("%s") = %i\n
	db "strlen(", 34, "%s", 34, ") = %i", 10, 0

section .data

@10175$string_t203D202225s222C20u203D202225s220A#:
...
@10298$string_strtok28s2C20222C2229203D202225s220A#:
...
section .text
 ...
 string_test:
	...
	mov qword [rbp + 28], @10159$string_Hello2C20World21#
 ...
 string_test$2:
	...
	mov qword [rbp + 268], @10168$string_strlen282225s2229203D2025i0A#
 ...
 string_test$9:
	; Parameter 284 signedint £temporary3265
	mov [rbp + 284], ebx
 ...
 string_test$23:
	; Dereference £temporary3269 -> u u 0
	mov rsi, rbp
	add rsi, 136

 string_test$24:
	; Assign £temporary3269 -> u 0
	mov byte [rsi + 5], 0
 ...
 string_test$26:
	...
	mov qword [rbp + 268], @10175$string_t203D202225s222C20u203D202225s220A#
 ...
 string_test$33:
	...
	mov qword [rbp + 276], @10176$string_abc#
 ...
 string_test$44:
	; Parameter 276 pointer "abc"
	mov qword [rbp + 276], @10177$string_abc#
 ...
 string_test$48:
	; BinaryAdd £temporary3274 i 2
	mov eax, [rbp + 24]
	add eax, 2

 string_test$49:
	; IntegralToIntegral £temporary3276 £temporary3274
	mov rbx, 4294967295
	and rax, rbx

 string_test$50:
	; BinaryAdd £temporary3277 u £temporary3276
	mov rsi, rbp
	add rsi, 136
	add rsi, rax

 string_test$51:
	; Dereference £temporary3275 -> £temporary3277 £temporary3277 0

 string_test$52:
	; Assign £temporary3275 -> £temporary3277 0
	mov byte [rsi], 0
 ...
 string_test$54:
	; Parameter 268 pointer "t = "%s", u = "%s"\n"
	mov qword [rbp + 268], @10185$string_t203D202225s222C20u203D202225s220A#
 ...
 string_test$60:
	...
	mov qword [rbp + 268], @10186$string_strcmp28s2C20u29203D2025i0A#
 ...
 string_test$71:
	...
	mov qword [rbp + 268], @10187$string_strncmp28s2C20u2C20229203D2025i0A#
 ...
 string_test$79:
	; Parameter 276 signedint £temporary3281
	mov [rbp + 276], ebx
 ...
 string_test$90:
	...
	mov qword [rbp + 268], @10194$string_strchr28s2C2027l2729203D2025i0A#
 ...
 string_test$92:
	; BinarySubtract £temporary3285 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$93:
	; IntegralToIntegral £temporary3287 £temporary3285
 ...
 string_test$95:
	; Assign £temporary3287 -1
	mov eax, -1

 string_test$96:
	; Parameter 276 signedint £temporary3287
	mov [rbp + 276], eax
 ...
 string_test$104:
	; GetReturnValue £temporary3289

 string_test$105:
	; Assign p £temporary3289
	mov [rbp + 236], rbx
 ...
 string_test$107:
	...
	mov qword [rbp + 268], @10203$string_strrchr28s2C2027l2729203D2025i0A#
 ...
 string_test$109:
	; BinarySubtract £temporary3291 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$110:
	; IntegralToIntegral £temporary3293 £temporary3291
 ...
 string_test$112:
	; Assign £temporary3293 -1
	mov eax, -1

 string_test$113:
	; Parameter 276 signedint £temporary3293
	mov [rbp + 276], eax
 ...
 string_test$121:
	; GetReturnValue £temporary3295

 string_test$122:
	; Assign p £temporary3295
	mov [rbp + 236], rbx
 ...
 string_test$124:
	...
	mov qword [rbp + 268], @10212$string_strchr28s2C2027x2729203D2025i0A#
 ...
 string_test$126:
	; BinarySubtract £temporary3297 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$127:
	; IntegralToIntegral £temporary3299 £temporary3297
 ...
 string_test$129:
	; Assign £temporary3299 -1
	mov eax, -1

 string_test$130:
	; Parameter 276 signedint £temporary3299
	mov [rbp + 276], eax
 ...
 string_test$141:
	...
	mov qword [rbp + 268], @10221$string_strrchr28s2C2027x2729203D2025i0A#
 ...
 string_test$143:
	; BinarySubtract £temporary3303 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$144:
	; IntegralToIntegral £temporary3305 £temporary3303
 ...
 string_test$146:
	; Assign £temporary3305 -1
	mov eax, -1

 string_test$147:
	; Parameter 276 signedint £temporary3305
	mov [rbp + 276], eax
 ...
 string_test$152:
	...
	mov qword [rbp + 276], @10227$string_Hello2C20World21#
 ...
 string_test$158:
	; Parameter 276 pointer "Hello, World!"
	mov qword [rbp + 276], @10233$string_Hello2C20World21#
 ...
 string_test$168:
	; Dereference £temporary3310 -> u u 0
	mov rsi, rbp
	add rsi, 136

 string_test$169:
	; Assign £temporary3310 -> u 0
	mov byte [rsi + 19], 0
 ...
 string_test$171:
	...
	mov qword [rbp + 268], @10252$string_s203D202225s222C20t203D202225s222C20u203D202225s220A#
 ...
 string_test$186:
	...
	mov qword [rbp + 268], @10261$string_memchr28s2C2027l272C20SIZE202A20sizeof28char2929203D2025i0A#
 ...
 string_test$188:
	; BinarySubtract £temporary3314 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$189:
	; IntegralToIntegral £temporary3316 £temporary3314
 ...
 string_test$191:
	; Assign £temporary3316 -1
	mov eax, -1

 string_test$192:
	; Parameter 276 signedint £temporary3316
	mov [rbp + 276], eax
 ...
 string_test$201:
	; GetReturnValue £temporary3318

 string_test$202:
	; Assign p £temporary3318
	mov [rbp + 236], rbx
 ...
 string_test$204:
	...
	mov qword [rbp + 268], @10275$string_memchr28s2C2027x272C20SIZE202A20sizeof28char2929203D2025i0A#
 ...
 string_test$206:
	; BinarySubtract £temporary3320 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]
 ...
 string_test$209:
	; Assign £temporary3322 -1
	mov eax, -1

 string_test$210:
	; Parameter 276 signedint £temporary3322
	mov [rbp + 276], eax
 ...
 string_test$214:
	...
	mov qword [rbp + 268], @10281$string_s3A202225s222C20t3A202225s220A#
 ...
 string_test$220:
	...
	mov qword [rbp + 268], @10282$string_strcmp28s2C20t29203D2025i0A#
 ...
 string_test$227:
	; Parameter 276 signedint £temporary3325
	mov [rbp + 276], ebx
 ...
 string_test$231:
	...
	mov qword [rbp + 268], @10283$string_memcmp28s2C20t2C20SIZE202A20sizeof28char2929203D2025i0A#
 ...
 string_test$239:
	; Parameter 276 signedint £temporary3327
	mov [rbp + 276], ebx
 ...
 string_test$243:
	...
	mov qword [rbp + 268], @10289$string_strspn28s2C2022Hello2C20C2229203D2025i0A#
 ...
 string_test$246:
	...
	mov qword [rbp + 308], @10290$string_Hello2C20C#
 ...
 string_test$250:
	; Parameter 276 signedint £temporary3329
	mov [rbp + 276], ebx
 ...
 string_test$254:
	...
	mov qword [rbp + 268], @10291$string_strcspn28s2C2022Hello2C20C2229203D2025i0A#
 ...
 string_test$257:
	; Parameter 308 pointer "Hello, C"
	mov qword [rbp + 308], @10292$string_Hello2C20C#
 ...
 string_test$261:
	; Parameter 276 signedint £temporary3331
	mov [rbp + 276], ebx
 ...
 string_test$265:
	...
	mov qword [rbp + 268], @10293$string_strerror28errno29203D202225s220A#
 ...
 string_test$271:
	; Parameter 276 pointer £temporary3333
	mov [rbp + 276], rbx
 ...
 string_test$276:
	...
	mov qword [rbp + 276], @10294$string_2C#
 ...
 string_test$279:
	; GetReturnValue £temporary3335

 string_test$280:
	; Assign p £temporary3335
	mov [rbp + 236], rbx
 ...
 string_test$283:
	...
	mov qword [rbp + 268], @10298$string_strtok28s2C20222C2229203D202225s220A#
 ...
 string_test$289:
	; Parameter 276 pointer ","
	mov qword [rbp + 276], @10302$string_2C#
