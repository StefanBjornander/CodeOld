...
@9946$string_Hello2C20World21#:
	; Initializer String Hello, World!
	db "Hello, World!", 0

section .data

@9955$string_strlen282225s2229203D2025i0A#:
	; Initializer String strlen("%s") = %i\n
	db "strlen(", 34, "%s", 34, ") = %i", 10, 0

section .data

@9961$string_t203D202225s222C20u203D202225s220A#:
...
@10069$string_strtok28s2C20222C2229203D202225s220A#:
...
section .text
 ...
 string_test:
	...
	mov qword [rbp + 28], @9946$string_Hello2C20World21#
 ...
 string_test$2:
	...
	mov qword [rbp + 268], @9955$string_strlen282225s2229203D2025i0A#
 ...
 string_test$9:
	; Parameter 284 signedint £temporary3239
	mov [rbp + 284], ebx
 ...
 string_test$23:
	; Dereference £temporary3243 -> u u 0
	mov rsi, rbp
	add rsi, 136

 string_test$24:
	; Assign £temporary3243 -> u 0
	mov byte [rsi + 5], 0
 ...
 string_test$26:
	...
	mov qword [rbp + 268], @9961$string_t203D202225s222C20u203D202225s220A#
 ...
 string_test$33:
	...
	mov qword [rbp + 276], @9962$string_abc#
 ...
 string_test$44:
	; Parameter 276 pointer "abc"
	mov qword [rbp + 276], @9963$string_abc#
 ...
 string_test$48:
	; BinaryAdd £temporary3248 i 2
	mov eax, [rbp + 24]
	add eax, 2

 string_test$49:
	; IntegralToIntegral £temporary3250 £temporary3248
	mov rbx, 4294967295
	and rax, rbx

 string_test$50:
	; BinaryAdd £temporary3251 u £temporary3250
	mov rsi, rbp
	add rsi, 136
	add rsi, rax

 string_test$51:
	; Dereference £temporary3249 -> £temporary3251 £temporary3251 0

 string_test$52:
	; Assign £temporary3249 -> £temporary3251 0
	mov byte [rsi], 0
 ...
 string_test$54:
	; Parameter 268 pointer "t = "%s", u = "%s"\n"
	mov qword [rbp + 268], @9970$string_t203D202225s222C20u203D202225s220A#
 ...
 string_test$60:
	...
	mov qword [rbp + 268], @9971$string_strcmp28s2C20u29203D2025i0A#
 ...
 string_test$71:
	...
	mov qword [rbp + 268], @9972$string_strncmp28s2C20u2C20229203D2025i0A#
 ...
 string_test$90:
	...
	mov qword [rbp + 268], @9977$string_strchr28s2C2027l2729203D2025i0A#
 ...
 string_test$92:
	; BinarySubtract £temporary3259 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]
 ...
 string_test$95:
	; Assign £temporary3261 -1
	mov eax, -1

 string_test$96:
	; Parameter 276 signedint £temporary3261
	mov [rbp + 276], eax
 ...
 string_test$107:
	...
	mov qword [rbp + 268], @9985$string_strrchr28s2C2027l2729203D2025i0A#
 ...
 string_test$109:
	; BinarySubtract £temporary3265 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$110:
	; IntegralToIntegral £temporary3267 £temporary3265
 ...
 string_test$124:
	...
	mov qword [rbp + 268], @9993$string_strchr28s2C2027x2729203D2025i0A#
 ...
 string_test$126:
	; BinarySubtract £temporary3271 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$127:
	; IntegralToIntegral £temporary3273 £temporary3271
 ...
 string_test$141:
	...
	mov qword [rbp + 268], @10001$string_strrchr28s2C2027x2729203D2025i0A#
 ...
 string_test$143:
	; BinarySubtract £temporary3277 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$144:
	; IntegralToIntegral £temporary3279 £temporary3277
 ...
 string_test$152:
	...
	mov qword [rbp + 276], @10007$string_Hello2C20World21#
 ...
 string_test$158:
	; Parameter 276 pointer "Hello, World!"
	mov qword [rbp + 276], @10012$string_Hello2C20World21#
 ...
 string_test$168:
	; Dereference £temporary3284 -> u u 0
	mov rsi, rbp
	add rsi, 136

 string_test$169:
	; Assign £temporary3284 -> u 0
	mov byte [rsi + 19], 0
 ...
 string_test$171:
	...
	mov qword [rbp + 268], @10028$string_s203D202225s222C20t203D202225s222C20u203D202225s220A#
 ...
 string_test$186:
	...
	mov qword [rbp + 268], @10035$string_memchr28s2C2027l272C20SIZE202A20sizeof28char2929203D2025i0A#
 ...
 string_test$188:
	; BinarySubtract £temporary3288 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$189:
	; IntegralToIntegral £temporary3290 £temporary3288
 ...
 string_test$191:
	; Assign £temporary3290 -1
	mov eax, -1

 string_test$192:
	; Parameter 276 signedint £temporary3290
	mov [rbp + 276], eax
 ...
 string_test$201:
	; GetReturnValue £temporary3292

 string_test$202:
	; Assign p £temporary3292
	mov [rbp + 236], rbx
 ...
 string_test$204:
	...
	mov qword [rbp + 268], @10047$string_memchr28s2C2027x272C20SIZE202A20sizeof28char2929203D2025i0A#
 ...
 string_test$206:
	; BinarySubtract £temporary3294 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$207:
	; IntegralToIntegral £temporary3296 £temporary3294
 ...
 string_test$209:
	; Assign £temporary3296 -1
	mov eax, -1

 string_test$210:
	; Parameter 276 signedint £temporary3296
	mov [rbp + 276], eax
 ...
 string_test$214:
	...
	mov qword [rbp + 268], @10053$string_s3A202225s222C20t3A202225s220A#
 ...
 string_test$220:
	...
	mov qword [rbp + 268], @10054$string_strcmp28s2C20t29203D2025i0A#
 ...
 string_test$231:
	...
	mov qword [rbp + 268], @10055$string_memcmp28s2C20t2C20SIZE202A20sizeof28char2929203D2025i0A#
 ...
 string_test$239:
	; Parameter 276 signedint £temporary3301
	mov [rbp + 276], ebx
 ...
 string_test$243:
	...
	mov qword [rbp + 268], @10060$string_strspn28s2C2022Hello2C20C2229203D2025i0A#
 ...
 string_test$246:
	...
	mov qword [rbp + 308], @10061$string_Hello2C20C#
 ...
 string_test$249:
	; GetReturnValue £temporary3303

 string_test$250:
	; Parameter 276 signedint £temporary3303
	mov [rbp + 276], ebx
 ...
 string_test$254:
	...
	mov qword [rbp + 268], @10062$string_strcspn28s2C2022Hello2C20C2229203D2025i0A#
 ...
 string_test$257:
	; Parameter 308 pointer "Hello, C"
	mov qword [rbp + 308], @10063$string_Hello2C20C#
 ...
 string_test$265:
	...
	mov qword [rbp + 268], @10064$string_strerror28errno29203D202225s220A#
 ...
 string_test$271:
	; Parameter 276 pointer £temporary3307
	mov [rbp + 276], rbx
 ...
 string_test$276:
	...
	mov qword [rbp + 276], @10065$string_2C#
 ...
 string_test$283:
	...
	mov qword [rbp + 268], @10069$string_strtok28s2C20222C2229203D202225s220A#
 ...
 string_test$289:
	; Parameter 276 pointer ","
	mov qword [rbp + 276], @10073$string_2C#
