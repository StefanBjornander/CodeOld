...
section .text
 ...
 string_test$9:
	; Parameter 284 signedint £temporary3625
	mov [rbp + 284], ebx
 ...
 string_test$23:
	; Dereference £temporary3629 -> u u 0
	mov rsi, rbp
	add rsi, 136

 string_test$24:
	; Assign £temporary3629 -> u 0
	mov byte [rsi + 5], 0
 ...
 string_test$48:
	; BinaryAdd £temporary3634 i 2
	mov eax, [rbp + 24]
	add eax, 2

 string_test$49:
	; IntegralToIntegral £temporary3636 £temporary3634
	mov rbx, 4294967295
	and rax, rbx

 string_test$50:
	; BinaryAdd £temporary3638 u £temporary3636
	mov rsi, rbp
	add rsi, 136
	add rsi, rax

 string_test$51:
	; Dereference £temporary3635 -> £temporary3638 £temporary3638 0

 string_test$52:
	; Assign £temporary3635 -> £temporary3638 0
	mov byte [rsi], 0
 ...
 string_test$79:
	; Parameter 276 signedint £temporary3642
	mov [rbp + 276], ebx
 ...
 string_test$92:
	; BinarySubtract £temporary3647 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]
 ...
 string_test$95:
	; Assign £temporary3649 -1
	mov eax, -1

 string_test$96:
	; Parameter 276 signedint £temporary3649
	mov [rbp + 276], eax
 ...
 string_test$109:
	; BinarySubtract £temporary3654 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$110:
	; IntegralToIntegral £temporary3656 £temporary3654
 ...
 string_test$112:
	; Assign £temporary3656 -1
	mov eax, -1

 string_test$113:
	; Parameter 276 signedint £temporary3656
	mov [rbp + 276], eax
 ...
 string_test$126:
	; BinarySubtract £temporary3661 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$127:
	; IntegralToIntegral £temporary3663 £temporary3661
 ...
 string_test$129:
	; Assign £temporary3663 -1
	mov eax, -1

 string_test$130:
	; Parameter 276 signedint £temporary3663
	mov [rbp + 276], eax
 ...
 string_test$143:
	; BinarySubtract £temporary3668 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$144:
	; IntegralToIntegral £temporary3670 £temporary3668
 ...
 string_test$146:
	; Assign £temporary3670 -1
	mov eax, -1

 string_test$147:
	; Parameter 276 signedint £temporary3670
	mov [rbp + 276], eax
 ...
 string_test$168:
	; Dereference £temporary3675 -> u u 0
	mov rsi, rbp
	add rsi, 136

 string_test$169:
	; Assign £temporary3675 -> u 0
	mov byte [rsi + 19], 0
 ...
 string_test$188:
	; BinarySubtract £temporary3680 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$189:
	; IntegralToIntegral £temporary3682 £temporary3680
 ...
 string_test$191:
	; Assign £temporary3682 -1
	mov eax, -1

 string_test$192:
	; Parameter 276 signedint £temporary3682
	mov [rbp + 276], eax
 ...
 string_test$206:
	; BinarySubtract £temporary3687 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$207:
	; IntegralToIntegral £temporary3689 £temporary3687
 ...
 string_test$209:
	; Assign £temporary3689 -1
	mov eax, -1

 string_test$210:
	; Parameter 276 signedint £temporary3689
	mov [rbp + 276], eax
 ...
 string_test$233:
	; Parameter 276 signedint £temporary3693
	mov [rbp + 276], ebx
 ...
 string_test$254:
	; Parameter 276 pointer £temporary3697
	mov [rbp + 276], rbx
 ...
 string_test$275:
	; GetReturnValue £temporary3702

 string_test$276:
	; Assign p £temporary3702
	mov [rbp + 236], rbx
