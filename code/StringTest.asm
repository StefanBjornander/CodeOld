...
@8706string_Hello2C20World21#:
	; Initializer String Hello, World!
	db "Hello, World!", 0

section .data

@8715string_strlen282225s2229203D2025i0A#:
	; Initializer String strlen("%s") = %i\n
	db "strlen(", 34, "%s", 34, ") = %i", 10, 0

section .data

@8719string_t203D202225s222C20u203D202225s220A#:
...
@8803string_strtok28s2C20222C2229203D202225s220A#:
...
section .text
 ...
 string_test:
	...
	mov qword [rbp + 28], @8706string_Hello2C20World21#
 ...
 string_test$2:
	...
	mov qword [rbp + 268], @8715string_strlen282225s2229203D2025i0A#
 ...
 string_test$9:
	; Parameter 284 signed int £temporary3276
	mov [rbp + 284], ebx
 ...
 string_test$26:
	...
	mov qword [rbp + 268], @8719string_t203D202225s222C20u203D202225s220A#
 ...
 string_test$33:
	...
	mov qword [rbp + 276], @8720string_abc#
 ...
 string_test$44:
	; Parameter 276 pointer string_abc#
	mov qword [rbp + 276], @8721string_abc#
 ...
 string_test$48:
	; Add £temporary3285 i integral4$2#
	mov eax, [rbp + 24]
	add eax, 2

 string_test$49:
	; IntegralToIntegral £temporary3286 £temporary3285
	mov rbx, 4294967295
	and rax, rbx

 string_test$50:
	; Add £temporary3287 u £temporary3286
	mov rsi, rbp
	add rsi, 136
	add rsi, rax

 string_test$51:
	; Dereference £temporary3288 £temporary3287 0

 string_test$52:
	; Assign £temporary3288 integral1$0#
	mov byte [rsi], 0
 ...
 string_test$54:
	; Parameter 268 pointer string_t203D202225s222C20u203D202225s220A#
	mov qword [rbp + 268], @8725string_t203D202225s222C20u203D202225s220A#
 ...
 string_test$60:
	...
	mov qword [rbp + 268], @8726string_strcmp28s2C20u29203D2025i0A#
 ...
 string_test$67:
	; Parameter 276 signed int £temporary3290
	mov [rbp + 276], ebx
 ...
 string_test$71:
	...
	mov qword [rbp + 268], @8727string_strncmp28s2C20u2C20229203D2025i0A#
 ...
 string_test$79:
	; Parameter 276 signed int £temporary3292
	mov [rbp + 276], ebx
 ...
 string_test$90:
	...
	mov qword [rbp + 268], @8731string_strchr28s2C2027l2729203D2025i0A#
 ...
 string_test$92:
	; Subtract £temporary3296 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$93:
	; IntegralToIntegral £temporary3298 £temporary3296
 ...
 string_test$95:
	; Assign £temporary3298 integral4$minus1#
	mov eax, -1

 string_test$96:
	; Parameter 276 signed int £temporary3298
	mov [rbp + 276], eax
 ...
 string_test$107:
	...
	mov qword [rbp + 268], @8737string_strrchr28s2C2027l2729203D2025i0A#
 ...
 string_test$109:
	; Subtract £temporary3302 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$110:
	; IntegralToIntegral £temporary3304 £temporary3302
 ...
 string_test$112:
	; Assign £temporary3304 integral4$minus1#
	mov eax, -1
 ...
 string_test$124:
	...
	mov qword [rbp + 268], @8743string_strchr28s2C2027x2729203D2025i0A#
 ...
 string_test$126:
	; Subtract £temporary3308 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$127:
	; IntegralToIntegral £temporary3310 £temporary3308
 ...
 string_test$129:
	; Assign £temporary3310 integral4$minus1#
	mov eax, -1

 string_test$130:
	; Parameter 276 signed int £temporary3310
	mov [rbp + 276], eax
 ...
 string_test$141:
	...
	mov qword [rbp + 268], @8749string_strrchr28s2C2027x2729203D2025i0A#
 ...
 string_test$146:
	; Assign £temporary3316 integral4$minus1#
	mov eax, -1

 string_test$147:
	; Parameter 276 signed int £temporary3316
	mov [rbp + 276], eax
 ...
 string_test$152:
	...
	mov qword [rbp + 276], @8753string_Hello2C20World21#
 ...
 string_test$158:
	; Parameter 276 pointer string_Hello2C20World21#
	mov qword [rbp + 276], @8757string_Hello2C20World21#
 ...
 string_test$168:
	; Dereference £temporary3321 u 0
	mov rsi, rbp
	add rsi, 136

 string_test$169:
	; Assign £temporary3321 integral1$0#
	mov byte [rsi + 19], 0
 ...
 string_test$171:
	...
	mov qword [rbp + 268], @8770string_s203D202225s222C20t203D202225s222C20u203D202225s220A#
 ...
 string_test$186:
	...
	mov qword [rbp + 268], @8776string_memchr28s2C2027l272C20SIZE202A20sizeof28char2929203D2025i0A#
 ...
 string_test$188:
	; Subtract £temporary3325 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$189:
	; IntegralToIntegral £temporary3327 £temporary3325
 ...
 string_test$191:
	; Assign £temporary3327 integral4$minus1#
	mov eax, -1

 string_test$192:
	; Parameter 276 signed int £temporary3327
	mov [rbp + 276], eax
 ...
 string_test$204:
	...
	mov qword [rbp + 268], @8785string_memchr28s2C2027x272C20SIZE202A20sizeof28char2929203D2025i0A#
 ...
 string_test$206:
	; Subtract £temporary3331 p s
	mov rax, [rbp + 236]
	sub rax, [rbp + 28]

 string_test$207:
	; IntegralToIntegral £temporary3333 £temporary3331
 ...
 string_test$209:
	; Assign £temporary3333 integral4$minus1#
	mov eax, -1

 string_test$210:
	; Parameter 276 signed int £temporary3333
	mov [rbp + 276], eax
 ...
 string_test$214:
	...
	mov qword [rbp + 268], @8789string_s3A202225s222C20t3A202225s220A#
 ...
 string_test$220:
	...
	mov qword [rbp + 268], @8790string_strcmp28s2C20t29203D2025i0A#
 ...
 string_test$231:
	...
	mov qword [rbp + 268], @8791string_memcmp28s2C20t2C20SIZE202A20sizeof28char2929203D2025i0A#
 ...
 string_test$243:
	...
	mov qword [rbp + 268], @8795string_strspn28s2C2022Hello2C20C2229203D2025i0A#
 ...
 string_test$246:
	...
	mov qword [rbp + 308], @8796string_Hello2C20C#
 ...
 string_test$250:
	; Parameter 276 signed int £temporary3340
	mov [rbp + 276], ebx
 ...
 string_test$254:
	...
	mov qword [rbp + 268], @8797string_strcspn28s2C2022Hello2C20C2229203D2025i0A#
 ...
 string_test$257:
	; Parameter 308 pointer string_Hello2C20C#
	mov qword [rbp + 308], @8798string_Hello2C20C#
 ...
 string_test$261:
	; Parameter 276 signed int £temporary3342
	mov [rbp + 276], ebx
 ...
 string_test$265:
	...
	mov qword [rbp + 268], @8799string_strerror28errno29203D202225s220A#
 ...
 string_test$270:
	; GetReturnValue £temporary3344

 string_test$271:
	; Parameter 276 pointer £temporary3344
	mov [rbp + 276], rbx
 ...
 string_test$276:
	...
	mov qword [rbp + 276], @8800string_2C#
 ...
 string_test$283:
	...
	mov qword [rbp + 268], @8803string_strtok28s2C20222C2229203D202225s220A#
 ...
 string_test$289:
	; Parameter 276 pointer string_2C#
	mov qword [rbp + 276], @8806string_2C#
