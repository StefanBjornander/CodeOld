...
section .text
 ...
 time_test$15:
	; parameter £temporary4043, offset 112
	mov [rbp + 112], rsi
 ...
 time_test$40:
	; £temporary4051 = int_to_int s$tm_wday (Signed_Int -> Array)
	mov eax, [rbp + 128]
	mov rbx, 4294967295
	and rax, rbx

 time_test$41:
	; £temporary4052 = £temporary4051 * Array_8#
	xor rdx, rdx
	mul qword [Array_8#]

 time_test$42:
	; £temporary4053 = weekdays + £temporary4052
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$43:
	; £field4050 -> £temporary4053 = *£temporary4053

 time_test$44:
	; parameter £field4050 -> £temporary4053, offset 172
	mov rax, [rsi]
	mov [rbp + 172], rax

 time_test$45:
	; £temporary4055 = s$tm_year + int4$1900#
	mov eax, [rbp + 124]
	add eax, 1900

 time_test$46:
	; parameter £temporary4055, offset 180
	mov [rbp + 180], eax

 time_test$47:
	; £temporary4057 = s$tm_mon + int4$1#
	mov eax, [rbp + 120]
	inc eax

 time_test$48:
	; parameter £temporary4057, offset 184
	mov [rbp + 184], eax
 ...
 time_test$60:
	; parameter £temporary4066, offset 164
	mov [rbp + 164], rsi
 ...
 time_test$63:
	; £temporary4067 = return_value

 time_test$64:
	; £field4068 -> £temporary4067 = *£temporary4067

 time_test$65:
	; s = £field4068 -> £temporary4067
	mov rsi, rbp
	add rsi, 104
	mov al, 36
 ...
 time_test$68:
	; £temporary4071 = int_to_int s$tm_wday (Signed_Int -> Array)
	mov eax, [rbp + 128]
	mov rbx, 4294967295
	and rax, rbx

 time_test$69:
	; £temporary4072 = £temporary4071 * Array_8#
	xor rdx, rdx
	mul qword [Array_8#]

 time_test$70:
	; £temporary4073 = weekdays + £temporary4072
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$71:
	; £field4070 -> £temporary4073 = *£temporary4073

 time_test$72:
	; parameter £field4070 -> £temporary4073, offset 172
	mov rax, [rsi]
	mov [rbp + 172], rax

 time_test$73:
	; £temporary4075 = s$tm_year + int4$1900#
	mov eax, [rbp + 124]
	add eax, 1900

 time_test$74:
	; parameter £temporary4075, offset 180
	mov [rbp + 180], eax

 time_test$75:
	; £temporary4077 = s$tm_mon + int4$1#
	mov eax, [rbp + 120]
	inc eax

 time_test$76:
	; parameter £temporary4077, offset 184
	mov [rbp + 184], eax
 ...
 time_test$90:
	; parameter £temporary4086, offset 396
	mov [rbp + 396], rsi
 ...
 time_test$93:
	; £temporary4087 = return_value

 time_test$94:
	; parameter £temporary4087, offset 372
	mov [rbp + 372], rbx
 ...
 time_test$101:
	; parameter £temporary4089, offset 396
	mov [rbp + 396], rsi
 ...
 time_test$105:
	; parameter £temporary4090, offset 372
	mov [rbp + 372], rbx
 ...
 time_test$119:
	; parameter £temporary4093, offset 684
	mov [rbp + 684], rsi
