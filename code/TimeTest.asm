...
time_test$36:	; £temporary5603 -> p = *p
	mov rsi, [rbp + 88]

time_test$37:	; s = £temporary5603 -> p
	mov rdi, rbp
	add rdi, 104
	mov al, 36
...
time_test$64:	; £temporary5623 -> £temporary5622 = *£temporary5622

time_test$65:	; s = £temporary5623 -> £temporary5622
	mov rsi, rbp
	add rsi, 104
	mov al, 36
