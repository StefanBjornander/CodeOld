...
@14575$string_now2013A2025lu0A#:
	; Initializer String now 1: %lu\n
	db "now 1: %lu", 10, 0

section .data

@14576$string_now2023A2025lu0A#:
	; Initializer String now 2: %lu\n
	db "now 2: %lu", 10, 0

section .data

@14577$string_202020gm20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#:
...
@14584$string_local20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#:
...
@14601$string_asctime203C25s3E2C20ctime203C25s3E0A#:
	; Initializer String asctime <%s>, ctime <%s>\n
	db "asctime <%s>, ctime <%s>", 10, 0

section .data

@14604$string_#:
...
@14606$string_strftime2025i2025i203C25s3E0A#:
...
section .text
 ...
 time_test:
	...
	mov qword [rbp + 24], @14559$string_Sun#

 time_test$1:
	; Assign weekdays[1] "Mon"
	mov qword [rbp + 32], @14560$string_Mon#

 time_test$2:
	; Assign weekdays[2] "Tue"
	mov qword [rbp + 40], @14561$string_Tue#

 time_test$3:
	; Assign weekdays[3] "Wed"
	mov qword [rbp + 48], @14562$string_Wed#

 time_test$4:
	; Assign weekdays[4] "Thu"
	mov qword [rbp + 56], @14563$string_Thu#

 time_test$5:
	; Assign weekdays[5] "Fri"
	mov qword [rbp + 64], @14564$string_Fri#

 time_test$6:
	; Assign weekdays[6] "Sat"
	mov qword [rbp + 72], @14565$string_Sat#
 ...
 time_test$19:
	; Dereference £temporary4302 -> £temporary4301 £temporary4301 0

 time_test$20:
	; AssignInitSize s £temporary4302 -> £temporary4301
	mov rsi, rbp
	add rsi, 88
	mov al, 36

 time_test$21:
	; Assign s £temporary4302 -> £temporary4301
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 time_test$28:
	; Dereference £temporary4305 -> £temporary4304 £temporary4304 0

 time_test$29:
	; AssignInitSize t £temporary4305 -> £temporary4304
	mov rsi, rbp
	add rsi, 124
	mov al, 36

 time_test$30:
	; Assign t £temporary4305 -> £temporary4304
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 time_test$39:
	...
	mov qword [rbp + 192], @14575$string_now2013A2025lu0A#
 ...
 time_test$44:
	...
	mov qword [rbp + 192], @14576$string_now2023A2025lu0A#
 ...
 time_test$49:
	...
	mov qword [rbp + 192], @14577$string_202020gm20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#

 time_test$50:
	; Multiply £temporary4312 s.tm_wday 8
	mov eax, [rbp + 112]
	xor edx, edx
	imul dword [@14579$int4$8#]
 ...
 time_test$52:
	; BinaryAdd £temporary4314 weekdays £temporary4313
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$53:
	; Dereference £temporary4311 -> £temporary4314 £temporary4314 0

 time_test$54:
	; Parameter 200 pointer £temporary4311 -> £temporary4314
	mov rax, [rsi]
	mov [rbp + 200], rax

 time_test$55:
	; BinaryAdd £temporary4316 s.tm_year 1900
	mov eax, [rbp + 108]
	add eax, 1900
 ...
 time_test$57:
	; BinaryAdd £temporary4318 s.tm_mon 1
	mov eax, [rbp + 104]
	inc eax
 ...
 time_test$69:
	...
	mov qword [rbp + 192], @14584$string_local20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#

 time_test$70:
	; Multiply £temporary4329 t.tm_wday 8
	mov eax, [rbp + 148]
	xor edx, edx
	imul dword [@14586$int4$8#]
 ...
 time_test$72:
	; BinaryAdd £temporary4331 weekdays £temporary4330
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$73:
	; Dereference £temporary4328 -> £temporary4331 £temporary4331 0

 time_test$74:
	; Parameter 200 pointer £temporary4328 -> £temporary4331
	mov rax, [rsi]
	mov [rbp + 200], rax

 time_test$75:
	; BinaryAdd £temporary4333 t.tm_year 1900
	mov eax, [rbp + 144]
	add eax, 1900
 ...
 time_test$77:
	; BinaryAdd £temporary4335 t.tm_mon 1
	mov eax, [rbp + 140]
	inc eax
 ...
 time_test$111:
	...
	mov qword [rbp + 796], @14601$string_asctime203C25s3E2C20ctime203C25s3E0A#
 ...
 time_test$119:
	...
	mov qword [rbp + 808], @14604$string_#
 ...
 time_test$127:
	...
	mov qword [rbp + 796], @14606$string_strftime2025i2025i203C25s3E0A#
