...
string_202020gm20time3A2025s2025i2D25i2D25i2025i3A25i3A25i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#:
	; Initializer String    gm time: %s %i-%i-%i %i:%i:%i, year day %i, week day %i, daylight saving time %i\n
	db "   gm time: %s %i-%i-%i %i:%i:%i, year day %i, week day %i, daylight saving time %i", 10, 0
...
string_local20time3A2025s2025i2D25i2D25i2025i3A25i3A25i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#:
	; Initializer String local time: %s %i-%i-%i %i:%i:%i, year day %i, week day %i, daylight saving time %i\n
	db "local time: %s %i-%i-%i %i:%i:%i, year day %i, week day %i, daylight saving time %i", 10, 0
...
section .text
 ...
 time_test$14:
	; Address £temporary4500 now1
	mov rsi, rbp
	add rsi, 80

 time_test$15:
	; Parameter pointer £temporary4500 112
	mov [rbp + 112], rsi
 ...
 time_test$18:
	; GetReturnValue £temporary4501

 time_test$19:
	; Dereference £temporary4502 -> £temporary4501 £temporary4501 0

 time_test$20:
	; AssignInitSize s £temporary4502 -> £temporary4501
	mov rsi, rbp
	add rsi, 88
	mov al, 36

 time_test$21:
	; Assign s £temporary4502 -> £temporary4501
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 time_test$23:
	; Address £temporary4503 now1
	mov rsi, rbp
	add rsi, 80

 time_test$24:
	; Parameter pointer £temporary4503 148
	mov [rbp + 148], rsi
 ...
 time_test$28:
	; Dereference £temporary4505 -> £temporary4504 £temporary4504 0

 time_test$29:
	; AssignInitSize t £temporary4505 -> £temporary4504
	mov rsi, rbp
	add rsi, 124
	mov al, 36

 time_test$30:
	; Assign t £temporary4505 -> £temporary4504
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 time_test$32:
	; Address £temporary4506 s
	mov rsi, rbp
	add rsi, 88

 time_test$33:
	; Parameter pointer £temporary4506 184
	mov [rbp + 184], rsi
 ...
 time_test$49:
	; Parameter pointer "   gm time: %s %i-%i-%i %i:%i:%i, year day %i, week day %i, daylight saving time %i\n" 192
	mov qword [rbp + 192], string_202020gm20time3A2025s2025i2D25i2D25i2025i3A25i3A25i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#

 time_test$50:
	; IntegralToIntegral £temporary4512 s.tm_wday
	mov eax, [rbp + 112]
	mov rbx, 4294967295
	and rax, rbx

 time_test$51:
	; UnsignedMultiply £temporary4513 £temporary4512 8
	xor rdx, rdx
	mul qword [Array_8#]

 time_test$52:
	; BinaryAdd £temporary4514 weekdays £temporary4513
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$53:
	; Dereference £temporary4511 -> £temporary4514 £temporary4514 0

 time_test$54:
	; Parameter pointer £temporary4511 -> £temporary4514 200
	mov rax, [rsi]
	mov [rbp + 200], rax

 time_test$55:
	; BinaryAdd £temporary4516 s.tm_year 1900
	mov eax, [rbp + 108]
	add eax, 1900

 time_test$56:
	; Parameter signedint £temporary4516 208
	mov [rbp + 208], eax

 time_test$57:
	; BinaryAdd £temporary4518 s.tm_mon 1
	mov eax, [rbp + 104]
	inc eax

 time_test$58:
	; Parameter signedint £temporary4518 212
	mov [rbp + 212], eax
 ...
 time_test$69:
	; Parameter pointer "local time: %s %i-%i-%i %i:%i:%i, year day %i, week day %i, daylight saving time %i\n" 192
	mov qword [rbp + 192], string_local20time3A2025s2025i2D25i2D25i2025i3A25i3A25i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#

 time_test$70:
	; IntegralToIntegral £temporary4529 t.tm_wday
	mov eax, [rbp + 148]
	mov rbx, 4294967295
	and rax, rbx

 time_test$71:
	; UnsignedMultiply £temporary4530 £temporary4529 8
	xor rdx, rdx
	mul qword [Array_8#]

 time_test$72:
	; BinaryAdd £temporary4531 weekdays £temporary4530
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$73:
	; Dereference £temporary4528 -> £temporary4531 £temporary4531 0

 time_test$74:
	; Parameter pointer £temporary4528 -> £temporary4531 200
	mov rax, [rsi]
	mov [rbp + 200], rax

 time_test$75:
	; BinaryAdd £temporary4533 t.tm_year 1900
	mov eax, [rbp + 144]
	add eax, 1900

 time_test$76:
	; Parameter signedint £temporary4533 208
	mov [rbp + 208], eax

 time_test$77:
	; BinaryAdd £temporary4535 t.tm_mon 1
	mov eax, [rbp + 140]
	inc eax

 time_test$78:
	; Parameter signedint £temporary4535 212
	mov [rbp + 212], eax
 ...
 time_test$91:
	; Address £temporary4544 s
	mov rsi, rbp
	add rsi, 88

 time_test$92:
	; Parameter pointer £temporary4544 728
	mov [rbp + 728], rsi
 ...
 time_test$96:
	; Parameter pointer £temporary4545 704
	mov [rbp + 704], rbx
 ...
 time_test$102:
	; Address £temporary4547 now1
	mov rsi, rbp
	add rsi, 80

 time_test$103:
	; Parameter pointer £temporary4547 728
	mov [rbp + 728], rsi
 ...
 time_test$107:
	; Parameter pointer £temporary4548 704
	mov [rbp + 704], rbx
 ...
 time_test$120:
	; Address £temporary4551 t
	mov rsi, rbp
	add rsi, 124

 time_test$121:
	; Parameter pointer £temporary4551 716
	mov [rbp + 716], rsi
 ...
 time_test$134:
	; Parameter signedint £temporary4553 708
	mov [rbp + 708], ebx
