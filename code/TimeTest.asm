...
@12580string_now2013A2025lu0A#:
	; Initializer String now 1: %lu\n
	db "now 1: %lu", 10, 0

section .data

@12581string_now2023A2025lu0A#:
	; Initializer String now 2: %lu\n
	db "now 2: %lu", 10, 0

section .data

@12582string_202020gm20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#:
...
@12586string_local20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#:
...
@12600string_asctime203C25s3E2C20ctime203C25s3E0A#:
	; Initializer String asctime <%s>, ctime <%s>\n
	db "asctime <%s>, ctime <%s>", 10, 0

section .data

@12602string_#:
...
@12603string_strftime2025i2025i203C25s3E0A#:
...
section .text
 ...
 time_test:
	...
	mov qword [rbp + 24], @12566string_Sun#

 time_test$1:
	; Assign weekdays[1] string_Mon#
	mov qword [rbp + 32], @12567string_Mon#

 time_test$2:
	; Assign weekdays[2] string_Tue#
	mov qword [rbp + 40], @12568string_Tue#

 time_test$3:
	; Assign weekdays[3] string_Wed#
	mov qword [rbp + 48], @12569string_Wed#

 time_test$4:
	; Assign weekdays[4] string_Thu#
	mov qword [rbp + 56], @12570string_Thu#

 time_test$5:
	; Assign weekdays[5] string_Fri#
	mov qword [rbp + 64], @12571string_Fri#

 time_test$6:
	; Assign weekdays[6] string_Sat#
	mov qword [rbp + 72], @12572string_Sat#
 ...
 time_test$39:
	...
	mov qword [rbp + 192], @12580string_now2013A2025lu0A#
 ...
 time_test$44:
	...
	mov qword [rbp + 192], @12581string_now2023A2025lu0A#
 ...
 time_test$49:
	...
	mov qword [rbp + 192], @12582string_202020gm20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#

 time_test$50:
	; Multiply £temporary4322 s.tm_wday integral4$8#
	mov eax, [rbp + 112]
	xor edx, edx
	imul dword [@12583integral4$8#]
 ...
 time_test$55:
	; Add £temporary4326 s.tm_year integral4$1900#
	mov eax, [rbp + 108]
	add eax, 1900
 ...
 time_test$57:
	; Add £temporary4328 s.tm_mon integral4$1#
	mov eax, [rbp + 104]
	inc eax
 ...
 time_test$69:
	...
	mov qword [rbp + 192], @12586string_local20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#

 time_test$70:
	; Multiply £temporary4339 t.tm_wday integral4$8#
	mov eax, [rbp + 148]
	xor edx, edx
	imul dword [@12587integral4$8#]
 ...
 time_test$75:
	; Add £temporary4343 t.tm_year integral4$1900#
	mov eax, [rbp + 144]
	add eax, 1900
 ...
 time_test$77:
	; Add £temporary4345 t.tm_mon integral4$1#
	mov eax, [rbp + 140]
	inc eax
 ...
 time_test$111:
	...
	mov qword [rbp + 796], @12600string_asctime203C25s3E2C20ctime203C25s3E0A#
 ...
 time_test$119:
	...
	mov qword [rbp + 808], @12602string_#
 ...
 time_test$127:
	...
	mov qword [rbp + 796], @12603string_strftime2025i2025i203C25s3E0A#
