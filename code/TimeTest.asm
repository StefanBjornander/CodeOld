...
@14013$string_now2013A2025lu0A#:
	; Initializer String now 1: %lu\n
	db "now 1: %lu", 10, 0

section .data

@14014$string_now2023A2025lu0A#:
	; Initializer String now 2: %lu\n
	db "now 2: %lu", 10, 0

section .data

@14015$string_202020gm20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#:
...
@14022$string_local20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#:
...
@14039$string_asctime203C25s3E2C20ctime203C25s3E0A#:
	; Initializer String asctime <%s>, ctime <%s>\n
	db "asctime <%s>, ctime <%s>", 10, 0

section .data

@14042$string_#:
...
@14043$string_strftime2025i2025i203C25s3E0A#:
...
section .text
 ...
 time_test:
	...
	mov qword [rbp + 24], @13998$string_Sun#

 time_test$1:
	; Assign weekdays[1] "Mon"
	mov qword [rbp + 32], @13999$string_Mon#

 time_test$2:
	; Assign weekdays[2] "Tue"
	mov qword [rbp + 40], @14000$string_Tue#

 time_test$3:
	; Assign weekdays[3] "Wed"
	mov qword [rbp + 48], @14001$string_Wed#

 time_test$4:
	; Assign weekdays[4] "Thu"
	mov qword [rbp + 56], @14002$string_Thu#

 time_test$5:
	; Assign weekdays[5] "Fri"
	mov qword [rbp + 64], @14003$string_Fri#

 time_test$6:
	; Assign weekdays[6] "Sat"
	mov qword [rbp + 72], @14004$string_Sat#
 ...
 time_test$14:
	; Address £temporary4264 now1
	mov rsi, rbp
	add rsi, 80

 time_test$15:
	; Parameter 112 pointer £temporary4264
	mov [rbp + 112], rsi
 ...
 time_test$19:
	; Dereference £temporary4266 -> £temporary4265 £temporary4265 0

 time_test$20:
	; AssignInitSize s £temporary4266 -> £temporary4265
	mov rsi, rbp
	add rsi, 88
	mov al, 36

 time_test$21:
	; Assign s £temporary4266 -> £temporary4265
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 time_test$23:
	; Address £temporary4267 now1
	mov rsi, rbp
	add rsi, 80

 time_test$24:
	; Parameter 148 pointer £temporary4267
	mov [rbp + 148], rsi
 ...
 time_test$28:
	; Dereference £temporary4269 -> £temporary4268 £temporary4268 0

 time_test$29:
	; AssignInitSize t £temporary4269 -> £temporary4268
	mov rsi, rbp
	add rsi, 124
	mov al, 36

 time_test$30:
	; Assign t £temporary4269 -> £temporary4268
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 time_test$32:
	; Address £temporary4270 s
	mov rsi, rbp
	add rsi, 88

 time_test$33:
	; Parameter 184 pointer £temporary4270
	mov [rbp + 184], rsi
 ...
 time_test$39:
	...
	mov qword [rbp + 192], @14013$string_now2013A2025lu0A#
 ...
 time_test$44:
	...
	mov qword [rbp + 192], @14014$string_now2023A2025lu0A#
 ...
 time_test$49:
	...
	mov qword [rbp + 192], @14015$string_202020gm20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#

 time_test$50:
	; UnsignedMultiply £temporary4276 s.tm_wday 8
	mov eax, [rbp + 112]
	xor edx, edx
	mul dword [@14017$int4$8#]
 ...
 time_test$52:
	; BinaryAdd £temporary4278 weekdays £temporary4277
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$53:
	; Dereference £temporary4275 -> £temporary4278 £temporary4278 0

 time_test$54:
	; Parameter 200 pointer £temporary4275 -> £temporary4278
	mov rax, [rsi]
	mov [rbp + 200], rax

 time_test$55:
	; BinaryAdd £temporary4280 s.tm_year 1900
	mov eax, [rbp + 108]
	add eax, 1900

 time_test$56:
	; Parameter 208 signedint £temporary4280
	mov [rbp + 208], eax

 time_test$57:
	; BinaryAdd £temporary4282 s.tm_mon 1
	mov eax, [rbp + 104]
	inc eax

 time_test$58:
	; Parameter 212 signedint £temporary4282
	mov [rbp + 212], eax
 ...
 time_test$69:
	...
	mov qword [rbp + 192], @14022$string_local20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#

 time_test$70:
	; UnsignedMultiply £temporary4293 t.tm_wday 8
	mov eax, [rbp + 148]
	xor edx, edx
	mul dword [@14024$int4$8#]
 ...
 time_test$72:
	; BinaryAdd £temporary4295 weekdays £temporary4294
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$73:
	; Dereference £temporary4292 -> £temporary4295 £temporary4295 0

 time_test$74:
	; Parameter 200 pointer £temporary4292 -> £temporary4295
	mov rax, [rsi]
	mov [rbp + 200], rax

 time_test$75:
	; BinaryAdd £temporary4297 t.tm_year 1900
	mov eax, [rbp + 144]
	add eax, 1900

 time_test$76:
	; Parameter 208 signedint £temporary4297
	mov [rbp + 208], eax

 time_test$77:
	; BinaryAdd £temporary4299 t.tm_mon 1
	mov eax, [rbp + 140]
	inc eax

 time_test$78:
	; Parameter 212 signedint £temporary4299
	mov [rbp + 212], eax
 ...
 time_test$91:
	; Address £temporary4308 s
	mov rsi, rbp
	add rsi, 88

 time_test$92:
	; Parameter 728 pointer £temporary4308
	mov [rbp + 728], rsi
 ...
 time_test$96:
	; Parameter 704 pointer £temporary4309
	mov [rbp + 704], rbx
 ...
 time_test$102:
	; Address £temporary4311 now1
	mov rsi, rbp
	add rsi, 80

 time_test$103:
	; Parameter 728 pointer £temporary4311
	mov [rbp + 728], rsi
 ...
 time_test$107:
	; Parameter 704 pointer £temporary4312
	mov [rbp + 704], rbx
 ...
 time_test$111:
	...
	mov qword [rbp + 696], @14039$string_asctime203C25s3E2C20ctime203C25s3E0A#
 ...
 time_test$119:
	...
	mov qword [rbp + 708], @14042$string_#

 time_test$120:
	; Address £temporary4315 t
	mov rsi, rbp
	add rsi, 124

 time_test$121:
	; Parameter 716 pointer £temporary4315
	mov [rbp + 716], rsi
 ...
 time_test$127:
	...
	mov qword [rbp + 696], @14043$string_strftime2025i2025i203C25s3E0A#
 ...
 time_test$134:
	; Parameter 708 signedint £temporary4317
	mov [rbp + 708], ebx
