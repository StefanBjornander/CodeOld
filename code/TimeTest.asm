...
@14491$string_now2013A2025lu0A#:
	; Initializer String now 1: %lu\n
	db "now 1: %lu", 10, 0

section .data

@14492$string_now2023A2025lu0A#:
	; Initializer String now 2: %lu\n
	db "now 2: %lu", 10, 0

section .data

@14493$string_202020gm20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#:
...
@14499$string_local20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#:
...
@14515$string_asctime203C25s3E2C20ctime203C25s3E0A#:
...
@14519$string_strftime2025i2025i203C25s3E0A#:
...
section .text
 ...
 time_test:
	...
	mov qword [rbp + 24], @14476$string_Sun#

 time_test$1:
	; Assign weekdays[1] "Mon"
	mov qword [rbp + 32], @14477$string_Mon#

 time_test$2:
	; Assign weekdays[2] "Tue"
	mov qword [rbp + 40], @14478$string_Tue#

 time_test$3:
	; Assign weekdays[3] "Wed"
	mov qword [rbp + 48], @14479$string_Wed#

 time_test$4:
	; Assign weekdays[4] "Thu"
	mov qword [rbp + 56], @14480$string_Thu#

 time_test$5:
	; Assign weekdays[5] "Fri"
	mov qword [rbp + 64], @14481$string_Fri#

 time_test$6:
	; Assign weekdays[6] "Sat"
	mov qword [rbp + 72], @14482$string_Sat#
 ...
 time_test$11:
	; GetReturnValue £temporary4583

 time_test$12:
	; Assign now1 £temporary4583
	mov [rbp + 80], rbx
 ...
 time_test$14:
	; Address £temporary4584 now1
	mov rsi, rbp
	add rsi, 80

 time_test$15:
	; Parameter 112 pointer £temporary4584
	mov [rbp + 112], rsi
 ...
 time_test$19:
	; Dereference £temporary4586 -> £temporary4585 £temporary4585 0

 time_test$20:
	; AssignInitSize s £temporary4586 -> £temporary4585
	mov rsi, rbp
	add rsi, 88
	mov al, 36

 time_test$21:
	; Assign s £temporary4586 -> £temporary4585
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 time_test$23:
	; Address £temporary4587 now1
	mov rsi, rbp
	add rsi, 80

 time_test$24:
	; Parameter 148 pointer £temporary4587
	mov [rbp + 148], rsi
 ...
 time_test$28:
	; Dereference £temporary4589 -> £temporary4588 £temporary4588 0

 time_test$29:
	; AssignInitSize t £temporary4589 -> £temporary4588
	mov rsi, rbp
	add rsi, 124
	mov al, 36

 time_test$30:
	; Assign t £temporary4589 -> £temporary4588
	mov ah, [rbx]
	mov [rsi], ah
	inc rbx
	inc rsi
 ...
 time_test$32:
	; Address £temporary4590 s
	mov rsi, rbp
	add rsi, 88

 time_test$33:
	; Parameter 184 pointer £temporary4590
	mov [rbp + 184], rsi
 ...
 time_test$36:
	; GetReturnValue £temporary4591

 time_test$37:
	; Assign now2 £temporary4591
	mov [rbp + 160], rbx
 ...
 time_test$39:
	...
	mov qword [rbp + 192], @14491$string_now2013A2025lu0A#
 ...
 time_test$44:
	...
	mov qword [rbp + 192], @14492$string_now2023A2025lu0A#
 ...
 time_test$49:
	...
	mov qword [rbp + 192], @14493$string_202020gm20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#

 time_test$50:
	; IntegralToIntegral £temporary4596 s.tm_wday
	mov eax, [rbp + 112]
	mov rbx, 4294967295
	and rax, rbx
 ...
 time_test$55:
	; BinaryAdd £temporary4600 s.tm_year 1900
	mov eax, [rbp + 108]
	add eax, 1900
 ...
 time_test$57:
	; BinaryAdd £temporary4602 s.tm_mon 1
	mov eax, [rbp + 104]
	inc eax
 ...
 time_test$69:
	...
	mov qword [rbp + 192], @14499$string_local20time3A2025s202502i2D2502i2D2502i202502i3A2502i3A2502i2C20year20day2025i2C20week20day2025i2C20daylight20saving20time2025i0A#

 time_test$70:
	; IntegralToIntegral £temporary4613 t.tm_wday
	mov eax, [rbp + 148]
	mov rbx, 4294967295
	and rax, rbx

 time_test$71:
	; UnsignedMultiply £temporary4614 £temporary4613 8
	xor rdx, rdx
	mul qword [@14500$Array_8#]

 time_test$72:
	; BinaryAdd £temporary4615 weekdays £temporary4614
	mov rsi, rbp
	add rsi, 24
	add rsi, rax

 time_test$73:
	; Dereference £temporary4612 -> £temporary4615 £temporary4615 0

 time_test$74:
	; Parameter 200 pointer £temporary4612 -> £temporary4615
	mov rax, [rsi]
	mov [rbp + 200], rax

 time_test$75:
	; BinaryAdd £temporary4617 t.tm_year 1900
	mov eax, [rbp + 144]
	add eax, 1900

 time_test$76:
	; Parameter 208 signedint £temporary4617
	mov [rbp + 208], eax

 time_test$77:
	; BinaryAdd £temporary4619 t.tm_mon 1
	mov eax, [rbp + 140]
	inc eax

 time_test$78:
	; Parameter 212 signedint £temporary4619
	mov [rbp + 212], eax
 ...
 time_test$91:
	; Address £temporary4628 s
	mov rsi, rbp
	add rsi, 88

 time_test$92:
	; Parameter 728 pointer £temporary4628
	mov [rbp + 728], rsi
 ...
 time_test$95:
	; GetReturnValue £temporary4629

 time_test$96:
	; Parameter 704 pointer £temporary4629
	mov [rbp + 704], rbx
 ...
 time_test$102:
	; Address £temporary4631 now1
	mov rsi, rbp
	add rsi, 80

 time_test$103:
	; Parameter 728 pointer £temporary4631
	mov [rbp + 728], rsi
 ...
 time_test$107:
	; Parameter 704 pointer £temporary4632
	mov [rbp + 704], rbx
 ...
 time_test$111:
	...
	mov qword [rbp + 696], @14515$string_asctime203C25s3E2C20ctime203C25s3E0A#
 ...
 time_test$119:
	...
	mov qword [rbp + 708], @14518$string_#

 time_test$120:
	; Address £temporary4635 t
	mov rsi, rbp
	add rsi, 124

 time_test$121:
	; Parameter 716 pointer £temporary4635
	mov [rbp + 716], rsi
 ...
 time_test$127:
	...
	mov qword [rbp + 696], @14519$string_strftime2025i2025i203C25s3E0A#
 ...
 time_test$133:
	; GetReturnValue £temporary4637

 time_test$134:
	; Parameter 708 signedint £temporary4637
	mov [rbp + 708], ebx
