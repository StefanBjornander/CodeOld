...
@628$string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#:
	; Initializer String Assertion failed: "%s" in file %s at line %i\n
	db "Assertion failed: ", 34, "%s", 34, " in file %s at line %i", 10, 0

section .data

@629$string_memorySize203E3D200#:
	; Initializer String memorySize >= 0
	db "memorySize >= 0", 0

section .data

@630$string_C3A5CUsers5CStefan5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CMalloc2Ec#:
...
section .text
 ...
 malloc$1:
	; BinaryAdd newBlockSize £temporary22 12
	add eax, 12
	mov [rbp + 28], eax
 ...
 malloc$4:
	; BinaryAdd £temporary25 £temporary24 1048572
	add rax, 1048572
 ...
 malloc$14:
	...
	mov qword [rbp + 104], @628$string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#

 malloc$15:
	; Parameter 112 pointer "memorySize >= 0"
	mov qword [rbp + 112], @629$string_memorySize203E3D200#

 malloc$16:
	; Parameter 120 pointer "C:\Users\Stefan\Documents\vagrant\homestead\code\code\Malloc.c"
	mov qword [rbp + 120], @630$string_C3A5CUsers5CStefan5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CMalloc2Ec#
...
@733$string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#:
	; Initializer String Assertion failed: "%s" in file %s at line %i\n
	db "Assertion failed: ", 34, "%s", 34, " in file %s at line %i", 10, 0

section .data

@734$string_newMemorySize203E3D200#:
	; Initializer String newMemorySize >= 0
	db "newMemorySize >= 0", 0

section .data

@735$string_C3A5CUsers5CStefan5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CMalloc2Ec#:
	; Initializer String C:\Users\Stefan\Documents\vagrant\homestead\code\code\Malloc.c
	db "C:\Users\Stefan\Documents\vagrant\homestead\code\code\Malloc.c", 0

section .data

@743$string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#:
	; Initializer String Assertion failed: "%s" in file %s at line %i\n
	db "Assertion failed: ", 34, "%s", 34, " in file %s at line %i", 10, 0

section .data

@744$string_2820oldMemoryPtr20213D20NULL2029207C7C202820newMemorySize203E2002029#:
	; Initializer String ( oldMemoryPtr != NULL ) || ( newMemorySize > 0 )
	db "( oldMemoryPtr != NULL ) || ( newMemorySize > 0 )", 0

section .data

@745$string_C3A5CUsers5CStefan5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CMalloc2Ec#:
	; Initializer String C:\Users\Stefan\Documents\vagrant\homestead\code\code\Malloc.c
	db "C:\Users\Stefan\Documents\vagrant\homestead\code\code\Malloc.c", 0
...
section .text
 ...
 realloc$3:
	...
	mov qword [rbp + 68], @733$string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#

 realloc$4:
	; Parameter 76 pointer "newMemorySize >= 0"
	mov qword [rbp + 76], @734$string_newMemorySize203E3D200#

 realloc$5:
	; Parameter 84 pointer "C:\Users\Stefan\Documents\vagrant\homestead\code\code\Malloc.c"
	mov qword [rbp + 84], @735$string_C3A5CUsers5CStefan5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CMalloc2Ec#
 ...
 realloc$16:
	; Parameter 68 pointer "Assertion failed: "%s" in file %s at line %i\n"
	mov qword [rbp + 68], @743$string_Assertion20failed3A202225s2220in20file2025s20at20line2025i0A#

 realloc$17:
	; Parameter 76 pointer "( oldMemoryPtr != NULL ) || ( newMemorySize > 0 )"
	mov qword [rbp + 76], @744$string_2820oldMemoryPtr20213D20NULL2029207C7C202820newMemorySize203E2002029#

 realloc$18:
	; Parameter 84 pointer "C:\Users\Stefan\Documents\vagrant\homestead\code\code\Malloc.c"
	mov qword [rbp + 84], @745$string_C3A5CUsers5CStefan5CDocuments5Cvagrant5Chomestead5Ccode5Ccode5CMalloc2Ec#
 ...
 realloc$47:
	; GreaterThan 52 newBlockSize £temporary108 -> oldBlockPtr
	mov eax, [rsi]
	cmp [rbp + 36], eax
	ja realloc$52
 ...
 realloc$60:
	; BinarySubtract availableSize lastAddress £temporary116
	mov ebx, [rbp + 48]
	sub ebx, eax
	mov [rbp + 60], ebx
 ...
 realloc$62:
	; Dereference £temporary119 -> oldBlockPtr oldBlockPtr 0
	mov rsi, [rbp + 40]

 realloc$63:
	; Assign £temporary119 -> oldBlockPtr newBlockSize
	mov eax, [rbp + 36]
	mov [rsi], eax
 ...
 realloc$68:
	; Dereference £temporary121 -> currBlockPtr currBlockPtr 0
	mov rsi, [rbp + 52]

 realloc$69:
	; Assign currBlockPtr £temporary121 -> currBlockPtr
	mov rax, [rsi + 4]
	mov [rbp + 52], rax
...
@802$string_2020Address2025u2C20Size2025u0A#:
...
section .text
 ...
 print_heap$2:
	...
	mov qword [rbp + 56], @798$string_Heap3A0A#
 ...
 print_heap$7:
	...
	mov qword [rbp + 56], @802$string_2020Address2025u2C20Size2025u0A#
 ...
 print_heap$10:
	; Dereference £temporary129 -> currBlockPtr currBlockPtr 0
	mov rsi, [rbp + 24]

 print_heap$11:
	; Parameter 68 unsigned int £temporary129 -> currBlockPtr
	mov eax, [rsi]
	mov [rbp + 68], eax
 ...
 print_heap$14:
	; Dereference £temporary131 -> currBlockPtr currBlockPtr 0
	mov rsi, [rbp + 24]

 print_heap$15:
	; Assign currBlockPtr £temporary131 -> currBlockPtr
	mov rax, [rsi + 4]
	mov [rbp + 24], rax
 ...
 print_heap$18:
	...
	mov qword [rbp + 56], @803$string_0A#
