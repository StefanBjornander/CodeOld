...
section .text
 ...
 malloc$14:
	; IntegralToIntegral £temporary154 memorySize
	mov eax, [rbp + 24]

 malloc$15:
	; BinaryAdd newBlockSize £temporary154 12
	add eax, 12
	mov [rbp + 28], eax
 ...
 malloc$17:
	; StackTop £temporary156
	mov rax, $StackTop

 malloc$18:
	; BinaryAdd £temporary157 £temporary156 1048572
	add rax, 1048572

 malloc$19:
	; IntegralToIntegral £temporary159 £temporary157

 malloc$20:
	; Assign lastAddress £temporary159
	mov [rbp + 36], eax
 ...
 malloc$26:
	; IntegralToIntegral £temporary161 currBlockPtr
	mov rax, [rbp + 64]

 malloc$27:
	; Assign currAddress £temporary161
	mov [rbp + 72], eax

 malloc$28:
	; Dereference £temporary162 -> currBlockPtr currBlockPtr 0
	mov rsi, [rbp + 64]

 malloc$29:
	; BinaryAdd £temporary163 currAddress £temporary162 -> currBlockPtr
	mov eax, [rbp + 72]
	add eax, [rsi]

 malloc$30:
	; BinaryAdd £temporary164 £temporary163 12
	add eax, 12

 malloc$31:
	; BinarySubtract currGap lastAddress £temporary164
	mov ebx, [rbp + 36]
	sub ebx, eax
	mov [rbp + 76], ebx
 ...
 malloc$40:
	; Dereference £temporary171 -> currBlockPtr currBlockPtr 0
	mov rsi, [rbp + 64]

 malloc$41:
	; Assign currBlockPtr £temporary171 -> currBlockPtr
	mov rax, [rsi + 4]
	mov [rbp + 64], rax
 ...
 malloc$44:
	; IntegralToIntegral £temporary173 minBlockPtr
	mov rax, [rbp + 40]

 malloc$45:
	; Dereference £temporary174 -> minBlockPtr minBlockPtr 0
	mov rsi, [rbp + 40]

 malloc$46:
	; BinaryAdd £temporary175 £temporary173 £temporary174 -> minBlockPtr
	add eax, [rsi]

 malloc$47:
	; BinaryAdd newAddress £temporary175 12
	add eax, 12
	mov [rbp + 72], eax
 ...
 malloc$53:
	; Assign £temporary179 -> newBlockPtr minBlockPtr
	mov rax, [rbp + 40]
	mov [rsi + 4], rax
 ...
 malloc$55:
	; Dereference £temporary181 -> minPrevBlockPtr minPrevBlockPtr 0
	mov rsi, [rbp + 48]

 malloc$56:
	; Assign £temporary181 -> minPrevBlockPtr newBlockPtr
	mov rax, [rbp + 76]
	mov [rsi + 4], rax
 ...
 malloc$63:
	; InspectRegister £temporary185 rbp

 malloc$64:
	; IntegralToIntegral £temporary186 £temporary185

 malloc$65:
	; Assign stackTop £temporary186
	mov [rbp + 76], ebp
 ...
 malloc$67:
	; IntegralToIntegral £temporary188 newAddress
	mov eax, [rbp + 72]
	mov rbx, 4294967295
	and rax, rbx

 malloc$68:
	; Assign newBlockPtr £temporary188
	mov [rbp + 80], rax

 malloc$69:
	; Dereference £temporary189 -> newBlockPtr newBlockPtr 0
	mov rsi, [rbp + 80]

 malloc$70:
	; Assign £temporary189 -> newBlockPtr memorySize
	mov eax, [rbp + 24]
	mov [rsi], eax

 malloc$71:
	; Dereference £temporary190 -> newBlockPtr newBlockPtr 0
	mov rsi, [rbp + 80]

 malloc$72:
	; Assign £temporary190 -> newBlockPtr 0
	mov qword [rsi + 4], 0
 ...
 malloc$74:
	; Dereference £temporary192 -> prevBlockPtr prevBlockPtr 0
	mov rsi, [rbp + 56]

 malloc$75:
	; Assign £temporary192 -> prevBlockPtr newBlockPtr
	mov rax, [rbp + 80]
	mov [rsi + 4], rax
 ...
 malloc$78:
	; BinaryAdd £temporary193 newAddress 12
	mov ebx, [rbp + 72]
	add ebx, 12
...
section .text
 ...
 calloc$1:
	; SignedMultiply £temporary195 number size
	mov eax, [rbp + 24]
	xor edx, edx
	imul dword [rbp + 28]

 calloc$2:
	; Parameter signedint £temporary195 56
	mov [rbp + 56], eax
...
section .text
 ...
 free$2:
	; IntegralToIntegral £temporary200 freeMemoryPtr
	mov rax, [rbp + 24]

 free$3:
	; BinarySubtract £temporary201 £temporary200 12
	sub eax, 12

 free$4:
	; IntegralToIntegral £temporary202 £temporary201
	mov rbx, 4294967295
	and rax, rbx

 free$5:
	; Assign freeBlockPtr £temporary202
	mov [rbp + 32], rax
 ...
 free$11:
	; Dereference £temporary206 -> currBlockPtr currBlockPtr 0
	mov rsi, [rbp + 48]

 free$12:
	; NotEqual 15 £temporary206 -> currBlockPtr 0
	cmp qword [rsi + 4], 0
	jne free$15
 ...
 free$16:
	; Dereference £temporary210 -> currBlockPtr currBlockPtr 0
	mov rsi, [rbp + 48]

 free$17:
	; Assign g_firstBlockPtr £temporary210 -> currBlockPtr
	mov rax, [rsi + 4]
	mov [g_firstBlockPtr], rax
 ...
 free$19:
	; Dereference £temporary211 -> currBlockPtr currBlockPtr 0
	mov rsi, [rbp + 48]

 free$20:
	; NotEqual 24 £temporary211 -> currBlockPtr 0
	cmp qword [rsi + 4], 0
	jne free$24

 free$21:
	; Dereference £temporary213 -> prevBlockPtr prevBlockPtr 0
	mov rsi, [rbp + 40]

 free$22:
	; Assign £temporary213 -> prevBlockPtr 0
	mov qword [rsi + 4], 0
 ...
 free$24:
	; Dereference £temporary214 -> prevBlockPtr prevBlockPtr 0
	mov rsi, [rbp + 40]

 free$25:
	; Dereference £temporary215 -> currBlockPtr currBlockPtr 0
	mov rdi, [rbp + 48]

 free$26:
	; Assign £temporary214 -> prevBlockPtr £temporary215 -> currBlockPtr
	mov rax, [rdi + 4]
	mov [rsi + 4], rax
 ...
 free$29:
	; Dereference £temporary216 -> currBlockPtr currBlockPtr 0
	mov rsi, [rbp + 48]

 free$30:
	; Assign currBlockPtr £temporary216 -> currBlockPtr
	mov rax, [rsi + 4]
	mov [rbp + 48], rax
...
section .text
 ...
 realloc$38:
	; IntegralToIntegral £temporary231 newMemorySize
	mov eax, [rbp + 32]

 realloc$39:
	; BinaryAdd newBlockSize £temporary231 12
	add eax, 12
	mov [rbp + 36], eax

 realloc$40:
	; IntegralToIntegral £temporary233 oldMemoryPtr
	mov rax, [rbp + 24]

 realloc$41:
	; BinarySubtract £temporary234 £temporary233 12
	sub eax, 12
 ...
 realloc$43:
	; Assign oldBlockPtr £temporary235
	mov [rbp + 40], rax
 ...
 realloc$45:
	; UnsignedGreaterThan 49 newBlockSize £temporary236 -> oldBlockPtr
	mov eax, [rsi]
	cmp [rbp + 36], eax
	ja realloc$49

 realloc$46:
	; Dereference £temporary238 -> oldBlockPtr oldBlockPtr 0
	mov rsi, [rbp + 40]

 realloc$47:
	; Assign £temporary238 -> oldBlockPtr newBlockSize
	mov eax, [rbp + 36]
	mov [rsi], eax
 ...
 realloc$49:
	; StackTop £temporary239
	mov rax, $StackTop

 realloc$50:
	; BinaryAdd £temporary240 £temporary239 1048572
	add rax, 1048572

 realloc$51:
	; IntegralToIntegral £temporary242 £temporary240

 realloc$52:
	; Assign lastAddress £temporary242
	mov [rbp + 48], eax
 ...
 realloc$57:
	; BinarySubtract availableSize lastAddress £temporary245
	mov ebx, [rbp + 48]
	sub ebx, eax
	mov [rbp + 60], ebx
 ...
 realloc$59:
	; Dereference £temporary248 -> oldBlockPtr oldBlockPtr 0
	mov rsi, [rbp + 40]

 realloc$60:
	; Assign £temporary248 -> oldBlockPtr newBlockSize
	mov eax, [rbp + 36]
	mov [rsi], eax
 ...
 realloc$63:
	; Assign lastAddress £temporary249
	mov [rbp + 48], eax
 ...
 realloc$65:
	; Assign currBlockPtr £temporary250 -> currBlockPtr
	mov rax, [rsi + 4]
	mov [rbp + 52], rax
 ...
 realloc$72:
	; Assign newMemoryPtr £temporary251
	mov [rbp + 60], rbx
...
section .text
 ...
 print_heap$8:
	; IntegralToIntegral £temporary257 currBlockPtr
	mov rax, [rbp + 24]

 print_heap$9:
	; Parameter unsigned int £temporary257 64
	mov [rbp + 64], eax
 ...
 print_heap$11:
	; Parameter unsigned int £temporary258 -> currBlockPtr 68
	mov eax, [rsi]
	mov [rbp + 68], eax
 ...
 print_heap$14:
	; Dereference £temporary260 -> currBlockPtr currBlockPtr 0
	mov rsi, [rbp + 24]

 print_heap$15:
	; Assign currBlockPtr £temporary260 -> currBlockPtr
	mov rax, [rsi + 4]
	mov [rbp + 24], rax
