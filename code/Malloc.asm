...
malloc$27:	; £field186 -> currBlockPtr = *currBlockPtr
	mov rsi, [rbp + 64]

malloc$28:	; £temporary187 = currAddress + £field186 -> currBlockPtr
	mov eax, [rbp + 72]
	add eax, [rsi]
...
malloc$40:	; £field195 -> currBlockPtr = *currBlockPtr
	mov rsi, [rbp + 64]

malloc$41:	; currBlockPtr = £field195 -> currBlockPtr
	mov rax, [rsi + 4]
	mov [rbp + 64], rax
...
malloc$45:	; £field198 -> minBlockPtr = *minBlockPtr
	mov rsi, [rbp + 40]

malloc$46:	; £temporary199 = £temporary197 + £field198 -> minBlockPtr
	add eax, [rsi]
...
malloc$51:	; £field202 -> newBlockPtr = *newBlockPtr
	mov rsi, [rbp + 76]

malloc$52:	; £field202 -> newBlockPtr = memorySize
	mov eax, [rbp + 24]
	mov [rsi], eax

malloc$53:	; £field203 -> newBlockPtr = *newBlockPtr
	mov rsi, [rbp + 76]

malloc$54:	; £field203 -> newBlockPtr = minBlockPtr
	mov rax, [rbp + 40]
	mov [rsi + 4], rax
...
malloc$56:	; £field205 -> minPrevBlockPtr = *minPrevBlockPtr
	mov rsi, [rbp + 48]

malloc$57:	; £field205 -> minPrevBlockPtr = newBlockPtr
	mov rax, [rbp + 76]
	mov [rsi + 4], rax
...
malloc$72:	; £field213 -> newBlockPtr = *newBlockPtr
	mov rsi, [rbp + 80]

malloc$73:	; £field213 -> newBlockPtr = memorySize
	mov eax, [rbp + 24]
	mov [rsi], eax

malloc$74:	; £field214 -> newBlockPtr = *newBlockPtr
	mov rsi, [rbp + 80]

malloc$75:	; £field214 -> newBlockPtr = int8$0#
	mov qword [rsi + 4], 0
...
malloc$77:	; £field216 -> prevBlockPtr = *prevBlockPtr
	mov rsi, [rbp + 56]

malloc$78:	; £field216 -> prevBlockPtr = newBlockPtr
	mov rax, [rbp + 80]
	mov [rsi + 4], rax
...
realloc$47:	; £field269 -> oldBlockPtr = *oldBlockPtr
	mov rsi, [rbp + 40]

realloc$48:	; if newBlockSize > £field269 -> oldBlockPtr goto 53
	mov eax, [rbp + 36]
	cmp eax, [rsi]
	ja realloc$53

realloc$49:	; £field271 -> oldBlockPtr = *oldBlockPtr
	mov rsi, [rbp + 40]

realloc$50:	; £field271 -> oldBlockPtr = newBlockSize
	mov eax, [rbp + 36]
	mov [rsi], eax
...
realloc$61:	; £field277 -> oldBlockPtr = *oldBlockPtr
	mov rsi, [rbp + 40]

realloc$62:	; £field277 -> oldBlockPtr = newBlockSize
	mov eax, [rbp + 36]
	mov [rsi], eax
...
realloc$67:	; £field279 -> currBlockPtr = *currBlockPtr
	mov rsi, [rbp + 52]

realloc$68:	; currBlockPtr = £field279 -> currBlockPtr
	mov rax, [rsi + 4]
	mov [rbp + 52], rax
