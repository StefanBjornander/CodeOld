...
section .text
 ...
 malloc$14:
	; IntegralToIntegral £temporary143 memorySize
	mov eax, [rbp + 24]

 malloc$15:
	; BinaryAdd newBlockSize £temporary143 12
	add eax, 12
	mov [rbp + 28], eax
 ...
 malloc$17:
	; StackTop £temporary145
	mov rax, $StackTop

 malloc$18:
	; BinaryAdd £temporary146 £temporary145 1048572
	add rax, 1048572

 malloc$19:
	; IntegralToIntegral £temporary148 £temporary146

 malloc$20:
	; Assign lastAddress £temporary148
	mov [rbp + 36], eax
...
section .text
 ...
 calloc$2:
	; Parameter signedint £temporary184 56
	mov [rbp + 56], eax
...
section .text
 ...
 free$2:
	; IntegralToIntegral £temporary189 freeMemoryPtr
	mov rax, [rbp + 24]

 free$3:
	; BinarySubtract £temporary190 £temporary189 12
	sub eax, 12
 ...
 free$5:
	; Assign freeBlockPtr £temporary191
	mov [rbp + 32], rax
...
section .text
 ...
 realloc$45:
	; UnsignedGreaterThan 49 newBlockSize £temporary225 -> oldBlockPtr
	mov eax, [rsi]
	cmp [rbp + 36], eax
	ja realloc$49
...
section .text
 ...
 print_heap$9:
	; Parameter unsigned int £temporary246 64
	mov [rbp + 64], eax
 ...
 print_heap$11:
	; Parameter unsigned int £temporary247 -> currBlockPtr 68
	mov eax, [rsi]
	mov [rbp + 68], eax
